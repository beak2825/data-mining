                    ...
                    if (200 === e.status) {
                        ...
                        if (n.forEach(function(e) {
                            ...
                            case Vt.AlreadyOwned:
                                return {
                                    success: !1,
                                    message: $t.batchBuyPartialSuccessItemsOwnedFailureMessage,
                                    params: {
                                        itemCountSuccess: r,
                            ...
                            case Vt.InsufficientFunds:
                                return {
                                    success: !1,
                                    message: $t.batchBuyPartialSuccessInsufficientFundsFailureMessage,
                                    params: {
                                        itemCountSuccess: r,
                                        itemCountFailure: a.count
                                    }
                            ...
                            case Vt.ExceptionOccured:
                                return {
                                    success: !1,
                                    message: $t.batchBuyPartialSuccessNetworkErrorFailureMessage,
                                    params: {
                                        itemCountSuccess: r,
                                        itemCountFailure: a.count
                                    }
                            ...
                            case Vt.TooManyPurchases:
                                return {
                                    success: !1,
                                    message: $t.batchBuyPartialSuccessFloodcheckFailureMessage,
                                    params: {
                                        itemCountSuccess: r,
                                        itemCountFailure: a.count
                                    }
                            ...
                            case Vt.PremiumNeeded:
                                return {
                                    success: !1,
                                    message: $t.batchBuyPartialSuccessPremiumNeededFailureMessage,
                                    params: {
                                        itemCountSuccess: r,
                                        itemCountFailure: a.count
                                    }
                            ...
                            case Vt.NoSellers:
                                return {
                                    success: !1,
                                    message: $t.batchBuyPartialSuccessNoSellersFailureMessage,
                                    params: {
                                        itemCountSuccess: r,
                                        itemCountFailure: a.count
                                    }
                            ...
                            case Vt.InExperienceOnly:
                                return {
                                    success: !1,
                                    message: $t.batchBuyPartialSuccessInExperienceOnlyFailureMessage,
                                    params: {
                                        itemCountSuccess: r,
                                        itemCountFailure: a.count
                                    }
                            ...
                            default:
                                return {
                                    success: !1,
                                    message: $t.batchBuyPartialSuccessGeneralFailureMessage,
                                    params: {
                                        itemCountSuccess: r,
                                        itemCountFailure: a.count
                                    }
                            ...
                            case Vt.AlreadyOwned:
                                return {
                                    success: !1,
                                    message: $t.batchBuyItemsOwnedFailureMessage
                                };
                            case Vt.InsufficientFunds:
                                return {
                                    success: !1,
                            ...
                            case Vt.ExceptionOccured:
                                return {
                                    success: !1,
                                    message: $t.networkErrroFailureMessage
                                };
                            case Vt.TooManyPurchases:
                                return {
                                    success: !1,
                                    message: $t.floodcheckFailureMessage,
                                    params: {
                                        throttleTime: Kt
                                    }
                                };
                            case Vt.PremiumNeeded:
                                return {
                                    success: !1,
                                    message: $t.premiumNeededFailureMessage
                                };
                            case Vt.NoSellers:
                                return {
                                    success: !1,
                                    message: $t.noSellersFailureMessage
                                };
                            case Vt.InExperienceOnly:
                                return {
                                    success: !1,
                                    message: $t.inExperienceOnlyFailureMessage
                                };
                            default:
                                return {
                                    success: !1,
