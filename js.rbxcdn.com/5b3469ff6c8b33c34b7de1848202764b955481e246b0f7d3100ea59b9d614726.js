! function() {
    var t = {
            ...
            2162: function(e, a, t) {
                ...
                function i(o, e, a, t) {
                    o.cancelSearch = function() {
                        ...
                        o.chatLibrary.chatLayout.collapsed = !o.chatLibrary.chatLayout.collapsed, o.updateUnreadConversationCount(), o.chatLibrary.chatLayout.chatBarInitialized = !0, o.saveChatBarLayoutInCookie()
            ...
            3607: function(e, a, t) {
                ...
                function o(d, s, i, n, o, u, c, l, g, r, e, h, p, y, a, t, m, v, f, b, L, C, I, D, T, S, P, E, M, O, A, U, w, k, x, F, N, R) {
                    function G() {
                    ...
                    function j() {
                        return d.preSetChatLibrary.dialogIdList.filter(function(e) {
                    ...
                    d.processLatestMessageForConversations = function(e) {
                        re().forEach(e, function(e) {
                            var a = e.messages;
                            d.chatLibrary.conversationsDict[e.conversationId] && ((e = B(e.conversationId)).hasUnreadMessages = e.hasUnreadMessages || p.hasUnreadMessages(e, a), l.updateAndSanitizePreviewMessage(e, a), l.resetConversationUnreadStatus(e, a), l.formatTimestampInConversation(e))
                        })
                    }, d.updateUnreadConversationCount = function() {
                        d.getIsChatEnabled() && c.getUnreadConversationCount().then(function(e) {
                            e && (0 < e.count ? (d.chatViewModel.unreadConversationCount = " ✦ ", s.document.title = "( ✦ ) ".concat(d.chatLibrary.currentTabTitle)) : (d.chatViewModel.unreadConversationCount = 0, s.document.title = d.chatLibrary.currentTabTitle))
                        }, function() {
                        ...
                        d.closeDialog(e), r && d.updateDialogList(i, !0), t !== g.dialogType.CHAT && t !== g.dialogType.FRIEND || (a.participants.forEach(function(e) {
                            e = e.id;
                    ...
                    function H(e, a, t) {
                        l.appendMessages(d.chatLibrary, a, e), v.fetchDataForLinkCard(e, d.chatLibrary), p.hasUnreadMessages(a, e), e = {
                            status: !1,
                    ...
                    function W(e, a) {
                        ...
                        re().isUndefined(d.chatUserDict[r]) ? z(e) : (e = r, r = null, t = a, i = [], n = d.chatUserDict[e], e = null, t || (e = (new Date).getTime()), c.getMessagesByPageSize(n, r, g.dialogParams.smallestPageSizeOfGetMessages, i, function(e) {
                            H(i, n, t), e && (e = (new Date).getTime() - e, c.sendPerformanceData(C.performanceMeasurements.messageReceive, e))
                        }, e))
                    }
                    d.resetDialogLayout = function(t) {
                        var e, a;
                        t && (e = le({}, g.dialogLayout), a = le({}, g.dialogLayoutResetConstant), re().forEach(e, function(e, a) {
                            re().isUndefined(t[a]) && (t[a] = le({}, e))
                        ...
                        if (re().isDefined(d.preSetChatLibrary) && re().isDefined(d.preSetChatLibrary.dialogIdList)) {
                            var e = le({}, d.preSetChatLibrary.dialogIdList);
                            if (0 === e.length) return d.preSetChatLibrary.dialogDict = {}, d.preSetChatLibrary.dialogsLayout = {}, r.removeFromStorage(r.storageDictionary.dialogDict, d.chatLibrary.cookieOption), r.removeFromStorage(r.storageDictionary.dialogsLayout, d.chatLibrary.cookieOption), !1;
                            ...
                            }), d.chatLibrary.dialogIdList = d.preSetChatLibrary.dialogIdList, re().forEach(t, function(e, a) {
                            ...
                            }), d.maybeCloseNewGroupDialog(), ee(j())
                        }
                    };
                    ...
                    var q;
                    d.setup = function() {
                        d.chatUserDict = {}, d.dialogType = le({}, g.dialogType), d.userPresenceTypes = le({}, g.userPresenceTypes), d.newGroup = le({}, t.newGroup), d.selectedFriendIds = [], d.chatTimeouts = {}, d.chatLibrary = le({}, m.chatLibrary), re().isDefined(ie.RealTime) && (q = ie.RealTime.Factory.GetClient())
                    }, d.initializePresetData = function() {
                        d.preSetChatLibrary = {}, r.isStorageDefined(r.storageDictionary.dialogIdList) && r.isStorageDefined(r.storageDictionary.dialogDict) ? d.preSetChatLibrary = {
                            dialogIdList: r.getFromStorage(r.storageDictionary.dialogIdList),
                            dialogDict: r.getFromStorage(r.storageDictionary.dialogDict),
                            dialogsLayout: r.isStorageDefined(r.storageDictionary.dialogsLayout) ? r.getFromStorage(r.storageDictionary.dialogsLayout) : {}
                        } : d.preSetChatLibrary = {
                            dialogIdList: [],
                            dialogDict: {},
                            dialogsLayout: {}
                        }, r.isStorageDefined(r.storageDictionary.chatBarLayout) && (d.preSetChatLibrary.chatBarLayout = r.getFromStorage(r.storageDictionary.chatBarLayout)), d.chatApiParams = le({}, g.chatApiParams)
                    ...
                    d.getAllFriends = function() {
                        E.getFriendsPresence().then(function(e) {
                            d.getFriendsInfo(e)
                        }, function(e) {
                            console.debug(e)
                        })
                        ...
                        }), e = [ne.UserProfileField.Names.CombinedName], M.watchUserProfiles(i, e).subscribe(function(e) {
                            e.loading, e.error;
                            var a = e.data;
                            Object.keys(a).forEach(function(e) {
                                d.chatLibrary.friendsDict[e] && (d.chatLibrary.friendsDict[e].nameForDisplay = a[e].names.combinedName)
                            })
                        }), t && 0 < t.length && D.getAvatarHeadshots(t, d.chatLibrary.friendsDict))
                        ...
                        c.getUserConversations(e, d.chatApiParams.pageSizeOfConversations, d.chatLibrary.friendsDict).then(function(e) {
                            ...
                            return a && 0 < a.length && (t = T.getUserIdsNotInFriendsDict(a, e), d.buildChatUserListByConversations(a, i), d.retrieveDialogStatus()), d.chatLibrary.chatLayout.pageDataLoading && (d.chatLibrary.chatLayout.pageDataLoading = !1), d.chatLibrary.chatLayout.urlParseInitialized || Z(), S.getUserContacts(t, e), D.getUserInfo(t, e)
                        }, function(e) {
                            console.debug(e)
                        })
                            ...
                            switch (e) {
                                ...
                                case g.channelsNotificationType.participantsRemoved:
                                    d.chatLibrary.isWebChatTcEnabled ? setTimeout(function() {
                                        z(t)
                                    }, d.chatLibrary.rtnFetchConversationDelayMs) : z(t);
                                    break;
                                ...
                                case g.channelsNotificationType.removedFromChannel:
                                    d.chatLibrary.conversationsDict[t].remove || (i = d.chatLibrary.conversationsDict[t].layoutId, d.chatLibrary.conversationsDict[t].remove = !0, d.closeDialog(i), z(t));
                                    break;
                    ...
                    d.getTimeoutExpiresAt = function(e) {
                        ...
                        try {
                            switch (a.Type) {
                                case g.notificationType.friendshipDestroyed:
                                    ...
                                    }), E.getFriendsPresence(!0).then(function(e) {
                                        d.getFriendsInfo(e)
                                    }, function(e) {
                                        console.debug(e)
                        ...
                        try {
                            ...
                            return d.fetchAllWebChatSettings(!0).then(function(e) {
                                ...
                                e ? !t && e && (d.handleSignalRSuccess(!0), d.initializeRealTimeSubscriptionsForChat(), ee(j())) : d.unsubscribeRealTimeForChat(), d.maybeCloseNewGroupDialog(), d.$apply()
                            }).catch(function(e) {
                        ...
                        if (d.chatLibrary.chatLayout.numberOfDialogs > d.chatLibrary.chatLayout.availableNumberOfDialogs)
                            for (; d.chatLibrary.dialogIdList.length > d.chatLibrary.chatLayout.availableNumberOfDialogs;) {
                                ...
                                for (; d.chatLibrary.dialogIdList.length < d.chatLibrary.chatLayout.availableNumberOfDialogs;) {
                                    ...
                                    if (re().isUndefined(e)) break;
                                    e && d.chatLibrary.minimizedDialogData[e] && (delete d.chatLibrary.minimizedDialogData[e], d.chatLibrary.dialogIdList.push(e), a = le({}, g.dialogInitValue), d.chatLibrary.dialogDict[e] = a)
                                }
                        ...
                        switch (i.isGroupChat || i.dialogType !== g.dialogType.CHAT || i.participants.forEach(function(e) {
                            ...
                            case d.dialogType.CHAT:
                                ...
                                break;
                            default:
                                re().isDefined(i.Username) && (i.name = i.Username)
                        }
                        var a = [ne.UserProfileField.Names.CombinedName],
                            t = i.userIds,
                            n = i.isGroupChat;
                        M.watchUserProfiles(t, a).subscribe(function(e) {
                            e.loading, e.error;
                            var a = e.data,
                                t = [];
                            re().forEach(Object.entries(a), function(e) {
                                var a = ce(e, 2),
                                    e = a[0],
                                    a = a[1];
                                d.chatLibrary.friendsDict[e] && (d.chatLibrary.friendsDict[e].nameForDisplay = a.names.combinedName, t.push(a.names.combinedName))
                            }), t.sort();
                            e = t.join(", ");
                            n ? (a = i.conversationTitle.titleForViewer, g.updateConversationTitle(i, i.hasDefaultName ? e : a)) : g.updateConversationTitle(i, e), d.$applyAsync()
                        }), d.chatUserDict[i.layoutId] = i;
                        a = d.chatLibrary.chatLayoutIds.indexOf(i.layoutId); - 1 < a && d.chatLibrary.chatLayoutIds.splice(a, 1), e ? (e = d.chatLibrary.chatLayoutIds[0], d.chatUserDict[e], d.chatLibrary.chatLayoutIds.unshift(i.layoutId)) : d.chatLibrary.chatLayoutIds.push(i.layoutId), Y(i.layoutId), d.chatLibrary.conversationsDict[i.id] || (d.chatLibrary.conversationsDict[i.id] = le({}, g.conversationInitStatus), d.chatLibrary.conversationsDict[i.id].layoutId = i.layoutId)
                        ...
                        var t = se(regeneratorRuntime.mark(function e(s, c) {
                            var a, t;
                            return regeneratorRuntime.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        a = regeneratorRuntime.mark(function e(a) {
                                            ...
                                            return regeneratorRuntime.wrap(function(e) {
                                                for (;;) switch (e.prev = e.next) {
                                                    case 0:
                                                        return (t = s[a]).isGroupChat = g.conversationType.multiUserConversation === t.type, t.dialogType = t.isGroupChat ? g.dialogType.GROUPCHAT : g.dialogType.CHAT, d.getUserInfoForConversation(t), o = [ne.UserProfileField.Names.CombinedName], i = t.userIds, n = [], e.next = 9, M.queryUserProfiles(i, o);
                                                    case 9:
                                                        o = e.sent, re().forEach(o, function(e) {
                                                            n.push(e.names.combinedName)
                                                        }), n.sort(), o = n.join(", "), t.isGroupChat ? (r = t.conversationTitle.titleForViewer, g.updateConversationTitle(t, t.hasDefaultName ? o : r)) : g.updateConversationTitle(t, o), t.isUserPending = d.getIsUserPending(t), t.isConversationUnavailableWithUser = d.getIsConversationDisabledWithUser(t), l.formatTimestampInConversation(t), r = d.getLayoutId(t.id, g.dialogType.CHAT), d.chatUserDict[r] ? (o = d.chatUserDict[r], t.hasUnreadMessages && t.chatMessages && 0 < t.chatMessages.length && (o.hasUnreadMessages = !0, d.chatLibrary.dialogDict[r] && -1 < d.chatLibrary.dialogIdList.indexOf(r) && (l.processMessages(d.chatLibrary, o, t.chatMessages, d.chatLibrary.friendsDict), v.fetchDataForLinkCard(t.chatMessages, d.chatLibrary)), l.updateAndSanitizePreviewMessage(o, t.chatMessages), d.updateChatViewModel(o, !0)), t.title !== o.title && g.updateConversationTitle(o, t.title), o.participants = t.participants, o.isUserPending = t.isUserPending, o.isConversationUnavailableWithUser = t.isConversationUnavailableWithUser, o.moderationType = t.moderationType, o.participantPendingStatus = t.participantPendingStatus, o.userPendingStatus = t.userPendingStatus, o.osaAcknowledgementStatus = t.osaAcknowledgementStatus, d.getUserInfoForConversation(o), c && _(o)) : (d.updateConversationInLocalStorage(t), t.layoutId = r, d.updateChatViewModel(t, !0), c && _(t)), d.$apply();
                                                    case 20:
                                                    case "end":
                                                        return e.stop()
                                                }
                                    ...
                                    case 2:
                                        if (t < s.length) return e.delegateYield(a(t), "t0", 4);
                                        e.next = 7;
                                        break;
                                    case 4:
                                        t++, e.next = 2;
                                        break;
                                    case 7:
                                        return re().equals(d.chatUserDict, {}) || (d.chatLibrary.chatLayout.chatLandingEnabled = !1), e.abrupt("return", s);
                                    case 9:
                                    case "end":
                                        return e.stop()
                                }
                        ...
                        d.sendChatLandingEvent(A.chatLandingConversationClicked, U.ChatLandingConversationClickedWeb, e), d.launchDialog(e, !1)
                    ...
                    d.closeDialog = function(e) {
                        ...
                        d.chatLibrary.chatLayout.focusedLayoutId === e && g.updateFocusedDialog(d.chatLibrary, null), d.deleteLayoutIdFromDialogList(e), a && a.dialogType === g.dialogType.NEWGROUPCHAT && (a.selectedUserIds = [], a.selectedUsersDict = {}, a.numberOfSelected = 0), t && 0 < t.length && t.mCustomScrollbar("destroy"), d.$broadcast("Roblox.Chat.MarkDialogInactive", {
                            layoutId: e
                        }), a && (t = a.id, d.chatLibrary.conversationsDict[t] && d.chatLibrary.conversationsDict[t].remove ? (-1 < (t = d.chatLibrary.chatLayoutIds.indexOf(e)) && a && (d.chatLibrary.chatLayoutIds.splice(t, 1), delete d.chatUserDict[e], re().equals(d.chatUserDict, {}) && (d.chatLibrary.chatLayout.chatLandingEnabled = !0)), Y(e, !0)) : l.processMessages(d.chatLibrary, a, null)), d.destroyDialogLayout(e), 0 < d.chatLibrary.minimizedDialogIdList.length && (a = d.chatLibrary.minimizedDialogIdList.shift(), delete d.chatLibrary.minimizedDialogData[a], d.chatLibrary.dialogIdList.push(a), d.chatLibrary.dialogDict[a].isUpdated = !0, d.chatLibrary.dialogDict[a].updateStatus = g.dialogStatus.REPLACE), r.updateStorage(r.storageDictionary.dialogIdList, d.chatLibrary.dialogIdList, d.chatLibrary.cookieOption), r.updateStorage(r.storageDictionary.dialogDict, d.chatLibrary.dialogDict, d.chatLibrary.cookieOption), d.chatLibrary.dialogsLayout && d.chatLibrary.dialogsLayout[e] && (d.chatLibrary.dialogsLayout[e].collapsed = !1), delete d.chatLibrary.dialogsLayout[e], r.updateStorage(r.storageDictionary.dialogsLayout, d.chatLibrary.dialogsLayout, d.chatLibrary.cookieOption)
                        ...
                        var a = B(e);
                        c.getModalSequence(le(le({}, g.getDynamicConversationId(a)), {}, {
                        ...
                        d.chatUserDict && d.chatLibrary || d.setup(), d.chatLibrary.countryRegions = {}, h.logSinglePerformanceMark(g.performanceMarkLabels.chatConversationsLoading), d.updateUnreadConversationCount(), d.getUserConversations(), d.chatLibrary.isWebChatTcEnabled && R.getCountryRegions().then(function(e) {
                        ...
                        try {
                            ...
                            var i = null !== (r = null === (n = d.chatUserDict) || void 0 === n ? void 0 : n[t]) && void 0 !== r ? r : {},
                                ...
                                n = {
                                    ...
                                    isFiltered: !!r,
                                    selectedConversationId: O.getConversationIdForAnalytics(i),
                                    hasUnreadMessages: !!n
                                };
                            O.sendEvent(a, n)
                        } catch (e) {
                        ...
                        try {
                            var a, t;
                            if (!d.chatLibrary.shouldSendEvents) return;
                            O.incrementCounter(U.WebChatConversationsLoadedWeb);
                            var r = [],
                                o = [];
                            re().forEach(e, function(e) {
                                var a = e.id,
                            ...
                            O.sendEvent(A.webChatConversationsLoaded, i)
                        } catch (e) {
                        ...
                        re().element(s).bind("resize", function() {
                            ...
                            r.removeFromStorage(r.storageDictionary.dialogIdList, d.chatLibrary.cookieOption), r.removeFromStorage(r.storageDictionary.dialogDict, d.chatLibrary.cookieOption), r.removeFromStorage(r.storageDictionary.dialogsLayout, d.chatLibrary.cookieOption), r.removeFromStorage(r.storageDictionary.chatBarLayout, d.chatLibrary.cookieOption), r.removeFromStorage(r.storageDictionary.chatFriendsListReloadTime), e.removeLocalStorage(d.chatLibrary.dialogLocalStorageName), I.clearLocalStorage()
                        ...
                        var a = e.metadataResponse,
                            ...
                            i = e.renameFriendsPoliciesResponse,
                            n = ie.EnvironmentUrls.domain;
                        ...
                        d.chatViewModel = le({}, m.chatViewModel)
                    ...
                    d.fetchAllWebChatSettings = function(e) {
                        e = [c.getMetaData(e), w.getChatUiPolicies(), w.getRenameFriendsPolicies()];
                        return Promise.allSettled(e).then(function(e) {
                            var a = ce(e, 3),
                                ...
                                a = a[2];
                            return {
                                metadataResponse: te(t),
                                chatUiPoliciesResponse: te(e),
                                renameFriendsPoliciesResponse: te(a)
                            }
                        })
                ...
                function i(l, e, a, t, i, n, d) {
                    ...
                    l.chatLibrary.isWebChatTcEnabled && (c(r = {}, t.friendshipOriginType.QR_CODE, {
                        ...
                        l.dismissContactCard(), i.removeTrustedConnection(l.getOneToOneFriendId()).then(function() {
                            l.showAlert("TrustedConnection.Toast.TrustedConnectionRemoved")
                        }).catch(function() {
                        ...
                        return e.forEach(function(e) {
                            ...
                            e && (e.mutualFriendInsight && (1 === (a = Object.keys(null !== (t = e.mutualFriendInsight.mutualFriends) && void 0 !== t ? t : {}).length) ? c.push({
                                ...
                                text: d.get("Label.MutualConnection")
                            }) : c.push({
                                iconClass: "icon-friends",
                                text: d.get("Label.MutualConnections", {
                                    numConnections: a
                                })
                                ...
                                years: Math.floor((i - t) / p),
                                months: Math.floor((i - t) / h),
                                ...
                                num: a
                            }) : d.get("Label.NewConnection"), c.push(n)), (n = null === (n = l.chatLibrary.countryRegions[null === (n = e.accountLocationInsight) || void 0 === n ? void 0 : n.accountLocationCode]) || void 0 === n ? void 0 : n.displayName) && c.push({
                        ...
                        "contactCard" === (null === (e = l.dialogLayout) || void 0 === e ? void 0 : e.currentDialogScreen) && a && (a = a, n.getProfileInsights(a).then(function(e) {
            ...
            3617: function(e, a, t) {
                ...
                function n(c, l, t, i, d, n, r, o, u, a, s, g, h, p, y, m, e, v) {
                    ...
                    c.dismissContactCard = function() {
                        var e, a, t;
                        c.dialogLayout.shouldShowContactCard = !1, t = c.chatLibrary.modals.conversationOverlays[c.dialogData.layoutId], i.recordModalSequenceResponse(P(P({}, d.getDynamicConversationId(c.dialogData)), {}, {
                        ...
                        c.dialogLayout.alertMessage = v.get(e), c.dialogLayout.shouldShowAlert = !0, b && t.cancel(b), b = t(function() {
                        ...
                        Object.assign(i, t)
                    }, c.dialogParams = P({}, d.dialogParams), c.userPresenceTypes = d.userPresenceTypes, c.dialogData.messageForSend = "", c.dialogLayout.scrollbarElm = d.getScrollBarSelector(c.dialogData, d.scrollBarType.MESSAGE), c.dialogLayout.listenToScrollInitialized = !1, c.friendsScrollbarElm = d.getScrollBarSelector(c.dialogData, d.scrollBarType.FRIENDSELECTION), c.updatePopoverParams(), c.updateDialog = function() {
                        return l.debug("---- updateDialog callback ---- Scrollbars updated"), c.dialogLayout.IsdialogContainerVisible || (S().element(c.dialogLayout.scrollbarElm).find(".mCustomScrollBox").addClass("dialog-visible"), c.dialogLayout.IsdialogContainerVisible = !0), !1
                        ...
                        if (c.dialogLayout.isAbuseReportConfirmationOn = !0, e && (c.dialogLayout.userIdForAbuseReport = e), a && c.dialogLayout.userIdForAbuseReport) {
                            if (c.abuseReportRevampEnabled) {
                                var t = new URLSearchParams({
                                        ...
                                        submitterId: T.CurrentUser.userId,
                                        abuseVector: "chat",
                            ...
                            t = s("formatString")(d.chatLayout.abuseReportUrl, {
                                ...
                                conversationId: c.dialogData.id
                            }), t = T.Endpoints ? T.Endpoints.getAbsoluteUrl(t) : t;
                            T.AbuseReportDispatcher ? T.AbuseReportDispatcher.triggerUrlAction(t) : window.location.href = t, c.dialogLayout.userIdForAbuseReport = null, c.dialogLayout.isAbuseReportConfirmationOn = !1
                        }
                        ...
                        c.keystrokeCollectionEnabled && 0 != d.dialogParams.keystrokeSampleRate && (t = Math.round(1 / d.dialogParams.keystrokeSampleRate), parseInt(a) % t == 0 && (a = (new Date).getTime(), "keyup" != e.type && "keydown" != e.type || (t = "keyup" == e.type ? 1 : 0, a = {
                            ...
                            eventType: t,
                            timestamp: a
                        }, c.keystrokeData.push(a), "Enter" == e && 1 == t ? (r = (n = L(c.keystrokeData)).keyPressedData, i = n.eventTypeData, n = n.timestampData, T.EventStream.SendEventWithTarget("appChatKeyStrokes", "enterPressed", {
                            keyPressedData: JSON.stringify(r),
                            eventTypeData: JSON.stringify(i),
                            timestampData: JSON.stringify(n)
                        }, T.EventStream.TargetTypes.WWW), c.keystrokeData = []) : c.keystrokeData.length >= d.dialogParams.maxKeystrokeDataLength && (i = (r = L(c.keystrokeData)).keyPressedData, n = r.eventTypeData, r = r.timestampData, T.EventStream.SendEventWithTarget("appChatKeyStrokes", "maxLengthReached", {
                            keyPressedData: JSON.stringify(i),
                            eventTypeData: JSON.stringify(n),
                            timestampData: JSON.stringify(r)
                        }, T.EventStream.TargetTypes.WWW), c.keystrokeData = []))))
                        ...
                        a ? (c.resetConfirmDialog(), c.getLimitLinkNameForMemberList(1), i.removeFromConversation(e, c.dialogData.id).then(function() {
                            data && data.status === d.resultType.SUCCESS && c.isOverLoaded()
                        ...
                        var i = p.getConversationIdForAnalytics(c.dialogData);
                        try {
                            if (!c.chatLibrary.shouldSendEvents) return;
                            p.incrementCounter(e);
                            var n = P({
                                localTimestamp: Date.now(),
                                conversationId: i
                            }, t);
                        ...
                        var a = p.getConversationIdForAnalytics(c.dialogData);
                        try {
                            if (!c.chatLibrary.shouldSendEvents) return;
                            p.incrementCounter(m.WebChatConversationRenderedWeb);
                            var e = {
                                localTimestamp: Date.now(),
                                conversationId: a,
                            ...
                            p.sendEvent(y.webChatConversationRendered, e)
                        } catch (e) {
                    ...
                    c.$watch(function() {
                        ...
                        var t;
                        a && !e && clearTimeout(C), e && !a && (t = c.chatLibrary.modals.conversationOverlays[c.dialogData.layoutId], C = setTimeout(function() {
                            var e, a;
                            i.recordModalSequenceResponse(P(P({}, d.getDynamicConversationId(c.dialogData)), {}, {
                                modalSequence: d.modalSequence.CONVERSATION_OVERLAY,
                                modalId: null == t || null === (e = t.modal_layout) || void 0 === e ? void 0 : e.id,
                                modalVariant: null == t ? void 0 : t.modal_variant,
                        ...
                        a.layoutId === c.dialogData.layoutId && C && clearTimeout(C)
                    ...
                    }), c.dialogData.dialogType === d.dialogType.FRIEND || c.dialogData.isUserPending || (D = (I = d.shouldScrollFromTop(c.dialogData, c.chatLibrary)) ? i.getAllMessages(c.dialogData.id) : i.getMessages(c.dialogData.id, null, c.dialogParams.pageSizeOfGetMessages), S().isUndefined(c.dialogData.messagesDict) && (c.dialogLayout.isChatLoading = !0), D.then(function(e) {
                        var a = e.messages;
                        c.dialogLayout.isChatLoading = !1, a ? (c.dialogParams.getMessagesNextCursor = e.next_cursor, c.dialogData.chatMessages = [], c.dialogData.messagesDict = {}, n.processMessages(c.chatLibrary, c.dialogData, a, c.chatLibrary.friendsDict), u.fetchDataForLinkCard(a, c.chatLibrary), c.dialogData.scrollBarType = d.scrollBarType.MESSAGE, e.next_cursor || (c.dialogParams.loadMoreMessages = !1), I && (c.updateDialog(), c.$apply())) : (c.dialogData.scrollBarType = d.scrollBarType.MESSAGE, c.updateDialog())
                ...
                n.$inject = ["$scope", "$log", "$timeout", "chatService", "chatUtility", "messageService", "dialogAttributes", "keyCode", "gameService", "resources", "$filter", "messageHelper", "httpStatusCodes", "analyticsService", "eventNames", "diagActionList", "guacService", "languageResource"], t.A.controller("dialogController", n), a.default = n
            },
            3848: function(e, a, t) {
                "use strict";
                t.r(a);
                ...
                function n(r, n, o, s, i) {
                    r.isNewGroupChat = function(e) {
                        ...
                        r.newGroupChatLocked || (r.newGroupChatLocked = !0, i = {
                            ...
                            var a;
                            e.status === o.resultType.SUCCESS && ((a = r.chatLibrary.allConversationLayoutIdsDict[e.id]) ? (i.isDuplicatedConversation = !0, r.resetPreviousDialog(t.layoutId, a, i), r.chatLibrary.dialogIdList.indexOf(a) < 0 && r.launchDialog(a, !0)) : (e.isGroupChat = e.type === o.conversationType.multiUserConversation, s.formatTimestampInConversation(e), r.generateDialog(e, o.dialogType.GROUPCHAT, i))), r.newGroupChatLocked = !1
                        }).catch(function(e) {
            ...
            6340: function(e, a, t) {
                ...
                function o(s, e, a, t, i, n, r, c, o) {
                    s.dialogLayout.scrollToBottom = !1, s.dialogLayout.IsdialogContainerVisible = !1, s.dialogParams = g({}, e.dialogParams), s.dialogType = g({}, e.dialogType), s.userPresenceTypes = g({}, e.userPresenceTypes), s.friendsScrollbarElm = e.getScrollBarSelector(s.dialogData, e.scrollBarType.FRIENDSELECTION), s.dialogData.scrollBarType = e.scrollBarType.FRIENDSELECTION, s.dialogData.isCreated = !0, s.updateFriendsDictData = function(e) {
                        ...
                        }), r && 0 < r.length && a.getAvatarHeadshots(r, s.chatLibrary.friendsDict))
                    };
            ...
            5300: function(e, a, t) {
                ...
                function i(r, t, i, n, o, s, c, l, d, u) {
                    r.isLinkCardAvailableAndParsedByClientSide = function(e) {
                        ...
                        var i = g.GameLauncher.isJoinAttemptIdEnabled() ? h.uuidService.generateRandomUuid() : void 0,
                        ...
                        i = "".concat(t.placeUrl, "?").concat(h.urlService.composeQueryString(i));
                        c.location.href = h.urlService.getAbsoluteUrl(i)
                        ...
                        var e = p.elementVisibilityService.observeVisibility({
                            element: t[0],
                            threshold: .5
                        }, function(e) {
            ...
            6893: function(e, a, t) {
                ...
                function i(s, i, t, n, r, c, o, l, d, u, g, h, p) {
                    s.sendEventStream = function(e, a, t, i) {
                        ...
                        var a = s.playTogether.playTogetherDict[e].placeId,
                            ...
                            i = p.buildPlayGameProperties(e, a, t, i),
                            e = {
                                placeId: e,
                                conversationId: s.playTogether.id
                            };
                        ...
                        var e, a, t, i, n, r, o;
                        s.playTogetherLayout = Object.assign({}, c), s.gameParameters = Object.assign({}, d), s.gameLayout = Object.assign({}, g), s.pinGameLayout = Object.assign({}, h), s.dialogData ? (s.playTogether = s.dialogData, s.playTogether.inDialog = !0, s.playTogetherLayout.numberOfActiveGames = s.hasActiveGames(), e = s.playTogetherLayout.numberOfActiveGames, a = (i = s.playTogetherLayout.activeGamesList).isCollapsed, t = i.pinGameIsInActiveGames, n = i.limitNumber, o = i.minNumberForFit, r = i.maxNumberForFit, i = i.showLess, t && (n = {
                            limitNumber: n + 1,
                            minNumberForFit: o + 1,
                            maxNumberForFit: r + 1
            ...
            9763: function(e, a, t) {
                ...
                function o(p, o, s, c, y, m, l, v, f, e, a, b, t, i, L) {
                    return {
                        restrict: "A",
                        scope: {
                            dialogData: "=",
                        ...
                        link: function(d, u) {
                            ...
                            function r(e) {
                                var a = C().isDefined(d.dialogData.userIds) ? d.dialogData.userIds.indexOf(e) : -1,
                                    e = C().isDefined(d.dialogData.selectedUserIds) ? d.dialogData.selectedUserIds.indexOf(e) : -1;
                                return a < 0 && e < 0
                            }
                            ...
                            d.updateDialogStyle = function() {
                                ...
                                p.document.title = e % 2 == 0 ? d.title : d.chatLibrary.currentTabTitle, e++
                                ...
                                if (C().isDefined(e) && C().isDefined(e[d.dialogData.layoutId])) {
                                    ...
                                    if (!a[t] || r.isUpdated) switch (C().isDefined(d.chatLibrary.dialogsLayout[d.dialogData.layoutId]) ? d.dialogLayout = d.chatLibrary.dialogsLayout[d.dialogData.layoutId] : C().isUndefined(d.dialogLayout) ? d.dialogLayout = C().copy(y.dialogLayout) : r.updateStatus === y.dialogStatus.INIT && d.dialogLayout && (d.dialogLayout.renameEditor = D({}, y.dialogLayout.renameEditor)), r.isUpdated = !1, r.updateStatus) {
                                        ...
                                        case y.dialogStatus.INIT:
                                            -1 < n && (d.dialogLayout.focusMeEnabled === r.autoOpen && (d.dialogLayout.focusMeEnabled = !r.autoOpen), d.checkNewGenerationDialogStatus(), g(), h());
                                            break;
                        ...
                        link: function(n, e) {
                            ...
                            e.mCustomScrollbar({
                                ...
                                callbacks: {
                                    ...
                                    onUpdate: function() {
                                        t.debug("---- onUpdate callback ---- Scrollbars updated" + n.dialogLayout.scrollToBottom), n.dialogLayout.scrollToBottom ? (e.mCustomScrollbar("scrollTo", "bottom", {
                                            scrollInertia: 0
            ...
            8994: function(e, a, t) {
                ...
                function r(e) {
                    return {
                        ...
                        scope: !0,
                        link: function(e) {
                            n().element("#dialogs-minimize").on("click touchstart", ".popover-content #" + e.dialogLayoutId + " .minimize-title", function() {
                                e.$apply(e.openDialog(e.dialogLayoutId))
                            });
                            n().element("#dialogs-minimize").on("click touchstart", ".popover-content #" + e.dialogLayoutId + " .minimize-close", function() {
                    ...
                    return {
                        ...
                        link: function(i, e) {
                            ...
                            i.$watch(function() {
                                ...
                                var t;
                                e && e !== a && (t = "#" + i.dialogData.layoutId + " .dialog-container", a = "#" + i.dialogData.layoutId + " " + i.friendsScrollbarElm, t = o().element(t), a = o().element(a), e = n + i.chatLibrary.layout.detailsActionHeight + e, i.dialogData.dialogType === r.dialogType.NEWGROUPCHAT && (e += i.chatLibrary.layout.detailsInputHeight), e = t.height() - e, a.css("height", e), a.mCustomScrollbar("update"))
                            }, !0)
                        }
                    }
                }
                        ...
                        link: function(i, e) {
                            ...
                            function c() {
                                g.on("click", function(e) {
                                    e.stopPropagation();
                                    var a, t = h().element(e.target);
                                    l(t) || (a = t, (e = h().element(n)).find(a) && 0 < e.find(a).length) || function(e) {
                                        var a = !1;
                                        ! function(e) {
                                            return e.hasClass(r)
                            ...
                            e.on("click", function(e) {
                                l(h().element(e.target)) && (i.dialogLayout.togglePopoverParams.isOpen = !i.dialogLayout.togglePopoverParams.isOpen)
                            });
                ...
                function n(e, a, o) {
                    ...
                    return {
                        sendEvent: function(e, a) {
                            s.EventStream && s.EventStream.SendEventWithTarget(e, "WebChatEventContext", a, s.EventStream.TargetTypes.WWW)
                        },
                        ...
                        sendInterventionEvent: function(e) {
                            ...
                            s.EventStream && (r = {
                                ...
                                placement: "Web"
                            }, a !== o.eventTypes.appealClicked && a !== o.eventTypes.ctaClicked && a !== o.eventTypes.learnClicked || (r.time_to_interact_seconds = (e - i) / 1e3), s.EventStream.SendEventWithTarget(o.eventName, o.eventContext, r, s.EventStream.TargetTypes.WWW))
                        }
                    }
                }
                n.$inject = ["$log", "chatUtility", "featureInterventionAnalytics"], i.A.factory("analyticsService", n), a.default = n
            },
            5577: function(e, a, t) {
                "use strict";
                t.r(a);
            ...
            717: function(e, a, t) {
                    ...
                    var i = function(e) {
                        for (var a in e) {
                            ...
                            for (t in i.participant_user_ids) {
                                var r = Object.assign({}, i.user_data[i.participant_user_ids[t]]);
                                n.push(r)
                            }
                            ...
                            }, i.userPendingStatus = i.user_pending_status, i.participantPendingStatus = i.participant_pending_status, i.moderationType = i.moderation_type, i.osaAcknowledgementStatus = i.osa_acknowledgement_status
                        }
                    };
                    return {
                        apiSets: {},
                        ...
                        getMetaData: function(e) {
                            var a = 0 < arguments.length && void 0 !== e && e ? s(s({}, t.apiSets.getMetaData), {}, {
                                ...
                                e = {
                                    userId: null !== (e = null === n.CurrentUser || void 0 === n.CurrentUser ? void 0 : n.CurrentUser.userId) && void 0 !== e ? e : ""
                                };
                ...
                o.$inject = ["$q", "chatUtility", "httpService", "$log", "apiParamsInitialization"], t.A.factory("chatService", o), a.default = o
            },
            6611: function(e, a, t) {
                "use strict";
                t.r(a);
                ...
                function n(o, e, c, a, t, i, n, r, s, l, d, u, g, h) {
                    function p(e) {
                    ...
                    return {
                        ...
                        userPresenceTypes: f().copy(n.userPresenceTypes),
                        ...
                        friendshipOriginType: f().copy(c.friendshipOriginType),
                        ...
                        buildEmojiPieces: function(e) {
                            ...
                            for (var a = e.content, t = g.emojiRegex, i = g.zwjRegex, n = g.emojiRepRegex, r = "", o = !1, s = 0; null !== (l = t.exec(a));) {
                                var c = l.index,
                                    l = l[0];
                                s !== c ? (r && e.pieces.push(m(r, !0)), e.pieces.push(m(a.slice(s, c), !1)), r = l) : null != l.match(i) ? (r += "&zwj;", o = !0) : o || null != l.match(n) ? (r += l, o = !1) : (r && e.pieces.push(m(r, !0)), r = l), s = t.lastIndex
                            }
                            r && e.pieces.push(m(r, !0)), s < a.length && e.pieces.push(m(a.slice(s), !1))
                        },
                        buildLinkCardMessages: function(e) {
                            ...
                            if (a && 0 < a.length) {
                                ...
                                for (var i = 0; i < t.length; i++) {
                                    var n = t[i],
                                        r = null;
                                    n.match(g.urlRegex) ? r = this.buildLinkCard(n) : n && 0 < n.length && !n.match(g.onlyNewLineRegex) && (r = {
                                        content: n = p(n = n.replace(g.removeNewLineRegex, "")),
                                        isCard: !1
                        ...
                        sanitizeMessage: function(e) {
                            var a, t;
                            e && e.content && !e.isSanitized && (a = e.content, t = e.content, e.content = p(e.content), t !== e.content ? (e.parsedContent = a, e.hasLinkCard = !0, e.hasLinkifyMessage = this.hasLinkifyContent(e.content), this.buildLinkCardMessages(e)) : this.buildEmojiPieces(e), e.isSanitized = !0)
                        },
                        ...
                        calculateRightPosition: function(e, a) {
                            for (var t = this.chatLayout.widthOfDialog + this.chatLayout.spaceOfDialog, i = this.chatLayout.widthOfCollapsedDialog + this.chatLayout.spaceOfDialog, n = 0, r = 0; r < a; r++) {
                                ...
                                n += ((null === (o = e.dialogsLayout) || void 0 === o ? void 0 : o[s]) || f().copy(c.dialogLayout)).collapsed ? i : t
                            }
                            return n
                        },
                        updateDialogsPosition: function(e) {
                            for (var a = e.chatLayout, t = a.widthOfChat, i = 0; i < e.dialogIdList.length; i++) {
                                var n = "#" + e.dialogIdList[i],
                                    r = f().element(document.querySelector(n)).find(this.dialogLayout.dialogContainerClass),
                        ...
                        updateFocusedDialog: function(e, a) {
                            h.debug(" ------ focused layoutId ------ " + a), e.chatLayout.focusedLayoutId = a
                        },
            ...
            380: function(e, a, t) {
                ...
                function i(e) {
                    var t = e,
                        ...
                        n = {
                            ...
                            memberDisplay: {
                                ...
                                defaultLimit: 3,
                                isAll: !1,
                                linkName: t.get("Label.SeeMore"),
                                seeMoreLink: t.get("Label.SeeMore"),
                                seeLessLink: t.get("Label.SeeLess"),
                                toastText: function(e, a) {
                                    return e ? t.get("Message.AddConnectionsLimit", {
                                        connectionsNum: a
                                    }) : t.get("Message.ToastText", {
                                        friendNum: a
                                    })
                                },
                                timeoutToast: 5e3
                    ...
                    return {
                        ...
                        negativeAction: {
                            removeUser: {
                                title: t.get("Heading.RemoveUser"),
                                headerTitle: t.get("Heading.RemoveUser"),
                                btnName: t.get("Action.Remove"),
                                cancelBtnName: t.get("Action.Cancel"),
                                type: "removeUser"
                            },
                            leaveChatGroup: {
                                title: t.get("Heading.ConfirmLeaving"),
                                headerTitle: t.get("Heading.LeaveChatGroup"),
                                btnName: t.get("Action.Leave"),
                                cancelBtnName: t.get("Action.Stay"),
                                type: "leaveChatGroup"
                            }
                        },
                        newGroup: {
                            ...
                            layoutId: "newGroup",
                            title: t.get("Heading.NewChatGroup")
                        },
                        scrollBarTypes: {
                            MESSAGE: 0,
                            FRIENDSELECTION: 1
                            ...
                            if (e) {
                                ...
                                if (n.placesLibrary[t] = {
                                    ...
                                    case c.reasonProhibitedMessage.Playable:
                                        n.placesLibrary[t].buttonLayoutForLinkCard = p().copy(o.playButtons.play);
                                        break;
                                    case c.reasonProhibitedMessage.PurchaseRequired:
                                    default:
                                        n.placesLibrary[t].buttonLayoutForLinkCard = p().copy(o.playButtons.details)
                                }
                    ...
                    return {
                        ...
                        fetchDataForLinkCard: function(e, i) {
                            ...
                            e.forEach(function(t) {
                                ...
                                return e ? void g(i, e, r) : (h(i, n), s.invalidateLinkCardsInMessageDict(n, r), !1)
                            }, function() {
                                h(i, n), s.invalidateLinkCardsInMessageDict(n, r)
                            })
                        },
                        updateButtonLayoutPerConversation: function(e, a) {
                            ...
                            e.pinGame && e.playTogetherIds && -1 < e.playTogetherIds.indexOf(a) ? e.placeButtonLayout[a] = p().copy(o.playButtons.join) : e.placeButtonLayout[a] = p().copy(o.playButtons.play)
                        },
                        buildButtonLayoutPerConversation: function(t, i) {
                            var e = [],
                                n = null,
                                r = !0;
                            t.playTogetherIds && 0 < t.playTogetherIds.length && (e = p().copy(t.playTogetherIds)), t.pinGame && (n = t.pinGame.rootPlaceId, e.indexOf(n) < 0 && (r = !1, e.push(n))), t.placeButtonLayout || (t.placeButtonLayout = {}), p().forEach(e, function(e) {
                                var a = i[e];
                                if (a) switch (a.reasonProhibited) {
                                    case c.reasonProhibitedMessage.None:
                                    case c.reasonProhibitedMessage.Playable:
                                        t.placeButtonLayout[e] = r || e !== n ? p().copy(o.playButtons.join) : p().copy(o.playButtons.play);
                                        break;
                                    case c.reasonProhibitedMessage.PurchaseRequired:
                                        t.placeButtonLayout[e] = p().copy(o.playButtons.details);
                                        break;
                                    default:
                                        t.placeButtonLayout[e] = p().copy(o.playButtons.notAvailable)
                                }
                            })
                        },
                            ...
                            return e.getGamesInfo = t.httpGet(r.getGamesByUniverseIds, a), e.getPlayabilityStatus = t.httpGet(r.multiGetPlayabilityStatus, a), i.all(e).then(function(e) {
                                if (e && e.getGamesInfo && e.getPlayabilityStatus) {
                                    var a = e.getGamesInfo.data,
                                        ...
                                        r = {},
                                        o = {};
                                    return p().forEach(a, function(e, a) {
                                        var t = e.rootPlaceId,
                                            i = n[a].universeId;
                ...
                function n(e, a, t) {
                    return {
                        getChatUiPolicies: function() {
                            return a.httpGet({
                                url: "".concat(i.EnvironmentUrls.apiGatewayUrl, "/universal-app-configuration/v1/behaviors/chat-ui/content"),
                                retryable: !0,
                                withCredentials: !0
                            })
                        },
                        ...
                        getAbuseReportRevampPolicies: function() {
                            return a.httpGet({
                                url: "".concat(i.EnvironmentUrls.universalAppConfigurationApi, "/v1/behaviors/abuse-reporting-revamp/content"),
                                retryable: !0,
                                withCredentials: !0
                            })
                        },
                        getRenameFriendsPolicies: function() {
                            return a.httpGet({
                                url: "".concat(i.EnvironmentUrls.universalAppConfigurationApi, "/v1/behaviors/web-rename-friends/content"),
                                retryable: !0,
                                withCredentials: !0
                            })
                        }
            ...
            184: function(e, a, t) {
                ...
                function n(t, d, u, g, h, r, a, p, o, s, y) {
                    var n = 3e4;
                    ...
                    function f() {
                        for (var e in i) {
                            ...
                            t.markAsRead(e).then(function(e) {
                                ...
                                h.debug("----- markAsRead request is failed ! ------")
                            })
                        }
                        m = !(i = {})
                    }
                    return {
                        ...
                        manipulateMessages: function(e, a, t) {
                            if (a || (e.messagesDict = {}), b().isUndefined(e.messagesDict) && (e.messagesDict = {}), a && 0 < a.length) {
                                ...
                                for (var r = i - 1; 0 <= r; r--) {
                                    var o = a[r];
                                    this.buildTimeStamp(o, e), o.type === d.messageSenderType.SYSTEM && (o.isSystemMessage = !0), e.messagesDict[o.id] || (e.messagesDict[o.id] = o, this.setClusterMaster(e, o)), c = t, l = n, (s = o).type === p.messageTypes.user && (c && !c[s.sender_user_id] && l.indexOf(s.sender_user_id) < 0) && (s = o.sender_user_id, h.debug(" ----- new friend information for this message, trying to get now -----" + s), o = [s], n.push(s), y.getUserInfo(o, t))
                                }
                ...
                function n(t, i, n) {
                    return {
                        getAvatarHeadshots: function(e, t) {
                            ...
                            return n.buildBatchPromises(a, e, 50, "userIds").then(function(e) {
                                if (e && 0 < e.length) {
                                    var a = [];
...
//# sourceMappingURL=https://sourcemaps.rbxcdn.com/816b8ad2ce14a1fce232ab80993d8858-chat.bundle.min.js.map
