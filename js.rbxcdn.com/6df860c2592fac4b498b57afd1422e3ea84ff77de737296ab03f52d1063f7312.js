...
Roblox.LangDynamic["Common.VisitGame"] = {
	...
	"Response.Dialog.MacFirstInstruction": "Once downloaded, double-clicking the {startBold}Roblox.dmg{endBold} file in your Downloads folder.",
	"Response.Dialog.WindowsFirstInstruction": "Once downloaded, double-clicking the {startBold}Roblox.exe{endBold} file in your Downloads folder.",
	"Response.Dialog.SecondInstruction": "Double-clicking the {startBold}RobloxPlayerInstaller{endBold} to install the app.",
