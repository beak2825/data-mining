	...
	var Fa = function(a) {
			...
			return a.replace(Ea, function(d, e) {
				...
				if (!h) {
					...
					if (c.nodeType === 1 && (e = c.tagName, e === "SCRIPT" || e === "STYLE")) throw Error(e === "SCRIPT" ? "Use safeScriptEl.setTextContent with a SafeScript." : "Use safeStyleEl.setTextContent with a SafeStyleSheet.");
