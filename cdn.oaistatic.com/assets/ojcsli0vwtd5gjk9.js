...
import "./kzmonehgvzu37er8.js";
import "./gccpliftrb26jmv2.js";
import "./h4y2be58evzp50oz.js";
import "./f9rv07xfg1rgyv7i.js";
import "./licto72kg488zsoz.js";
import "./iu7w9vyyt43hbo7k.js";
const rr = () => (C(), {
		prefetchSearch: null
	}),
	tr = ({
		...
		const r = s.searchParams,
			t = e.searchParams;
		return r.get(p) !== t.get(p) || r.get("q") !== t.get("q")
	},
	or = n(function() {
		const e = u(),
			{
		...
		const i = h();
		return m.useEffect(() => S(i, c.queryKey, () => {
			l.addFirstTiming("load.models")
		}), [i]), o.jsxs(o.Fragment, {
			children: [o.jsx(y, {
				...e,
				urlThreadId: r,
...
export {
	rr as clientLoader, or as
	default, tr as shouldRevalidate
};
//# sourceMappingURL=ojcsli0vwtd5gjk9.js.map