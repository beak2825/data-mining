...
function me({
	...
	const s = e.jsx("a", {
		...
		className: "cursor-pointer underline",
		onClick: o => {
			o.preventDefault(), h.logEventWithStatsig("Memory Full Warning Upsell Clicked", "chatgpt_memory_full_warning_upsell_clicked_memory_modal"), te(i, "MemoryUsageWarning Memory Modal Upsell")
		},
		children: e.jsx(d, {
			id: "djYoOr",
...
function ce({
	...
	const [a, i] = j.useState(!1), s = w(), o = F(), m = L(), c = async () => {
...
function ue({
	...
	const r = w(),
		...
		i = D(),
		{
			...
			mutationFn: async M => {
				const {
					success: v
				} = await N.safeDelete("/memories/{memory_id}", {
					parameters: {
						path: {
							memory_id: M
						}
				...
				if (!v) throw new Error("An error occurred while deleting the memory")
			},
			onSettled: () => {
				i.invalidateQueries({
					queryKey: P(t?.id)
	...
	return e.jsxs(e.Fragment, {
		children: [e.jsxs(g.Row, {
			...
			children: [e.jsx(g.Cell, {
				...
				children: e.jsx(g.Actions, {
					children: e.jsx("button", {
						onClick: () => {
							h.logEvent("Memory Manage Modal Memory Delete Clicked"), c(!0)
						},
						"aria-label": u,
			...
			onConfirm: () => {
				h.logEvent("Memory Manage Modal Memory Delete Confirmed"), s(n.id), c(!1)
			},
			onClose: () => {
				c(!1)
			},
...
export {
	de as M, fe as a, pe as b, A as u
};
//# sourceMappingURL=h8q9ocb5f5u66xjv.js.map