const __vite__mapDeps = (i, m = __vite__mapDeps, d = (m.f || (m.f = ["assets/ksc7cmkbpcodyd9o.js", "assets/fyeo2h7okrqcf3nz.js", "assets/egb2c0f6p1ew61vt.js", "assets/root-dql6y2cb.css", "assets/1qalzv2pc5hfujvd.js", "assets/lfe95xxssu6chc6h.js", "assets/f7j18j5u52u1pnnk.js", "assets/conversation-small-k592qa8k.css", "assets/c9ft6i9h8fs69flr.js", "assets/bhb6cy3wcttd33y4.js", "assets/krs0zdy80kbjzbaq.js", "assets/g4tl5lt9yqf20m4s.js"]))) => i.map(i => d[i]);
import {
	ay as U,
	cy as mt,
	cL as ae,
...
import {
	a as ql
} from "./k5e0jvj7ql5y3ogc.js";
import {
	c as Yl
} from "./lfe95xxssu6chc6h.js";
import {
	P as In,
	g as Ql,
	h as $l,
	...
	d as tc,
	A as sc
} from "./mpc64wzn0wwiuplc.js";
import {
	S as Rn,
	u as ac,
	T as nc,
	a as oc
} from "./cu5abwmrp0din1ql.js";
import {
	u as ic,
	a as rc,
	b as lc
...
import {
	a as uc
} from "./jrm7m26zzbmpv5fw.js";
import {
	u as Bn,
	a as gc
} from "./navzkdkdtbvnrmqv.js";
import {
	S as mc
} from "./fwft5jfgwtq3rlsj.js";
import {
	u as At,
	l as Lt,
	S as Fn
} from "./inxq59yujvdee4ll.js";
import {
	C as fc
} from "./gu7a504uz5kfhw7b.js";
import {
	s as hc
} from "./bggvvkbqarfmaknw.js";
import {
	u as pc
} from "./picr87pgml298ikm.js";
import {
	u as xc
} from "./odn3jimzeso6ws9q.js";
import {
	S as Cc
...
import "./gs9mey20bowp7r2m.js";
import {
	u as bc,
	M as yc,
	a as jc
} from "./h8q9ocb5f5u66xjv.js";
import {
	g as vc
...
import "./1qalzv2pc5hfujvd.js";
import "./pde2w7wi3s85a6ty.js";
import "./bfu8twf3het5vjyn.js";
import "./iej0cupg2dqkmejt.js";
import "./ne5lavu77zt62cgb.js";
import "./d007yjle2atvv0vb.js";
...
function kc({
	...
	const s = v(),
		...
		[m, g] = f.useState(!1);
	if (!d) return null;
	const C = d.accountItems.find(L => L.id != t.id),
		j = () => {
			he.setLeaveWorkspaceData(null)
		},
		M = async () => {
			if (n != null) {
				g(!0);
	...
	if (u) return e.jsx(Nc, {
		workspace: t,
		fallbackWorkspace: C,
		onClose: j
	});
	if (!r.data) return e.jsx(wc, {
		onClose: j
	});
	const b = r.data.total_count,
		x = r.data.owner_count;
	if (l && x < 2) return e.jsx(_c, {
		workspace: t,
		onClose: j
	});
	const y = e.jsx(ae.Button, {
			onClick: () => {
				he.setLeaveWorkspaceData(null)
			},
...
function Nc({
	...
	const n = ue(),
		o = v(),
		i = U(),
		l = He(h => h.currentWorkspace),
		r = Ds(),
		d = () => {
			if (s != null && l)
				if (he.setLeaveWorkspaceData(null), l.id == t.id) {
					const {
						willRedirect: h
					} = fo(n, s.id, r, o, i);
					h || $s()
			...
			else he.setLeaveWorkspaceData(null), tt.deleteCookie(st.Workspace), tt.deleteCookie(st.WorkspaceResidencyRegion), $s();
			a()
		},
		u = s != null ? e.jsx(ae.Button, {
			color: "primary",
			onClick: d,
...
const Pc = "https://chatgpt.com/post/...";
...
function Ec({
	...
	const [i, l] = f.useState(!1), r = (x, y) => {
		x && Is(x, void 0, y).then(() => {
			l(!0), setTimeout(() => {
				l(!1)
			}, 1500)
		}).catch(() => {})
		...
		mutationFn: async x => {
			const y = await z.safePost("/share/post", {
				requestBody: {
		...
		onSuccess: x => {
			...
			d.setQueryData(Ct(t), x), r(us(x.postId))
		}
	}), {
		mutate: g
	} = pe({
		...
		p.current?.focus(), a ? r(us(a.postId), x) : h(t)
	}, j = x => {
		a && g({
			sharedResearchResultId: a.postId,
			access: x
		})
	}, M = a ? us(a.postId) : void 0, b = x => {
		switch (x) {
			case "public":
				return ls.PUBLIC;
			case "private":
	...
	return e.jsx(Kl, {
		...
		sharedObject: a && {
			id: a.postId,
			title: n,
			access: b(a.permissions)
		},
		title: n,
		shareTextPlaceholder: Pc,
		shareUrl: M,
		isCopySuccessful: i,
		isCreateLinkRequestInProgress: m,
		handlePrivacyChange: j,
...
const Lc = ({
	...
	const n = v(),
		...
		M = async w => {
			if (d) {
				if (!r) {
					m.warning("Failed to download file. Please try refreshing the page."), O.logEventWithStatsig("Deep Research Export Missing serverThreadId", "deep_research_export_missing_serverthreadid");
					return
				}
				h(!0);
				try {
					const N = await z.safePost("/export_doc/deep_research", {
						requestBody: {
							conversation_id: r,
							message_id: d.id,
							export_type: w
					...
					if (!N.ok) throw N.status >= 400 && N.status < 600 && m.danger(j, {
					...
					const L = await N.blob(),
						...
						T = yr(S) ?? `ChatGPT Deep Research.${w}`;
					jr(L, T)
				} catch (N) {
					ve.addError(N)
				} finally {
			...
			i(!1), l.current = setTimeout(() => {
				br.setResearchShareIntent(null)
			}, 400)
		}, x = d?.metadata?.async_task_title, y = Mo();
	return x ? e.jsx(ln, {
		children: e.jsx(ae.Root, {
			isOpen: o,
			onClose: b,
			className: "container",
			testId: "modal-deep-research-share",
			children: e.jsx(ae.Overlay, {
				showBackground: !0,
				children: e.jsx(ae.Content, {
					size: "normal",
					...
					children: e.jsxs(lr.div, {
						...
						children: [e.jsx(ae.Header, {
							...
							accessory: e.jsxs(e.Fragment, {
								children: [p && r !== void 0 && e.jsxs(W.Root, {
									open: u ? !1 : void 0,
									children: [e.jsx(W.BasicTrigger, {
										asChild: !0,
										children: e.jsx(E, {
											disabled: u,
											loading: u,
										...
										children: e.jsxs(W.Content, {
											align: "end",
											children: [e.jsx(W.Item, {
												onClick: w => {
													w.preventDefault(), M("pdf")
												},
												children: n.formatMessage({
...
function Oc() {
	...
	let o;
	t[0] !== s ? (o = s.formatMessage(Ae.title), t[0] = s, t[1] = o) : o = t[1];
	let i;
	...
	t[4] === Symbol.for("react.memo_cache_sentinel") ? (r = e.jsxs("ol", {
		...
		children: [e.jsx("li", {
			className: "",
			children: e.jsx(c, {
				...Ae.description1Bullet1
			})
		}), e.jsx("li", {
			children: e.jsx(c, {
				...Ae.description1Bullet2
			})
		})]
	}), t[4] = r) : r = t[4];
	let d;
	...
	return t[10] !== a || t[11] !== o ? (p = e.jsxs(K, {
		...
		title: o,
		children: [m, g]
	}), t[10] = a, t[11] = o, t[12] = p) : p = t[12], p
}

function Dc() {
	return he.closeModal(Te.AgeVerificationInterstitial)
}
...
const ra = de.h3`text-token-text-primary text-base mb-1`,
	Ae = B({
		title: {
	...
	Bc = () => {
		const t = Pt(),
			...
			a = vt(o => o.activeModals.has(Te.LogoutConfirm)),
			n = () => {
				he.closeModal(Te.LogoutConfirm)
			};
		return e.jsx(K, {
	...
	Fc = "https://cdn.oaistatic.com/assets/team-upsell-mjqpjoww.webp",
	Gc = {
		src: Fc
	},
	...
	V = B({
		...
		valueExperiment1: {
			...
			defaultMessage: "<b>Everything in Plus</b> and unlimited GPT-4o, with the flexibility to add credits as needed"
		},
		valueExperiment2: {
	...
	qc = [{
		icon: un,
		message: V.valueExperiment1,
		b: $e
	}, {
		icon: Sr,
		message: V.valueExperiment2,
		b: $e
	}, {
		icon: kr,
		message: V.valueExperiment3,
		b: $e
	}, {
		icon: wr,
		message: V.valueExperiment4,
		b: $e
	}, {
		icon: _r,
		message: V.valueExperiment5,
		b: $e
	}, {
		icon: Nr,
		message: V.valueExperiment6,
		b: $e
	}, {
		icon: Aa,
		message: V.valueExperiment7,
		link: Un,
		b: $e
	}],
	It = de.button`text-base rounded-xl justify-center gap-1 flex items-center bg-token-main-surface-primary border w-full p-3`,
	Yc = de.div`flex h-[1px] w-full border-b border-token-surface-tertiary`,
	Qc = de.div`relative z-10 max-w-[402px] w-full flex flex-col items-start p-6 pb-3 border-box bg-token-main-surface-primary border border-token-surface-tertiary shadow-elevation-01 rounded-xl`,
	$c = de.div`flex w-full border-dotted border-b border-token-surface-tertiary`,
	Zc = de.div`text-base text-sm tracking-[-0.18px]`,
	Xc = de.div`flex gap-3 py-3 items-center`,
	Jc = de.div`w-5 h-5`,
	ca = de.div`text-token-text-secondary flex flex-col self-end text-xs`,
	gs = de.div`text-token-text-secondary me-0.5 flex self-start text-xl`,
	ms = de.div`me-2 leading-none`,
	ed = () => {
		const t = Ke(),
			s = Pa(t),
			a = H(),
	...
	td = () => {
		const t = v(),
			s = ic(null, !0),
			a = vr(s.initialBillingDetails.currency).annualBillingPlan,
			n = cc(),
			{
				data: o
			} = dc(n ?? ""),
			...
			m = H(),
			g = Zt(m, "3010332215").get("enabled", !1);
		f.useEffect(() => {
		...
		const p = window.location.href + "-direct",
			C = M => {
				if (!p.includes(Zs)) {
					ve.addError("TeamPurchaseInterstitialModal: Missing team pricing hash.");
					return
				}
				if (M === "email") {
					cs(m, {
				...
				children: [e.jsxs("div", {
					...
					children: [e.jsxs("div", {
						...
						children: [e.jsx(vo, {
							...
							children: e.jsx("span", {
								...
								children: t.formatMessage(De.team1dollarWelcomeOffer)
							})
						}), e.jsx("div", {
							className: "mb-5 text-center text-3xl",
							children: t.formatMessage(V.title)
						}), e.jsxs(It, {
							onClick: () => C("email"),
							children: [e.jsx(Rn, {
								className: "h-6 w-6"
							...
							switch (!0) {
								case l:
									M = De.team1dollarLoginToVerify;
									break;
								case r:
									M = De.team1dollarNotEligible;
									break;
								case d:
									M = De.team1dollarTemporarilyDisabled;
									break;
								default:
									M = De.team1dollarOffline
							}
							return e.jsx("div", {
								className: "mb-4 w-full",
								children: e.jsx(dn, {
									content: t.formatMessage(M),
									type: "normal"
								})
							})
						})()]
					...
					children: [e.jsxs(Qc, {
						children: [e.jsxs("div", {
								...
								children: e.jsx("div", {
									...
									children: h ? e.jsxs(e.Fragment, {
										children: [e.jsx(gs, {
											...
											children: t.formatNumber(Pr)
										}), e.jsxs(ca, {
											children: [e.jsx("div", {
												children: t.formatMessage(De.team1dollarPerSeat)
											}), e.jsxs("div", {
												children: [t.formatMessage(De.team1dollarCost), t.formatMessage(De.asterisk)]
											})]
										})]
									}) : e.jsxs(e.Fragment, {
										children: [e.jsx(gs, {
											...
											children: [e.jsx("div", {
												children: t.formatMessage(V.perMonth)
											}), e.jsx("div", {
												children: t.formatMessage(V.billedAnnually)
											})]
										})]
									})
								})
							...
							link: x,
							b: y
						}, w) => e.jsxs(Ut.Fragment, {
							children: [e.jsxs(Xc, {
								className: Le(g && "items-start"),
								children: [e.jsx(Jc, {
									className: Le(g && "mt-1"),
									children: e.jsx(M, {})
								}), e.jsx(Zc, {
									children: t.formatMessage(b, {
										b: y,
										link: x || void 0
									})
								})]
							}), w < la.length - 1 && e.jsx($c, {})]
						}, b.id)), h && e.jsx("div", {
							className: "text-token-text-secondary mt-2 self-start text-xs",
							children: e.jsx(c, {
								...De.team1dollarPromoDisclaimer,
								values: {
	...
	sd = () => {
		...
		return _o() || !(a === "#ca-google-drive-oauth") || !s || s?.isPersonalAccount() || !t ? null : e.jsx(ad, {})
	},
	ad = () => {
		const {
			openSettings: t
		} = pt(), {
			gDriveOAuthConnectionId: s,
			isLoading: a,
			refetch: n
		} = No();
		return f.useEffect(() => {
...
const nd = ({
		...
		return f.useEffect(() => {
			a && h && (Oa.setItem(Da.PromoCode, d), m())
		}, [n, h, a, d, m]), f.useEffect(() => {
			r || l && h == null && ve.addError("User is eligible for promo but metadata is missing", {
				promoCode: d
			})
		}, [d, l, h, r]), a || n ? null : l && h != null ? e.jsx(od, {
			currentAccount: t,
			onClose: m,
			promoCode: d,
			promoMetadata: h
	...
	od = ({
		...
		return f.useEffect(() => {
			O.logEvent("Promo Eligible Modal Shown", {
				promoCode: a,
				promoMetadata: n
			}), Jt.logEvent("chatgpt_promo_eligible_modal_shown")
		}, [a, n]), e.jsx(K, {
	...
	id = ({
		...
		return f.useEffect(() => {
			...
			}), Jt.logEvent("chatgpt_promo_ineligible_modal_shown")
		}, [a, s.code]), e.jsx(Ws, {
...
function rd() {
	...
	return f.useEffect(() => {
		s && tt.getBooleanCookie(st.ShowPaymentModal) && (tt.deleteCookie(st.ShowPaymentModal), es(n, "Show payment modal cookie"))
	}, [s, n]), f.useEffect(() => {
		r ? (he.closeAllActiveModals(), he.openModal(Te.AccountPayment)) : he.closeModal(Te.AccountPayment)
	}, [r]), {
		isOpen: r,
		defaultTab: d
	}
...
function ld({
	...
	const a = ce(),
		...
		i = H(),
		l = Zt(i, "954359911");
	return !a || !n || !t ? "personal" : s || a.isWorkspaceAccount() || (n?.email_domain_type === "professional" || n?.email_domain_type === "government" || n?.email_domain_type === "unknown") && (!o || l.get("enabled", !1)) ? "business" : "personal"
}
...
function Hs({
	...
	return e.jsx("div", {
		className: Le("flex h-full w-full items-center justify-center", t),
		children: e.jsx(oe, {})
	})
}
const Wn = de.div`p-6`;
...
function Hn({
	...
	const i = v(),
		...
		[d, u] = f.useState(null),
		{
			...
			mutationFn: () => Ve.validateEmail(l, t),
			onSuccess: g => {
				u(null), ee.logValidateEmailSuccess(), s(g.transaction_id)
			},
			onError: g => {
				...
				ee.logValidateEmailFailure(), u(p)
			}
		});
	return e.jsx(cd, {
		emailAddress: l,
		...
		onClickValidateEmail: () => {
			h(), ee.logClickValidateEmail()
		},
		onClickCancel: () => {
			ee.logClose("add-email"), a()
		},
		title: n ? e.jsx(c, {
...
function dd({
	...
	f.useEffect(() => {
		ee.logShowReferralDiscount(a.program_name, !1)
	}, [a]);
	const d = ud(a);
	if (!t) return null;
	const u = Lr();
	return e.jsxs("div", {
		className: Le("relative flex h-full items-center justify-center", d ? "overflow-auto" : "overflow-hidden"),
		children: [e.jsx(In, {
			className: "bg-token-bg-primary",
			...
			onUpgradeButtonClick: () => {
				ee.logClickUpgradeButton(s), r(le.PLUS), o()
			},
			...
			className: Le("absolute inset-0 flex items-center justify-center", d ? "invisible" : "visible"),
			children: e.jsx(Hs, {})
		})]
	})
}
...
function gd({
	...
	onValidateVerificationCode: r,
	onResendVerificationCode: d,
	onChangeEmailAddress: u,
	onCancel: h
}) {
	return e.jsx(Wn, {
		children: e.jsxs("div", {
...
function Vn({
	...
	const o = v(),
		...
		}),
		{
			...
			mutationFn: () => Ve.sendVerificationCode(t),
			onError: y => {
				const w = y.detail?.user_error_message ?? p;
				h(w)
			}
		}),
		{
			...
			mutationFn: () => Ve.validateVerificationCode(t, i),
			onSuccess: () => {
				d(null), h(null), ee.logValidateVerificationCodeSuccess();
				try {
					g(!0), a()
				} catch {
					g(!1), d(p)
			...
			onError: y => {
				const w = y.detail?.user_error_message ?? o.formatMessage({
					id: "9wITlN",
					defaultMessage: "Something went wrong"
				});
				ee.logValidateVerificationCodeFailure(), d(w)
			}
		}),
		x = f.useRef(!1);
	return f.useEffect(() => {
		x.current || (C(), ee.logSendVerificationCode(), x.current = !0)
	}, [C]), e.jsx(gd, {
		emailAddress: "",
		verificationCode: i,
		errorMessage: r,
		sendErrorMessage: u,
		validateVerificationCodeIsPending: b || m,
		isSendingVerificationCode: j,
		setVerificationCode: l,
		onChangeEmailAddress: () => {
			ee.logClickChangeEmailButton(), s()
		},
		onValidateVerificationCode: () => {
			ee.logClickValidateVerificationCode(), M()
		},
		onResendVerificationCode: () => {
			ee.logClickResendVerificationCodeButton(), C()
		},
		onCancel: () => {
			ee.logClose("verify-email"), n()
		}
	})
}
...
function zn(t) {
	const s = H(),
		a = Eo(s, "1682643554").value;
	if (!t || typeof a != "object" || !a) return;
...
function md({
	...
	return f.useEffect(() => {
		...
		h && g && a(pn(g)), n && d && Ve.trackReferralSignup(t)
	}, [h, g, a, n, t, d]), r ? e.jsx(K, {
...
function fd({
	...
	const d = Bn(),
		...
		C = u?.hasPaidSubscription() ?? !1,
		j = pe({
			mutationFn: () => {
				if (t.name === "verify-email") return Ve.redeemReferral(a, t.transactionId);
				throw new Error("Invalid state for redeeming referral")
			}
		}),
		M = f.useCallback(async x => {
			try {
				await xn(u?.features ?? [], h, g, x.billingDetails, x.plusAnalyticsParams)
			} catch {}
		}, [u?.features, h, g]);
	f.useEffect(() => {
		if (!(l || t.name !== "loading")) {
	...
	switch (t.name) {
		...
		case "discount-intro":
			return e.jsx(dd, {
				...
				checkoutDetails: d,
				onContinue: () => {
					ee.logReferralDiscountContinue(), p ? m({
						authType: "signup",
						callback: x => {
						...
						callbackUrl: b
					}) : o ? M(d) : s(da(t.referralMetadata))
				},
				onClose: () => {
					ee.logClose("discount"), t.referralMetadata.discount && t.referralMetadata.duration && Oa.setItem(Da.ReferralCode, a), r()
				}
			});
		case "add-email":
			return e.jsx(Hn, {
...
function Kn({
	...
	const n = v(),
		...
		l = Cn(i),
		r = Rs(n, i.value || 0, i.currency_code);
	return e.jsxs("div", {
		...
		children: [e.jsxs("div", {
			...
			children: [e.jsx(E, {
				...
				onClick: () => {
					s && Is(Cs(s), o).then(() => {
						ee.logCopyReferralLink(), o.success(n.formatMessage({
							id: "1TiBkD",
...
function Cd({
	...
	const n = gt(),
		[o, i] = f.useState(null),
		{
			...
			mutationFn: () => Ve.createReferralCode(s),
			onSuccess: u => {
				i(u.referral_code)
			},
			onError: u => {}
		...
		r = f.useRef(!1);
	f.useEffect(() => {
		r.current || (r.current = !0, l(), ee.logShowReferrerConclusion())
	}, [l]);
	const {
		program_name: d
	} = t;
	return !n || !d ? null : e.jsx(Kn, {
		referralMetadata: t,
		referralCode: o,
		onClose: () => {
			ee.logClose("referrer-conclusion"), a()
		}
	})
}
...
function Md({
	...
	const n = v(),
		o = gt();
	f.useEffect(() => {
		ee.logShowReferralLinkGenerationModal(t.program_name)
	}, [t]);
	const {
		discount: i,
		program_name: l
	...
	if (!o || !l) return null;
	const r = Cn(i),
		d = Rs(n, i.value || 0, i.currency_code);
	return e.jsxs("div", {
		className: "text-center",
		children: [e.jsxs("div", {
			className: "text-token-sidebar-surface mx-auto flex h-[64px] w-[104px] items-center justify-center rounded-md bg-[#AF52DE] px-4 py-2 text-[40px]",
			...
			children: [e.jsx(E, {
				...
				color: "secondary",
				onClick: () => {
					ee.logClickReferrerIntroNotNowButton(), a()
				},
				size: "large",
				className: "w-full",
				children: e.jsx(c, {
...
function bd({
	...
	const {
		...
		programConfiguration: d,
		validDomain: u
	} = zn(i) ?? {}, h = jd(d, a, l), m = H(), g = Z(m, "550432558");
	return f.useEffect(() => {
		g || s(), h && s()
	}, [h, s, g]), g ? e.jsx(K, {
		...
		case "intro":
			return e.jsx(Md, {
				...
				onContinue: () => {
					h ? u({
						authType: "signup",
						callbackUrl: pn(m.referralMetadata.program_name)
...
function kd() {
	...
	let l;
	return t[0] !== o || t[1] !== a || t[2] !== s || t[3] !== n || t[4] !== i ? (l = a && n ? e.jsx(bd, {
		program: n,
		onClose: () => s({
			hash: ""
		})
	...
	}) : null, t[0] = o, t[1] = a, t[2] = s, t[3] = n, t[4] = i, t[5] = l) : l = t[5], l
}
...
const _d = ({
	...
	Nd = ({
		...
		onConnect: () => n({
			id: t.id
		}, "settings_connected_apps", wd(t), o),
	...
	Vs = ({
		...
		const o = v();
		return s ? e.jsx(fe, {
			label: o.formatMessage(Rt.disabledByAdmin),
			children: e.jsx(E, {
				onClick: a,
				color: "secondary",
				size: "small",
...
function Td({
	...
	switch (t) {
		case A.GDRIVE_ACTION_CONNECTOR:
			l = ss, r = "Google Drive (Deep Research)";
			break;
	...
	return e.jsx(D, {
		children: e.jsx(Re, {
			...
			statusIndicator: e.jsx(_d, {
				isConnected: d,
				onDisconnect: () => {
					t === A.GITHUB_CONNECTOR && Fr(), Do(Ss[t])
				},
				onConnect: () => {
					Oo({
						connectorType: t,
...
function Od() {
	const {
		data: t
	} = Pe(bn), s = t?.items, a = s?.filter(({
		type: l
	}) => l === "apple"), n = !!a?.length, o = s?.filter(({
		type: l
	}) => l === "codex_cli"), i = !!o?.length;
	return e.jsxs(ne, {
		title: e.jsx(c, {
...
function hs({
	...
	let s, a = lt.googleCalendarName,
		n = lt.googleCalendarDesc;
	switch (t) {
		case dt.GCAL_CONNECTOR:
			s = Wa;
			break;
		case dt.GMAIL_CONNECTOR:
			s = Ua, a = lt.gmailName, n = lt.gmailDesc;
			break;
		case dt.GOOGLE_CONTACTS_CONNECTOR:
			s = Ga, a = lt.googleContactsName, n = lt.googleContactsDesc;
			break
	}
	const o = v(),
		{
...
const lt = B({
	...
	Dd = () => {
		const t = H(),
			...
			r = Z(l, "4206189746"),
			d = o.get(Q.GDRIVE),
			u = o.get(Q.O365_PERSONAL),
			h = o.get(Q.O365_BUSINESS),
			m = a && !!d && !s,
			g = n && !!u,
			p = n && !!h,
			C = m || g || p || r;
		return s && (i || !C) ? null : e.jsx(ne, {
			title: e.jsx(c, {
				...We.fileUploadsTitle
			}),
			description: e.jsx(c, {
				...We.fileUploadsDescription
			}),
			children: i ? e.jsx("div", {
				...
				children: [r && e.jsxs(e.Fragment, {
					...
					entry: d,
					description: We.googleDriveDesc
				}), u && g && e.jsx(fs, {
					entry: u,
					description: We.o365Desc
				}), h && p && e.jsx(fs, {
					entry: h,
					description: We.o365BusinessDesc
				})]
			}) : e.jsx(Et, {
				type: "info",
				children: e.jsx(c, {
					...We.noConnectorSettings
				})
			})
		})
	},
	Id = new Set([A.GCAL_CONNECTOR, A.GMAIL_CONNECTOR, A.GOOGLE_CONTACTS_CONNECTOR]),
	Rd = () => {
		const t = H(),
			s = Z(t, "2509278897"),
			{
				...
				isJiraEnabled: n,
				isNotionOpenConnectorEnabled: o,
				isSlackOpenConnectorEnabled: i,
				connectorConfig: l,
				isLoading: r
			} = as(),
			d = l.get(Q.CONFLUENCE),
			u = l.get(Q.NOTION_OPEN_CONNECTOR),
			h = l.get(Q.JIRA),
			m = l.get(Q.SLACK_OPEN_CONNECTOR),
			g = a && !!d,
			p = n && !!h,
			C = o && !!u,
			j = i && !!m,
			...
			{
				availableConnectors: w,
				isLoading: N
			} = Ha(),
			{
				enabled: L
			} = Zo(),
			S = g || p || C || j || !s && (w.length > 0 || b),
			T = f.useMemo(() => s ? [] : [...new Set([...w.map(({
				type: Y
			}) => Y).filter(Y => Object.values(A).includes(Y)), ...b ? Id : []])], [w, b, s]),
			I = r || y || N;
		return s && (I || !S) || !I && !S ? null : e.jsx(ne, {
			title: e.jsx(c, {
				...We.connectorsTitle
			}),
			description: e.jsx(c, {
				...We.connectorsDescription,
				values: {
					learn_more_link: e.jsx("a", {
						href: "https://help.openai.com/en/articles/11145903",
						className: "underline",
			...
			children: I ? e.jsx("div", {
				...
				children: [!1, !1, !1, !1, T.map(P => fa[P] && e.jsx("div", {
					id: Xo[P],
					children: e.jsx(Td, {
						connectorType: P,
						description: fa[P],
						linkId: x.get(Ss[P])?.[0]?.id,
						isDisabledByAdmin: P === A.GITHUB_CONNECTOR && !L
					})
				}, P))]
			})
		})
...
function Bd() {
	...
	return f.useEffect(() => {
		...
		children: [s && e.jsx(yn, {
			onClose: () => a(!1)
		}), t && e.jsx(Va, {}), e.jsx(Dd, {}), e.jsx(Rd, {})]
	})
}
const Fd = t => f.createElement("svg", {
		width: 20,
		height: 20,
		viewBox: "0 0 20 20",
		fill: "currentColor",
	...
	Gd = (t, s) => {
		switch (t) {
			case "BUSINESS_AND_ANALYTICS":
				return s.formatMessage(G.categoryBusinessAndAnalytics);
			case "CREATIVITY_AND_DESIGN":
				return s.formatMessage(G.categoryCreativityAndDesign);
			case "DEVELOPER_TOOLS":
				return s.formatMessage(G.categoryDeveloperTools);
			case "MESSAGING_AND_SOCIAL":
				return s.formatMessage(G.categoryMessagingAndSocial);
			case "PRODUCTIVITY":
				return s.formatMessage(G.categoryProductivity);
			case "RESEARCH_AND_KNOWLEDGE":
				return s.formatMessage(G.categoryResearchAndKnowledge);
			default:
				return null
		}
	},
	Ot = (t, s, a) => {
		const n = [];
		s && s.length > 0 && n.push({
			title: a.formatMessage(G.worksWith),
			value: Lt(s, a)
		});
		const o = Gd(t.branding?.category, a);
		return o && n.push({
			title: a.formatMessage(G.category),
			value: o
		}), t.branding?.developer && n.push({
			title: a.formatMessage(G.developer),
			value: t.branding.developer
		}), t.branding?.website && n.push({
			title: a.formatMessage(G.website),
			value: e.jsx(Ne, {
				href: t.branding.website,
				openNewTab: !0,
				underline: !1,
				"aria-label": a.formatMessage(G.website),
			...
			title: a.formatMessage(G.privacyPolicy),
			value: e.jsx(Ne, {
				href: t.branding.privacy_policy,
				openNewTab: !0,
				underline: !1,
				"aria-label": a.formatMessage(G.privacyPolicy),
				className: "text-blue-400",
				children: e.jsx(Mt, {
					className: "icon"
				})
		...
		return e.jsxs(e.Fragment, {
			children: [e.jsx("div", {
				...
				children: [a, e.jsxs("div", {
					...
					children: e.jsxs(W.Root, {
						children: [e.jsx(W.BasicTrigger, {
							children: M || b ? e.jsx(ws, {
								className: "icon"
							}) : e.jsx(E, {
								color: "secondary",
								children: e.jsx(c, {
				...
				children: [e.jsx("div", {
					...
					children: l.filter(y => y.value != null).map(y => e.jsxs("div", {
	...
	Yn = ({
		...
		const u = v(),
			h = At(t),
			m = f.useMemo(() => [{
				title: u.formatMessage(G.connectedOn),
				value: new Date(s.created_at).toLocaleString([], {
					year: "numeric",
					month: "short",
					day: "numeric"
				})
			}, ...Ot(t, h, u)], [t, h, s.created_at, u]);
		return e.jsxs("div", {
			children: [e.jsx(is, {
				connector: t,
				onBackClick: a,
			...
			children: [e.jsx("div", {
				...
				children: t.actions.map(n => e.jsxs("li", {
					children: [e.jsxs("div", {
						...
						}), s?.actions?.includes(n.name) && e.jsx(za, {
							disabled: !0,
							"aria-hidden": !0,
							checked: !0,
							size: "small"
	...
	$n = ({
		...
		const r = v(),
			...
			u = f.useMemo(() => [...t.created_at ? [{
				title: r.formatMessage(G.createdAt),
	...
	Zn = ({
		...
		const i = v(),
			...
			u = o ? Ot(o, ["fileUploads"], i) : [{
				title: i.formatMessage(Ht.worksWith),
				value: Lt("fileUploads", i)
			}];
		return e.jsx(qn, {
			icon: e.jsx("span", {
				className: "border-token-border-default bg-token-main-surface-primary shadow-xxs max-h-fit rounded-2xl border-[.5px] bg-clip-padding p-2",
	...
	Wd = {
		[Q.O365_PERSONAL]: {
			description: Ht.o365Desc,
			Icon: yt
		},
		[Q.O365_BUSINESS]: {
			description: Ht.o365BusinessDesc,
			Icon: yt
		},
		[Q.GDRIVE]: {
			description: Ht.gdriveDesc,
			Icon: ss
		}
	},
	zs = ({
	...
	Xn = (t, s) => {
		...
		return async () => {
			try {
				await z.safeDelete("/connectors/user_setting/{connector_name}", {
					parameters: {
						path: {
							connector_name: t
						}
	...
	Kd = ({
		...
		const n = v(),
			i = ce()?.isPersonalAccount(),
			r = !!(ft() && i),
			d = f.useMemo(() => {
				if (a.id !== ge) return;
				const u = [];
				return r && u.push("chat"), u.push("deepResearch"), e.jsx(zs, {
					children: Lt(u, n)
				})
			}, [a.id, n, r]);
		return e.jsx(D, {
	...
	qd = ({
		...
		const a = v(),
			...
			b = f.useMemo(() => !j?.length || !s?.id ? null : j.find(N => s?.id === N.user_connection_details.backing_link_id), [j, s?.id]),
			x = async () => {
				await d(s.id)
			}, y = f.useMemo(() => s ? [{
			...
			}, ...Ot(t, r, a)] : [], [s, a, t, r]), w = f.useMemo(() => {
				if (b) switch (b.user_connection_details.knowledge_connector_type) {
					case void 0:
						break;
					case "github":
					case "notion":
		...
		return e.jsxs(e.Fragment, {
			children: [e.jsx(is, {
				...
				onBackClick: () => i(),
				details: y,
				onBlockItems: b && o ? () => g(!0) : void 0,
				onDisconnectClick: M,
				onDeleteSyncClick: b ? () => C(!0) : void 0,
				onEnableSyncClick: b || !o ? void 0 : () => {
					O.logEventWithStatsig("Connectors - Upgrade Personal Google Drive", "chatgpt_connectors_upgrade_personal_google_drive_clicked"), h({
						link: s
					})
				}
			}), e.jsx(Yd, {
				...
				accountId: n?.id ?? "",
				connectionId: b?.user_connection_details?.connection_instance_id ?? "",
				isOpen: m,
				objectType: w,
				onClose: () => g(!1)
			})]
	...
	Qd = ({
		...
		const s = v(),
			...
			i = ns(!0, Se.CONNECTOR_SETTING),
			l = at({
				fetchValidLinksOnly: !0,
				productSku: Se.CONNECTOR_SETTING
			}),
			r = i.platformConnectors.get(ge),
			d = f.useMemo(() => l.connectorLinks.get(ge) ?? [], [l.connectorLinks]),
			u = ze(),
			h = qa(),
			m = Vd(),
			g = Xn(Q.GDRIVE),
			{
				internalKnowledgeConfigs: p,
				fileUploadConfig: C,
				isLoading: j
			} = _t(),
			M = f.useMemo(() => p?.filter(T => T.user_connection_details.auth_status !== "not_connected") ?? [], [p]),
			[b, x] = f.useState(null),
			y = (C?.access_token ? 1 : 0) + (a?.isPersonalAccount() ? 0 : M.length) + d.length,
			[w] = f.useState(y),
			N = f.useMemo(() => !!p && !o && p.length - M.length > 0 || d.length === 0, [p, o, M.length, d.length]),
			L = f.useMemo(() => w > 1 ? b : C?.access_token ? {
				type: "file_uploads"
				...
				link: d[0]
			} : null, [w, C?.access_token, a, d, M, b]);
		if (i.isFetching || l.isLoading || j) return e.jsx("div", {
			className: "flex justify-center",
			children: e.jsx(oe, {})
		});
		if (i.error || l.error || !r) return u(), null;
		if (y === 0) return e.jsx($n, {
			connector: r,
			onBackClick: () => u(),
			onConnectClick: t
		});
		if (!L) {
			const T = I => {
				const P = d.find(Y => Y.id === I);
				P && (a?.isPersonalAccount() ? x({
					type: "upgradable_platform_connector",
					link: P
				}) : x({
					type: "platform_connector",
			...
			return e.jsx(zd, {
				...
				additionalLinks: e.jsxs(e.Fragment, {
					children: [!a?.isPersonalAccount() && M.map(I => e.jsx(D, {
						children: e.jsx("button", {
							className: "w-full",
							onClick: () => x({
								type: "internal_knowledge",
					...
					}, I.user_connection_details.connection_instance_id)), !!C?.access_token && e.jsx(D, {
						children: e.jsx("button", {
							className: "w-full",
							onClick: () => x({
								type: "file_uploads"
		...
		switch (L.type) {
			case "platform_connector": {
				const T = () => {
					h(L.link.id, () => x(null), Se.CONNECTOR_SETTING)
				};
				return e.jsx(Yn, {
					connector: r,
					onBackClick: S,
			...
			case "internal_knowledge": {
				const T = async () => {
					await m(L.config.user_connection_details.connection_instance_id), x(null)
				};
				return e.jsx(Ud, {
					connector: r,
					onBackClick: S,
	...
	pa = ({
		...
		const {
			...
			businessConfig: a,
			isLoading: n
		} = Ya(), o = t === Q.O365_PERSONAL ? s : a, i = ze(), l = Xn(t, () => {
			i()
		});
		return n ? e.jsx("div", {
			className: "flex justify-center",
	...
	$d = ({
		...
		const [a, n] = f.useState(!1), [o, i] = f.useState(!1), l = v(), r = U(), d = ns(!0, Se.CONNECTOR_SETTING), u = at({
			fetchValidLinksOnly: !0,
			productSku: Se.CONNECTOR_SETTING
		}), h = ue(), m = d.platformConnectors.get(t), g = u.connectorLinks.get(t), p = g && g.length > 0, C = !!m && m.connector_type === "MCP", j = ze(), M = ti(), b = ce(), x = f.useMemo(() => !!m?.owners.some(X => X.type === "USER" && X.id === b?.normalizedAccountUserId), [m, b?.normalizedAccountUserId]), y = C && x, w = d.isLoading || u.isLoading, [N, L] = f.useState(null), [S, T] = f.useState(null), I = f.useRef(!1), [P, Y] = f.useState(!1), we = !w && C && m.actions.length === 0 && p, Fe = !w && C && !we;
		if (f.useEffect(() => {
				I.current || P || (we ? (I.current = !0, Y(!0), si(g[0].id).then(async X => {
					L(X.conformance.implements_retrievable), T(X.conformance.reason_if_not_retrievable ?? null), await d.refetch(), h.invalidateQueries({
						queryKey: ["checkConnectorConformance", t]
					})
				}).finally(() => {
					Y(!1)
				})) : Fe && (I.current = !0, Y(!0), ai(t).then(X => {
					L(X.implements_retrievable), T(X.reason_if_not_retrievable ?? null), h.invalidateQueries({
						queryKey: ["checkConnectorConformance", t]
					})
				}).finally(() => Y(!1))))
			}, [g, d, we, d.isLoading, u.isLoading, t, Fe, P, h]), w || P) return e.jsx("div", {
			className: "flex justify-center",
			children: e.jsx(oe, {})
		});
		if (d.error || u.error || !m) return j(), null;
		const qe = async () => {
			switch (li(m)) {
				case "OAUTH": {
					s();
				...
				case "NONE": {
					try {
						n(!0), await ci(m), await u.refetch()
					} catch {
			...
			try {
				i(!0), await ri(t), await Promise.all([d.refetch(), u.refetch()]), j()
			} catch {
		...
		if (!p) return e.jsx($n, {
			...
			isDeleting: o,
			error: Qe,
			onDelete: y ? Ye : void 0
		});
		const nt = () => {
			M(t, () => {}, Se.CONNECTOR_SETTING)
		};
		return e.jsx(Yn, {
			connector: m,
			onBackClick: () => j(),
			link: g[0],
			onDisconnectClick: nt,
			isDeleting: o,
			error: Qe,
			onDelete: y ? Ye : void 0
		})
	...
	Zd = ({
		...
		type: Q.O365_PERSONAL
	}) : t === "onedrive-business" ? e.jsx(pa, {
		type: Q.O365_BUSINESS
	}) : e.jsx($d, {
		connectorId: t,
		onAddOauthLinkClick: s
	}),
	...
	Jd = ({
		...
		return e.jsx(fe, {
			label: o ? s.formatMessage(ui.disabledByAdmin) : void 0,
			triggerAs: "div",
			children: e.jsxs(E, {
				color: "secondary",
	...
	eo = ({
		...
		const {
			data: n
		} = fi(t.id, t.connector_type === "MCP" && t.status === "ONLY_ME"), o = v(), i = At(t), l = ze(), r = n === !1 ? e.jsx("span", {
			className: "text-token-text-status-error",
			children: e.jsx(c, {
				...au.mcpServerConformError,
				values: {
					link: d => e.jsx(Ne, {
						href: "https://platform.openai.com/docs/mcp#create-an-mcp-server",
						openNewTab: !0,
	...
	su = ({
		...
		return e.jsx("div", {
			className: "flex flex-col",
			children: l.map(r => r.type === "platform_connector" ? e.jsx(eo, {
				connector: r.connector
			}, r.connector.id) : r.type === "onedrive_personal" ? e.jsx(Ut.Fragment, {
				children: n
			}, r.type) : r.type === "onedrive_business" ? e.jsx(Ut.Fragment, {
				children: o
			}, r.type) : e.jsx(Ut.Fragment, {
				children: a
			}, r.type))
		})
	},
	...
	Bt = ({
		...
		const o = e.jsx(E, {
			...
			disabled: t,
			onClick: i => {
				i.preventDefault(), i.stopPropagation(), a?.(i)
			},
			size: "small",
			children: e.jsxs("div", {
	...
	nu = ({
		gdrivePlatformConnector: t,
		isFileUploadsEnabled: s,
		numPlatformLinks: a,
		platformLinks: n,
		...
		const r = v(),
			...
			x = i - o,
			y = f.useMemo(() => d?.isPersonalAccount() ? n.get(ge)?.find(P => P.connector_id === t.id) : null, [d, n, t.id]),
			w = f.useMemo(() => !j?.length || !y?.id || !m ? null : j.find(P => y?.id === P.user_connection_details.backing_link_id), [j, y?.id, m]),
			N = g.some(P => P.status === "success" && P.variables?.link?.id === y?.id && !w),
			L = g.some(P => P.status === "pending" && P.variables?.link?.id === y?.id);
		f.useEffect(() => {
			N && setTimeout(() => {
				b()
			}, 1e3)
		...
		const S = f.useMemo(() => {
				const P = t.status !== "DISABLED_BY_ADMIN",
					Y = a > 0;
				if (d?.isPersonalAccount()) {
					if (y && !w && m) {
						const we = () => {
							O.logEventWithStatsig("Connectors - Upgrade Personal Google Drive", "chatgpt_connectors_upgrade_personal_google_drive_clicked"), p({
								link: y
							})
						};
						return e.jsx(Bt, {
							onClick: we,
							loading: L || M || N,
							tooltip: r.formatMessage(J.syncForBetterAnswersTooltip)
						})
					}
					return y && w ? e.jsx(_s, {
						connection: w,
						...
						onClick: l,
						children: e.jsx(c, {
							...J.addChatAndOrDeepResearch
						})
					}) : null
				}
				if (Y) {
					if (x > 0 && o === 0) return e.jsx(Bt, {
						onClick: l,
						tooltip: r.formatMessage(J.syncForBetterAnswersTooltip)
					});
					if (C && i === 0) return e.jsx(Bt, {
						disabled: !0,
						onClick: l,
						tooltip: r.formatMessage(J.contactAdminTooltip)
					})
				} else {
					if (s && (o > 0 || x === 0)) return e.jsx(Ca, {
						disabled: !P,
						message: J.addDeepResearch,
						onAddClick: l,
						tooltip: P ? void 0 : r.formatMessage(J.deepResearchDisabledByAdmin)
					});
					if (P && s && o === 0) return e.jsx(Ca, {
						message: J.addChatAndOrDeepResearch,
						onAddClick: l
					});
					if (s && !P && o === 0 && x > 0) return e.jsx(Bt, {
						onClick: l,
						tooltip: r.formatMessage(J.syncForBetterAnswersTooltip)
					})
				}
				return null
			}, [t.status, a, m, y, w, l, L, M, N, r, p, x, o, C, i, d, s]),
			T = At(t),
			I = f.useMemo(() => {
				const P = [...T];
				return s && P.push("fileUploads"), Lt(P, r)
			}, [T, s, r]);
		return e.jsx(eo, {
			connector: t,
			description: I,
	...
	ou = ({
		onCreateCustomConnectorClick: t,
		onAddClick: s
	}) => {
		"use forget";
		const a = Xt(),
			n = hi(),
			o = ns(!0, Se.CONNECTOR_SETTING),
			i = at({
				fetchValidLinksOnly: !0,
				productSku: Se.CONNECTOR_SETTING
			}),
			...
			d = H(),
			u = f.useMemo(() => {
				if (Z(d, "3207737252")) return !0;
				if (!r) return !1;
				const T = Z(d, "3828441000");
				return r.isWorkspaceAccount() ? (r.isAdminOfAccount() || r.isOwnerOfAccount()) && T : T
			}, [r, d]),
			h = f.useMemo(() => Array.from(o.platformConnectors.values()).filter(S => S.connector_type === "MCP" || n.availableConnectors.some(T => T.id === S.id) || S.id === ge && a), [o.platformConnectors, n.availableConnectors, a]),
			m = f.useMemo(() => {
				const S = new Map(i.connectorLinks);
				return S.delete(ge), S
			}, [i.connectorLinks]),
			{
				fileUploadConfig: g,
				internalKnowledgeConfigs: p
			...
			C = Ya(),
			j = f.useMemo(() => p?.filter(S => S.user_connection_details.auth_status !== "not_connected").length ?? 0, [p]),
			M = i.connectorLinks.get(ge)?.length ?? 0,
			b = !!g?.access_token || M > 0 || j > 0,
			x = !!C.personalConfig?.access_token,
			y = !!C.businessConfig?.access_token,
			w = o.platformConnectors.get(ge),
			N = f.useMemo(() => h.filter(S => S.id === ge ? !b : !i.connectorLinks.has(S.id)), [h, i.connectorLinks, b]);
		if (o.isLoading || n.isLoading || i.isLoading) return e.jsx(ne, {
			title: e.jsx(c, {
				...J.connectorsTitle
			}),
			children: e.jsx("div", {
		...
		if (o.error || i.error || !n.enabled || !h.length) return e.jsx(ne, {
			title: e.jsx(c, {
				...J.connectorsTitle
			}),
			children: e.jsx(Et, {
		...
		const L = m.size > 0 || b || x || y;
		return e.jsxs(e.Fragment, {
			children: [L && e.jsx(ne, {
				title: e.jsx(c, {
					...J.enabledConnectorsTitle
				}),
				description: e.jsx(c, {
					...J.enabledConnectorsDescription,
					values: {
						link: S => e.jsx(Ne, {
							href: xa,
							openNewTab: !0,
				...
				children: e.jsx(su, {
					...
					gdriveRow: b && w ? e.jsx(nu, {
						gdrivePlatformConnector: w,
						isFileUploadsEnabled: !!g?.access_token,
						numPlatformLinks: M,
						platformLinks: i.connectorLinks,
						numInternalKnowledgeLinks: j,
						numInternalKnowledgeConfigs: p?.length ?? 0,
						onAddClick: () => {
							l(ge), s()
						}
					}) : null,
					onedrivePersonalRow: x && C.personalConfig ? e.jsx(Ma, {
						config: C.personalConfig,
						onClick: () => l("onedrive-personal")
					}) : null,
					onedriveBusinessRow: y && C.businessConfig ? e.jsx(Ma, {
						config: C.businessConfig,
				...
				title: e.jsxs("div", {
					...
					children: [L ? e.jsx(c, {
						...
						size: "small",
						children: e.jsx(c, {
							...J.createCustomConnectorButton
						})
					})]
				}),
				description: !L && e.jsx(c, {
					...J.connectorsDescription,
					values: {
						link: S => e.jsx(Ne, {
							href: xa,
							openNewTab: !0,
...
function iu() {
	const t = v(),
		...
		a = ht(!0),
		n = H();
	return !Z(n, "735368229") && s.data !== !0 ? null : e.jsxs(D, {
		children: [e.jsx(ke, {
			label: t.formatMessage(J.developerModeSettingsTitle),
...
const J = B({
	...
	ru = t => {
		...
		s[0] !== r || s[1] !== l.hash || s[2] !== d ? (u = () => {
			const M = l.hash || window.location.hash,
				b = M.indexOf("?");
			if (b === -1) return;
			const x = new URLSearchParams(M.substring(b + 1));
			if (x.get("show_github_repo_modal") !== "true") return;
			_e(r, yn), x.delete("show_github_repo_modal");
			const y = M.substring(0, b),
				w = x.toString() ? `${y}?${x.toString()}` : y;
			d({
				hash: w
			}, {
				replace: !0
			})
		}, h = [l.hash, r, d], s[0] = r, s[1] = l.hash, s[2] = d, s[3] = u, s[4] = h) : (u = s[3], h = s[4]), f.useEffect(u, h);
		let m, g;
		if (s[5] !== o ? (m = () => {
				o ? O.logEventWithStatsig("Connectors Details Settings Modal Shown", "chatgpt_connectors_details_settings_modal_shown", {
					type: o
				}) : O.logEventWithStatsig("Connectors Settings Modal Shown", "chatgpt_connectors_settings_modal_shown")
			}, g = [o], s[5] = o, s[6] = m, s[7] = g) : (m = s[6], g = s[7]), f.useEffect(m, g), o) {
			let M;
			return s[8] !== o || s[9] !== a ? (M = e.jsx(Zd, {
				connectorId: o,
				onAddClick: a
			}), s[8] = o, s[9] = a, s[10] = M) : M = s[10], M
		}
		let p;
		s[11] !== a || s[12] !== n ? (p = e.jsx(ou, {
			onCreateCustomConnectorClick: n,
			onAddClick: a
		}), s[11] = a, s[12] = n, s[13] = p) : p = s[13];
		let C;
		s[14] !== i ? (C = i && e.jsx(Va, {}), s[14] = i, s[15] = C) : C = s[15];
		let j;
		return s[16] !== p || s[17] !== C ? (j = e.jsxs(e.Fragment, {
			children: [p, C]
		}), s[16] = p, s[17] = C, s[18] = j) : j = s[18], j
	},
	to = ({
		defaultValue: t,
		onContinue: s,
		...
		return e.jsxs(e.Fragment, {
			children: [e.jsx(Ur, {
				...
				children: a.map(({
					...
					const g = e.jsxs(Wr, {
						value: i,
						className: Le("border-token-border-default flex items-center gap-4 rounded-2xl border p-4 text-sm", h && "cursor-not-allowed opacity-60"),
						disabled: h,
	...
	uu = ({
		...
		const l = ce(),
			...
			}, ...n ? [d ? pu : i ? mu : gu] : []], [d, o, u, n, i]);
		return e.jsxs(e.Fragment, {
			children: [e.jsx(Es, {
				title: e.jsx(c, {
					...xe.selectProductTitle
				}),
				connectorIcon: e.jsx(wt, {
					connector: t,
					className: "rounded-xl border-[0.5px] p-2 shadow-sm",
					size: "medium"
				}),
	...
	gu = {
		value: "deepResearch",
		label: xe.deepResearchTitle,
		description: xe.deepResearchDescription,
		Icon: Sn
	},
	mu = {
		value: "deepResearchAndOdyssey",
		label: xe.deepResearchAndOdysseyTitle,
		description: xe.deepResearchAndOdysseyDescription,
		Icon: Sn
	},
	fu = {
		value: "internalKnowledge",
		label: xe.internalKnowledgeTitle,
		description: xe.internalKnowledgeDescription,
		Icon: Vr,
		Badge: cu
	},
	hu = {
		value: "internalKnowledge",
		label: xe.syncTitle,
		description: xe.syncDescription,
		Icon: vn,
		Badge: du
	},
	pu = {
		value: "deepResearch",
		label: xe.dontSyncTitle,
		description: xe.dontSyncDescription,
		Icon: $a
	};
...
function so({
	...
	let l = `${n}?hints=${i}&sources=${Kt[s.id]}`;
	if (o) {
		const r = t.hash.match(/suggestedPromptsText=([^&]+)/)?.[1];
		l = `${l}&prompt=${r}&redirect_source=suggested_ca_prompts`
	} else l = `${l}${a==="enableSuggestions"?`&suggestions-for-connector=${Kt[s.id]}`:""}`;
	return {
		pathWithSlurmHint: l,
		suggestedPrompts: o
	}
...
const xu = ({
	...
	Mu = ({
		...
		const n = H(),
			...
			{
				availableConnectors: j
			} = Ha(),
			{
				availableConnectors: M
			} = zr(),
			[b, x] = f.useMemo(() => Kr(m ?? [], Me => Me.user_connection_details.auth_status === "not_connected"), [m]),
			y = b.length,
			w = x.length,
			[N, L] = f.useState(!1),
			[S, T] = f.useState(null),
			[I, P] = f.useState(null),
			Y = f.useMemo(() => y === 1 ? m?.[0] : I ? m?.find(Me => Me.user_connection_details.connection_instance_id === I) : void 0, [y, m, I]),
			[we, Fe] = f.useState(!1),
			{
				connectorLinks: qe,
				refetch: Ye
			...
			nt = f.useMemo(() => !!qe.get(ge)?.length, [qe]),
			{
				refetch: X
			} = Ns({
				skip: !0
			}),
			ot = !nt && j.some(Me => Me.type === A.GDRIVE_ACTION_CONNECTOR),
			xt = !nt && M.some(Me => Me.type === A.GDRIVE_ACTION_CONNECTOR),
			it = y > 0 || u,
			Oe = (ot || xt) && (it || !d?.isPersonalAccount() && g && w < 1 && !u),
			uo = S === "deepResearch" || S === "deepResearchAndOdyssey" || !Oe && (ot || xt),
			qs = S === "internalKnowledge" || !Oe && it,
			rt = u && S === "internalKnowledge",
			Ys = f.useCallback(async () => {
				try {
					Fe(!0), hc("popup"), O.logEventWithStatsig("Connectors - Connect Personal Google Drive", "chatgpt_connectors_connect_personal_google_drive_clicked", {
						sync: rt ? "true" : "false"
					});
					const Me = await Xa({
						connector: s,
					...
					if (Ye(), Qe(), Me?.errorType === "oauth_failed_scope_mismatch") {
						Fe(!1), L(!0);
						return
					}
					Me?.linkId && rt && p({
					...
					const rs = a !== Ja.Research && C.some(Qs => Qs.id === s.id && Kt[Qs.id] === A.GDRIVE_ACTION_CONNECTOR) && !d?.isEnterprisey() ? Zt(n, "2815206693").get("group", "control") : "control",
						{
							pathWithSlurmHint: go,
							suggestedPrompts: mo
						} = so({
					...
					rs === "enableConnector" || rs === "enableSuggestions" || mo ? window.location.href = go : (t(), setTimeout(() => {
						i(Ia, {
							replace: !0
						})
					}, 500)), L(!1)
			...
			}, [rt, s, l, o, Ye, Qe, a, C, d, n, p, X, t, i]);
		return h ? e.jsx("div", {
			className: "flex justify-center",
			children: e.jsx(oe, {})
		}) : N ? e.jsxs(e.Fragment, {
			...
			children: [Oe && !S && e.jsx(uu, {
				onClose: t,
				connector: s,
				onContinue: T,
				canAddDeepResearch: ot,
				canAddOdyssey: xt,
				canAddInternalKnowledge: it
			}), (uo || rt) && e.jsx(en, {
				connector: s,
				onClose: t,
				isConnecting: we,
				...
				connectionId: Y.user_connection_details.connection_instance_id,
				location: "user_settings",
				onSuccess: () => {
					X(), t()
				},
	...
	bu = ({
		...
		const i = ce(),
			...
			C = Ba(),
			j = o !== Ja.Research && p.some(x => x.id === t.id && [A.GDRIVE_ACTION_CONNECTOR, A.BOX_CONNECTOR, A.DROPBOX_CONNECTOR, A.SHAREPOINT_CONNECTOR].includes(Kt[x.id])),
			M = i?.isEnterprisey() ?? !1,
			b = async () => {
				try {
					const x = j && !M ? Zt(l, "2815206693").get("group", "control") : "control",
						{
							pathWithSlurmHint: y,
							suggestedPrompts: w
						} = so({
					...
					m(!0), await Xa({
						connector: t,
						redirectAfter: x === "enableConnector" || x === "enableSuggestions" || w ? y : n,
						toaster: u,
						openPopup: C,
						intl: r,
						productSku: a
					...
					m(!1), x instanceof Error && u.danger(r.formatMessage({
	...
	ju = t => {
		...
		if (!a || n) {
			...
			let g;
			s[0] !== m ? (g = Le("rounded-xl border border-dashed p-4", m), s[0] = m, s[1] = g) : g = s[1];
			let p;
			s[2] === Symbol.for("react.memo_cache_sentinel") ? (p = e.jsx(Bs, {
				className: "h-6 w-6"
			}), s[2] = p) : p = s[2];
			let C;
			return s[3] !== g ? (C = e.jsx("span", {
				className: g,
				children: p
			}), s[3] = g, s[4] = C) : C = s[4], C
		}
		const l = i && "bg-white";
		let r;
		s[5] !== l ? (r = Le("bg-token-bg-tertiary overflow-hidden rounded-xl border", l), s[5] = l, s[6] = r) : r = s[6];
		let d;
		s[7] !== o ? (d = o.formatMessage(F.iconPreviewAlt), s[7] = o, s[8] = d) : d = s[8];
		let u;
		s[9] !== a || s[10] !== d ? (u = e.jsx("img", {
			src: a,
			alt: d,
			className: "h-14 w-14 object-cover"
		}), s[9] = a, s[10] = d, s[11] = u) : u = s[11];
		let h;
		return s[12] !== r || s[13] !== u ? (h = e.jsx("span", {
			className: r,
			children: u
		}), s[12] = r, s[13] = u, s[14] = h) : h = s[14], h
	},
	vu = t => new Promise((s, a) => {
		const n = new FileReader;
		n.onloadend = () => s(n.result), n.onerror = () => a(), n.readAsDataURL(t)
	}),
	Su = ({
		onClose: t
	}) => {
		...
		const s = U(),
			...
			m = pc({
				...
				onSubmit: async ({
					...
					const T = g ? await vu(g) : null;
					let I = [];
					if (r === "OAUTH") try {
						I = [await ji(S.url.trim())]
					} catch {
						s.danger(o.formatMessage(F.oauthConfigError));
						return
					}
					try {
						const P = await a({
						...
						if (!P.implementsRetrievable) {
							b(!0);
							return
						}
						r === "NONE" && t(P.connector?.id)
					} catch (P) {
						const Y = P instanceof vi && P.status === 409 ? o.formatMessage(F.duplicateName) : o.formatMessage(F.createConnectorError);
						s.danger(Y);
						return
					}
				},
				validators: {
					onSubmit: ({
						...
						const T = {};
						return S.name.trim() || (T.name = o.formatMessage({
							id: "vtyh9X",
							defaultMessage: "Name is required"
						})), S.url.trim() ? S.url.trim().match(/^https?:\/\//) || (T.url = o.formatMessage({
							id: "7hn6Jq",
			...
			[M, b] = f.useState(!1),
			x = S => {
				if (C && URL.revokeObjectURL(C), S.size > ba) {
					s.danger(o.formatMessage(F.iconTooLarge));
					return
				}
				p(S);
			...
			},
			{
				...
				onDropRejected: () => {
					s.danger(o.formatMessage(F.iconInvalid))
				}
			}),
			L = S => {
				S.preventDefault(), u && (l(!0), m.handleSubmit())
			};
		return e.jsx(K, {
			...
			title: e.jsx("span", {
				className: "flex items-center gap-1",
				children: e.jsx(c, {
					...F.createCustomConnectorModalTitle,
					values: {
						betaBadge: e.jsx(Yr, {})
					}
				})
				...
				children: [e.jsxs("label", {
					...
					children: S => e.jsxs("div", {
						children: [e.jsx("label", {
							...
							value: S.state.value,
							onChange: T => {
								S.handleChange(T.target.value), i && l(!1)
							},
							ariaLabel: o.formatMessage(F.nameTitle),
							placeholder: o.formatMessage(F.namePlaceholder),
							error: i ? S.state.meta.errors[0] : void 0
						})]
					})
				}), e.jsx(m.Field, {
					name: "description",
					children: S => e.jsxs("div", {
						children: [e.jsx("label", {
							...
							value: S.state.value,
							onChange: T => S.handleChange(T.target.value),
							ariaLabel: o.formatMessage(F.descriptionTitle, {
								optionalText: o.formatMessage(F.optionalText)
							}),
							placeholder: o.formatMessage(F.descriptionPlaceholder)
						})]
					})
				}), e.jsx(m.Field, {
					name: "url",
					children: S => e.jsxs("div", {
						children: [e.jsx("label", {
							...
							value: S.state.value,
							onChange: T => {
								S.handleChange(T.target.value), i && l(!1), M && b(!1)
							},
							ariaLabel: o.formatMessage(F.urlTitle),
							placeholder: o.formatMessage(F.urlPlaceholder),
							error: M ? e.jsx("span", {
								children: e.jsx(c, {
									...F.conformanceError,
									values: {
							...
							}) : i ? S.state.meta.errors[0] : void 0
						})]
					})
				}), e.jsxs("div", {
					children: [e.jsx("label", {
						...
						options: [{
							label: o.formatMessage(F.oauthOption),
							value: "OAUTH"
						}, {
							label: o.formatMessage(F.noAuthOption),
							value: "NONE"
						}],
						value: r,
						onValueChange: S => d(S),
					...
					children: [e.jsxs("div", {
						...
						children: [e.jsx(Gs, {
							...
							children: [e.jsx("p", {
								className: "text-sm font-medium",
								children: e.jsx(c, {
									...F.customConnectorTrustTitle
								})
							}), e.jsx("p", {
								className: "text-token-text-tertiary text-sm",
								children: e.jsx(c, {
									...F.customConnectorTrustSubtitle
								})
							})]
						})]
					})]
...
let ps = 0;
const wu = de(W.CheckboxItem)`flex flex-row justify-between h-10 mx-2 items-center`;
		...
		children: [e.jsxs("div", {
			...
			children: [e.jsx("span", {
				...
				children: [e.jsxs(W.Trigger, {
					...
					children: e.jsx(W.Content, {
						size: "small",
						align: "end",
						children: t.options.map((n, o) => e.jsx(wu, {
							checked: n.enabled,
							onCheckedChange: i => _u(t, i, n.channel, s),
							children: n.name
						}, o))
					})
				})]
...
function Pu(t, s) {
	...
	return n && a ? s.formatMessage(Ft.pushAndEmailEnabled) : n ? s.formatMessage(Ft.pushEnabled) : a ? s.formatMessage(Ft.emailEnabled) : s.formatMessage(Ft.notificationsOff)
}

function Eu(t) {
	const s = ue();
	return pe({
		mutationFn: async a => (await $r.updateSettings(a)).settings,
		onMutate: async a => {
			ps += 1;
			const n = ps;
		...
		onSuccess: (a, n, o) => {
			o?.mutationId === ps && (s.setQueryData(Wt, a), t(a))
		}
	})
}
const Ft = B({
...
const ao = (t, s) => {
	const {
		...
		queryFn: async () => z.safeGet("/promotions/cp", {
			parameters: {
				query: {
					account_id: t
				}
	...
	return {
		cancellationPromoMetadata: f.useMemo(() => !a?.metadata || a.metadata.plan_name !== ki.PLUS || a.metadata.duration?.period !== "month" ? null : a.metadata, [a]),
...
function Lu({
	...
	const o = v(),
		...
		{
			cancellationPromoMetadata: b,
			isCancelPromoLoading: x
		} = ao(n.id, M),
		y = b ? j.get("promo_redemption_cta_color", "secondary") : "secondary",
		{
			numPeriods: w,
			formattedDiscountedCost: N
		} = f.useMemo(() => {
			...
			const I = b.duration?.num_periods ?? 1;
			return {
				numPeriods: I,
				...Ql(o, I, b.discount, T)
			}
		...
		L = async () => {
			if (!n || !h) throw new Error("Missing current account or subscription id");
			await d.mutateAsync(n.id, {
				...
				onSuccess: async () => {
					if (p.invalidateQueries({
							...
							duration: 5
						}), O.logEventWithStatsig("Cancel Subscription Modal Cancel Success", "chatgpt_cancel_subscription_modal_cancel_success"), Z(l, "3376055906")) {
						const I = new URL("https://openai.qualtrics.com/jfe/form/SV_eW3mdeRdMrpnPLw");
						I.searchParams.append("subscription_id", h), I.searchParams.append("plan_type", n.planType), n.authUserId ? I.searchParams.append("oai_user", n.authUserId) : ve.addError("authUserId missing from currentAccount"), window.open(I.toString(), "_blank")
					}
					setTimeout(() => {
						s()
					}, 5e3)
	...
	f.useEffect(() => {
		d.isSuccess && s()
	}, [d.isSuccess, s]), f.useEffect(() => {
		O.logEventWithStatsig("Cancel Subscription Modal Shown", "chatgpt_cancel_subscription_modal_shown")
	}), f.useEffect(() => {
		b && !x && O.logEventWithStatsig("Cancel Subscription Modal with Cancellation Promo Shown", "chatgpt_cancel_subscription_modal_with_cancellation_promo_shown", {
			promo_id: b.campaign_id
		})
	}, [b, x]);
	const S = r?.active_until ? new Date(r.active_until).toLocaleDateString(o.locale, {
		year: "numeric",
		month: "short",
		day: "numeric"
	}) : "";
...
`,
				...
				children: [e.jsx(ct, {
					...
					color: C.get("cancellation_modal_go_back_button_color", "secondary"),
					onClick: s
				}), e.jsx(ct, {
					title: o.formatMessage({
					...
					color: C.get("cancellation_modal_cancel_button_color", "danger"),
					onClick: () => {
						O.logEventWithStatsig("Cancel Subscription Modal Confirmation Button Clicked", "chatgpt_cancel_subscription_modal_confirmation_button_clicked"), L()
					},
					loading: d.isPending
				})]
			})]
...
function Ou({
	...
	const s = Ce(),
		...
		i = () => {
			O.logEventWithStatsig("Subscription Settings Change Plan Button Clicked", "chatgpt_subscription_settings_change_plan_button_clicked"), es(s, "Subscription settings manage button")
		};
	return e.jsx(W.Item, {
		icon: un,
		onClick: i,
...
function Du({
	...
	return e.jsxs(e.Fragment, {
		children: [e.jsx(W.Separator, {}), e.jsx(W.Item, {
			color: "danger",
			icon: Ka,
			onClick: async () => {
				if (O.logEventWithStatsig("Subscription Settings Cancel Subscription Button Clicked", "chatgpt_subscription_settings_cancel_subscription_button_clicked"), d) try {
					const u = await As.fetchCustomerPortalUrl();
					location.href = u.url
				} catch {
...
function Iu(t, s) {
	return t === le.FREE || t === le.PLUS && s === le.PRO
}
...
function Ru({
	...
	const a = t.data.subscriptionStatus.planType,
		...
		i = t.getNextPlanType();
	if (!(!o || i && Iu(i, a))) return null;
	const r = () => {
		O.logEventWithStatsig("Subscription Settings Renew Plan Button Clicked", "chatgpt_subscription_settings_renew_plan_button_clicked"), s()
	};
	return e.jsx(W.Item, {
		icon: il,
		onClick: r,
...
function Fu({
	...
	const s = t.subscriptionAnalyticsParams,
		...
		l = async () => {
			...
			try {
				const d = await As.fetchCustomerPortalUrl();
				O.logEvent("Account Portal: Navigating to Account Portal", s), location.href = d.url
			} catch {
	...
	switch (n) {
		...
		case Yt.MOBILE_ANDROID:
			return r(Pi, "Account Portal: Click Android Manage Subscription");
		default:
			if (t.hasCustomerObject()) return e.jsx(E, {
				onClick: l,
				color: "secondary",
				children: e.jsx(c, {
					id: "eQL80k",
...
function Gu() {
	...
	return e.jsx(no, {
		...
		ctaButton: e.jsx(E, {
			onClick: () => {
				O.logEventWithStatsig("Subscription Settings Free to Plus Upgrade Button Clicked", "chatgpt_subscription_settings_free_to_plus_upgrade_button_clicked"), es(s, "Subscription settings manage button Free to Plus")
			},
			color: "primary",
			children: e.jsx(c, {
				...ie.upgradeButton
...
function Uu({
	...
	const n = v(),
		...
		y = o === le.PRO ? b : x,
		{
			advertisedFeatures: w
		} = y,
		{
			costTitle: N,
			currencySymbol: L
		} = al(y, t.data.subscriptionStatus.billingCurrency ?? "USD"),
		S = l && r && p ? e.jsx("span", {
			children: e.jsx(c, {
		...
		T = i && !l && d && m && (t.data.subscriptionStatus.discount?.discount_type === wi.PERCENTAGE ? va(u, d) && N?.defaultMessage && L?.sign?.defaultMessage ? e.jsx("span", {
			children: e.jsx(c, {
	...
	return e.jsx(no, {
		...
		discountMessage: T,
		renewMessage: I,
		planCanceledMessage: P,
		paymentSection: Y
	})
}

function Ze(t, s) {
	const a = Ni(new Date, t);
...
function Wu({
	...
	const r = () => {
			O.logEventWithStatsig("Claim Subscription Cancellation Promotion Modal Close", "chatgpt_claim_subscription_cancellation_promotion_modal_close"), t()
		},
		d = () => {
			O.logEventWithStatsig("Claim Subscription Cancellation Promotion Modal Back Button Clicked", "chatgpt_claim_subscription_cancellation_promotion_modal_back_button_clicked"), s()
		},
		u = rl(a.id),
		{
			cancellationPromoMetadata: h,
			isCancelPromoLoading: m
		} = ao(a.id, a.isEligibleForCancellationPromotion()),
		{
			data: g,
			isError: p,
			isLoading: C
		} = ll(a.id, void 0, void 0, h?.campaign_id);
	...
	const j = ue(),
		M = async w => {
			O.logEventWithStatsig("Claim Subscription Cancellation Promotion Pay Now Button Clicked", "chatgpt_claim_subscription_cancellation_promotion_modal_pay_now_button_clicked"), l(!0);
			try {
				await u.mutateAsync({
					accountId: a.id,
		...
		}, [b, x, y] = Zl(a.mustGetSubscriptionBillingCurrency("GlobalSettingsModal"));
	return e.jsx(K, {
		...
		removePopoverStyling: !0,
		children: C || m ? e.jsx(Hu, {}) : h?.campaign_id && g ? e.jsx(Ku, {
			account: a,
			promoData: h,
			previewData: g,
			plusCost: b,
...
function Ku({
	...
	return e.jsxs("div", {
		...
		children: [e.jsx(zu, {
			...
			planCost: g,
			currencySymbol: i
		}), p.filter(C => C.value !== 0).map((C, j) => e.jsx(Xl, {
			adjustmentMessage: C.adjustmentMessage,
			proratedCreditMessage: C.proratedCreditMessage,
			proratedCreditInfoMessage: C.proratedCreditInfoMessage
		}, j)), e.jsx("hr", {
			className: "mt-4 mb-4"
		}), e.jsx(Jl, {
			data: a,
...
function qu() {
	...
	return f.useCallback(async () => {
		try {
			await xn(s ?? [], a, n, t.billingDetails, t.plusAnalyticsParams)
		} catch {}
	}, [s, a, n, t])
}
...
function Yu({
	...
	const {
		...
		queryFn: () => Ve.getEnrollmentDetails()
...
function Qu({
	...
	const s = gt(),
		...
		l = Cs(t.referral_code),
		{
			discount: r
		} = t.referral_metadata,
		d = Rs(a, r.value || 0, r.currency_code),
...
function xs({
	...
	return e.jsxs("div", {
		className: Le("flex flex-col items-center gap-0.5", t),
		children: [e.jsx("div", {
...
function Zu() {
	const t = H(),
		s = Z(t, "550432558"),
		{
			...
			queryFn: () => Ve.getIsEligibleForReferrals(),
			enabled: s
		}),
...
function eg() {
	...
	return e.jsxs("div", {
		...
		children: [e.jsx("div", {
			...
			onValueChange: s,
			options: [{
				label: a.formatMessage(Gt.system),
				value: "system"
			}, {
				label: a.formatMessage(Gt.dark),
				value: "dark"
			}, {
				label: a.formatMessage(Gt.light),
				value: "light"
			}]
		})]
	})
...
async function tg() {
	...
	return t?.lock && await t?.lock(), new Promise(a => {
		...
		const l = g => {
			...
			u = () => {
				window.removeEventListener("keydown", l), window.removeEventListener("keyup", r), window.removeEventListener("mousedown", d), window.removeEventListener("click", d), window.removeEventListener("blur", d), clearTimeout(m), t?.unlock && t?.unlock(), i = !1
			},
			h = () => {
				u();
				const g = sg(Array.from(o));
				a(oo({
					webKeys: g
				}))
			};
		window.addEventListener("keydown", l), window.addEventListener("keyup", r), window.addEventListener("mousedown", d), window.addEventListener("click", d), window.addEventListener("blur", d);
		const m = setTimeout(() => {
			i && (u(), a(void 0))
		}, 1e4)
	})
...
function sg(t) {
	return t.toSorted((s, a) => {
		const n = Object.values($t).indexOf(s),
			o = n === -1 ? Number.MAX_SAFE_INTEGER : n,
			i = Object.values($t).indexOf(a),
			l = i === -1 ? Number.MAX_SAFE_INTEGER : i;
		return o === l ? s.charCodeAt(0) - a.charCodeAt(0) : o - l
	})
}
const ag = t => /^[a-zA-Z]$/.test(t);

function ka(t, s) {
	const a = s.get(t.code) ?? t.key;
	let n;
	return _[t.key] ? n = _[t.key] : ag(a) ? n = a.toUpperCase() : n = a, n
}

function oo(t) {
	return t.webKeys ? (t.electronAcceleratorKeys = t.webKeys.map(og), t.electronAcceleratorString = wa(t.electronAcceleratorKeys)) : t.electronAcceleratorKeys ? (t.webKeys = t.electronAcceleratorKeys.map(ng), t.electronAcceleratorString = wa(t.electronAcceleratorKeys)) : t = {
		webKeys: [],
...
function io(t) {
	const s = new Set(Object.keys(ro)),
...
const ig = t => {
	...
	rg = Object.fromEntries(Object.entries($t).map(([t, s]) => [s, t]));
async function lg() {
...
function cg() {
	...
	return e.jsx(e.Fragment, {
		children: e.jsx(D, {
			children: e.jsx(je, {
				label: e.jsx(c, {
					...me.updatesSettingLabel
				}),
				disabled: t,
				buttonLabel: t ? e.jsx(c, {
					...me.updateInProgressButtonLabel
				}) : e.jsx(c, {
					...me.updateButtonLabel
				}),
				onClick: async () => {
					try {
						s(!0), await lg()
					} catch (a) {
						ve.addError(new Error("Sidetron Settings: Error checking for updates"), {
							cause: a
						})
					} finally {
						s(!1)
				...
				description: e.jsx(c, {
					...me.updateSettingDescription,
					values: {
						version: Di(Fi()) ?? "Unknown"
					}
				})
			})
		})
...
const dg = async () => {
	...
	typeof s == "string" ? t = s : ve.addError(new Error("Sidetron Settings: No companion chat hotkey found over IPC"));
	const a = ig(t);
...
function ug() {
	const [t, s] = f.useState(!1), [a, n] = f.useState(void 0);
	return f.useEffect(() => {
		(async () => {
			const i = await dg();
			n(i)
		...
		children: e.jsx(D, {
			children: e.jsx(je, {
				label: e.jsx(c, {
					...me.companionChatHotkeyLabel
				}),
				disabled: a === void 0 || t,
				buttonLabel: t ? e.jsx(c, {
					...me.companionChatHotkeyRecordingLabel
				}) : a ? e.jsx(mg, {
					keyboardBinding: a.webKeys
				}) : e.jsx(c, {
					...me.companionChatHotkeyLoadingLabel
				}),
				onClick: async () => {
					s(!0);
					const o = await tg();
					o ? o.electronAcceleratorString ? (n(o), ut && (ut.publish(ea.DESKTOP_SETTING_CHANGED, {
						setting: "companionWindowShortcut",
						value: o.electronAcceleratorString
					}), ve.addAction(`Sidetron Settings: User recorded a new hotkey: ${o.electronAcceleratorString}`))) : ve.addError(new Error(`Sidetron Settings: Invalid companion chat hotkey registered: ${o}`)) : ve.addAction("Sidetron Settings: User did not record a hotkey"), s(!1)
				}
			})
		})
	})
...
function mg({
	...
	return e.jsx(e.Fragment, {
		children: gl(t).map((s, a) => e.jsxs("span", {
			className: "text-xs",
			children: [s, a < t.length - 1 && e.jsx(fg, {})]
		}, a))
	})
}
...
function pg() {
	const [t, s] = f.useState(!1), a = v(), n = async () => {
	...
	return f.useEffect(() => {
		...
		children: e.jsx(D, {
			children: e.jsx(hg, {
				...
				stateLabel: t ? a.formatMessage(me.autoLaunchOnLabel) : a.formatMessage(me.autoLaunchOffLabel)
			})
		})
	})
}
...
function Mg() {
	const t = v(),
		...
		n = gt();
	return e.jsx(ne, {
		title: t.formatMessage(se.gizmoTab),
		children: a ? e.jsx("div", {
			className: "flex justify-center p-6",
			children: e.jsx(oe, {})
		}) : s === void 0 || n == null ? e.jsx(Et, {
			type: "info",
			children: e.jsx(c, {
				...se.noCreatorProfile
			})
...
function bg({
	...
	return i ? e.jsxs("div", {
		...
		children: [e.jsx(Cg, {
			gizmoAvatar: a,
			gizmoName: t ?? n.formatMessage(se.placeholderGPT),
			canEdit: s,
...
function jg({
	...
	const s = v(),
		...
		m = e.jsx(za, {
			...
			disabled: h,
			checked: !t.hide_name,
			"aria-label": t.hide_name ? s.formatMessage(se.showNameToggle) : s.formatMessage(se.hideNameToggle)
		});
	return e.jsxs("div", {
		...
		children: [e.jsx("div", {
			...
			children: e.jsxs("div", {
				className: "flex flex-col",
				children: [!t.is_verified && e.jsxs(Et, {
					type: "info",
					children: [e.jsx("div", {
						children: e.jsx(c, {
							...se.creatorProfileUnverifiedDisclaimer
						})
					}), e.jsx("div", {
						children: o ? e.jsx(c, {
							...se.creatorProfileBusinessUnverifiedDisclaimer
						}) : e.jsx(c, {
							...se.creatorProfilePersonalUnverifiedDisclaimer
						})
					})]
				}), t.name && e.jsxs("div", {
					...
					children: [e.jsxs("div", {
						...
						children: [e.jsx("b", {
							children: e.jsx(c, {
								...se.creatorProfileNameLabel
							})
						}), h ? e.jsx(fe, {
							side: "left",
							label: s.formatMessage(se.linkDisabledTooltip),
							children: m
						}) : m]
					}), e.jsxs("div", {
						...
						children: [e.jsx("span", {
							...
							side: "top",
							className: "ms-auto",
							label: s.formatMessage(se.nameSourceReason),
							children: e.jsx(js, {
					...
					children: [e.jsx("hr", {
						...
						label: s.formatMessage(se.feedbackEmailTooltip),
						children: e.jsx(Gs, {
							className: "rounded-xl",
							...
							label: s.formatMessage(se.receiveFeedbackEmails)
						})
					})]
				})]
			})
...
function kg({
	...
	const n = v(),
		...
		h = `/c/${t.id}`;
	return e.jsxs(e.Fragment, {
		children: [e.jsxs(R.Row, {
			disabled: r,
			children: [e.jsx(R.Cell, {
				children: e.jsxs("a", {
					href: h,
					rel: "noreferrer",
				...
				children: t.create_time != null ? e.jsx(os, {
					value: t.create_time,
					month: "long",
					year: "numeric",
					day: "numeric"
				...
				textAlign: "right",
				children: e.jsxs(R.Actions, {
					children: [e.jsx(fe, {
						label: n.formatMessage(ye.unarchiveConversation),
						side: "top",
						children: e.jsx("button", {
							"aria-label": n.formatMessage(ye.unarchiveConversation),
						...
						label: n.formatMessage(ye.deleteConversation),
						side: "top",
						children: e.jsx("button", {
							onClick: () => u(!0),
							"aria-label": n.formatMessage(ye.deleteConversation),
...
function wg({
	...
	}), r = f.useRef(null), d = f.useCallback(g => {
		a || g == null || (r.current?.disconnect(), r.current = new IntersectionObserver(p => {
	...
	return a ? m = e.jsx("div", {
		...
		children: e.jsx(c, {
			...ye.noArchivedConversations
		})
	}) : m = e.jsxs(R.Root, {
		className: "max-h-[28rem]",
		size: "compact",
		children: [e.jsxs(R.Header, {
			children: [e.jsx(R.HeaderCell, {
				children: e.jsx(c, {
					...ye.name
				})
			}), e.jsx(R.HeaderCell, {
			...
			children: u.map((g, p) => e.jsx(kg, {
				conversation: g,
				elementRef: p === u.length - Sg ? d : void 0,
				closeParentModal: t
			}, g.id))
		})]
	}), e.jsx(K, {
		...
		className: "max-w-5xl",
		type: "success",
		title: h.formatMessage(ye.title),
		showCloseButton: !0,
		children: m
	})
}
...
function _g() {
	const t = v(),
		s = He(Je.isBusinessWorkspace),
		a = He(Je.workspaceId) ?? void 0,
		{
			data: n,
			isLoading: o
		} = Wi(a),
...
function Ng() {
	const [t, s] = f.useState(!1), a = v(), n = vl(), {
		isLoading: o,
		data: i
	} = Sl(!0), l = ht(), {
		data: r
	} = kl(void 0, !1, n), d = bc(r?.memoryFullPct), u = H(), h = wn(), m = Tn(), g = Pn(), p = wl(), C = _l(), j = En(), M = An(u), b = Nl();
	Z(u, "1900515849");
	const x = !1,
		{
			data: y
		} = Xe(te.Gift),
		w = Z(u, "1804926979") && Z(u, "3365913332");
	return o ? e.jsx("div", {
		className: "flex justify-center p-6",
		children: e.jsx(oe, {})
	}) : e.jsxs(e.Fragment, {
		children: [e.jsxs(ne, {
			title: a.formatMessage(be.customizeTitle),
			children: [e.jsx(D, {
				children: e.jsx(an, {
					label: e.jsx(c, {
						...be.customInstructions
					}),
					stateLabel: i?.enabled ? a.formatMessage(be.on) : a.formatMessage(be.off),
					onClick: () => {
						...
						}), he.openModal(Te.UserContext)
					}
				})
			}), x]
		}), e.jsxs(ne, {
			title: a.formatMessage(be.memoryTitle),
			learnMoreHref: "https://help.openai.com/en/articles/8590148-memory-faq",
			children: [e.jsxs(D, {
				children: [e.jsx(ke, {
					label: a.formatMessage(be.toggleLabel),
					enabled: n,
					onChange: N => {
						l.mutate({
							setting: te.Sunshine,
				...
				children: [e.jsxs("div", {
					className: "flex items-center justify-between",
					children: [e.jsx(c, {
						...be.manageMemoriesLink
					}), e.jsxs("div", {
						className: "flex shrink-0 gap-2",
						children: [e.jsx(E, {
							color: "secondary",
							onClick: () => {
								O.logEventWithStatsig("Manage Memories Button Clicked", "chatgpt_manage_memories_button_clicked_settings"), s(!0)
							},
							children: e.jsx(c, {
								...be.manageButton
							})
...
function Tg() {
	...
	return f.useEffect(() => {
		...
		onClick: () => {
			O.logEventWithStatsig("Memory Full Warning Upsell Clicked", "chatgpt_memory_full_warning_upsell_clicked_settings"), es(t, "MemoryUsageWarning Settings Upsell")
		},
		color: "secondary",
		children: e.jsx(c, {
...
function Pg(t) {
	return z.safeDelete("/share/post/{post_id}", {
		parameters: {
			path: {
				post_id: t
			}
...
function Eg() {
	return z.safeDelete("/share/posts/mine")
}

function Ag({
	limit: t
}) {
	return z.safeGet("/share/posts/mine", {
		parameters: {
			query: {
				limit: t
			}
...
function Lg() {
	const t = ue(),
		...
		n = Ln(!0),
		{
			...
			mutationFn: () => Promise.allSettled([z.safeDelete("/share/all", {
				requestBody: {
					confirm: !0
				}
			}), z.safeDelete("/shared_textdocs", {}), n() ? Eg() : Promise.resolve()]),
			onSettled: () => {
				t.invalidateQueries({
					queryKey: Ie.sharedConversations
				}), t.invalidateQueries({
					queryKey: Ie.sharedTextdocs
				}), t.invalidateQueries({
					queryKey: Ie.sharedPosts
				})
			},
			onError: () => {
				a.danger($.deleteAllSharedLinksFailed, {
	...
	return e.jsx(sn, {
		...
		children: e.jsx(W.Item, {
			onClick: () => {
				window.confirm(s.formatMessage($.deleteAllSharedLinksConfirm)) && o()
			},
			color: "danger",
			children: e.jsx(c, {
				...$.deleteAllSharedLinks
...
function Og() {
	return z.safeGet("/shared_conversations", {
		parameters: {
			query: {
				order: "created"
			}
...
function Ig() {
	return Pe({
		queryKey: Ie.sharedTextdocs,
		queryFn: () => z.safeGet("/shared_textdocs", {}),
		refetchOnMount: "always"
	})
}
...
const Ks = ({
	...
	return e.jsx(R.Cell, {
		...
		children: e.jsxs(R.Actions, {
			children: [t && e.jsx(fe, {
				label: a.formatMessage($.goToOriginConversation),
				side: "top",
				children: e.jsx("a", {
					href: Pl(t),
					target: "_blank",
					rel: "noreferrer",
					"aria-label": a.formatMessage($.goToOriginConversation),
				...
				label: a.formatMessage($.deleteSharedLink),
				side: "top",
				className: "flex h-fit",
				children: e.jsx("button", {
					onClick: s,
					"aria-label": a.formatMessage($.deleteSharedLink),
					className: "text-token-text-tertiary hover:text-token-text-secondary",
					children: e.jsx(Fs, {
						className: "icon-sm"
					})
...
function Bg({
	...
	const s = U(),
		a = ue(),
		{
			...
			mutationFn: ({
				sharedConversationId: l
			}) => z.safeDelete("/share/{shared_conversation_id}", {
				parameters: {
					path: {
			...
			onError: () => {
				s.danger($.deleteSharedLinkFailed, {
...
function Fg({
	...
	const {
		...
		mutationFn: async ({
			sharedTextdocId: r
		}) => z.safeDelete("/textdoc/shared/{shared_textdoc_id}", {
			parameters: {
				path: {
					shared_textdoc_id: r
				}
		...
		onError: () => {
			n.danger($.deleteSharedLinkFailed, {
				toastId: "delete_shared_link_failed"
			})
		}
	});
	return e.jsxs(R.Row, {
		...
		children: [e.jsx(R.Cell, {
			...
			children: t.created_at != null ? e.jsx(os, {
				value: t.created_at,
				month: "long",
				year: "numeric",
				day: "numeric"
...
function Gg({
	...
	const s = U(),
		...
		i = t.attachments?.[0]?.kind === "media_generation" ? $.imageType : $.postType;
	return e.jsxs(R.Row, {
		disabled: o,
		children: [e.jsx(R.Cell, {
			children: e.jsxs("a", {
			...
			children: t.posted_at != null ? e.jsx(os, {
...
function Ug({
	...
	return a || l || h ? C = e.jsx("div", {
	...
	}) : s?.total === 0 && i?.shared_textdocs.length === 0 && u?.items.length === 0 ? C = e.jsx("div", {
		className: "text-token-text-tertiary pb-8",
		children: e.jsx(c, {
			...$.noSharedConversations
		})
		...
		children: [e.jsxs(R.Header, {
			...
			children: [s?.items.map(j => e.jsx(Bg, {
				sharedConversation: j
			}, j.id)), i?.shared_textdocs.map(j => e.jsx(Fg, {
				sharedTextdoc: j
			}, j.shared_textdoc_id)), u?.items.map(j => e.jsx(Gg, {
				sharedPost: j
			}, j.id))]
		})]
	}), e.jsx(K, {
		...
		className: "max-w-5xl",
		type: "success",
		title: p.formatMessage($.title),
		testId: "modal-shared-conversations",
		showCloseButton: !0,
		children: C
	})
}
const co = "https://help.openai.com/en/articles/5722486",
	Wg = "https://help.openai.com/en/articles/8400625-voice-mode-faq#h_3839e62d6a";
	...
	const s = Nt(t),
		{
			...
			queryFn: () => z.safeGet("/accounts/data_usage_for_training"),
			enabled: s != null
		});
...
function Vg({
	...
	if (!t) return null;
	const a = qt(s, "3431098147");
	return t.isFree() && a.get("should_show_subscription_settings_to_free", !1) ? le.FREE : t.isPlus() ? le.PLUS : t.isPro() ? le.PRO : null
}

function zg() {
	const {
		data: t
	} = mt(), s = v(), a = He(Je.isBusinessWorkspace), [n, o] = f.useState(!1), i = He(Je.isTeamPlan), l = He(Je.isEduPlan), {
		data: r
	} = Xe(te.TrainingAllowed), {
		data: d
	} = Xe(te.VoiceTrainingAllowed), {
		data: u
	} = Xe(te.VideoTrainingAllowed), h = ht(), m = Hg(t), g = m === "disallowed" ? !1 : !!r;
	return e.jsxs(D, {
		children: [e.jsx(an, {
			onClick: () => o(!0),
			label: s.formatMessage(k.chatTrainingAllowedToggleLabel),
			...
			children: [e.jsx("div", {
				...
				children: e.jsx(ke, {
					...
					toggleTooltip: a ? e.jsx(c, {
						...i ? k.chatTrainingTeamsTooltip : l ? k.chatTrainingEduTooltip : k.chatTrainingEnterpriseTooltip
					}) : null,
					description: e.jsx(c, {
						...k.trainingAllowedDescription,
						values: {
							link: p => e.jsx("a", {
								href: co,
								target: "_blank",
				...
				children: [e.jsx("p", {
					...
					className: "pb-2",
					children: e.jsx(ke, {
						label: s.formatMessage(k.voiceTrainingAllowedLabel),
						enabled: g ? !!d : !1,
						disabled: !g,
						onChange: p => {
							g && h.mutate({
					...
					label: s.formatMessage(k.videoTrainingAllowedLabel),
					enabled: g ? !!u : !1,
					disabled: !g,
					onChange: p => {
						g && h.mutate({
					...
					description: e.jsx(c, {
						...k.voiceAndVideoTrainingDescription,
						values: {
							link: p => e.jsx("a", {
								href: Wg,
								target: "_blank",
...
const Kg = () => {
	const t = H(),
		...
		N = Xt(),
		{
			hasContextConnectorEnabled: L
		} = as(),
		{
			data: S
		} = Pe(bn),
		T = S?.items,
		P = T != null && T.length > 0 || L || N,
		Y = Z(t, "733205176"),
		we = Z(t, "2509278897"),
		Fe = bs(Te.CookieManagement),
		qe = On(),
		Ye = w?.isQuorum(),
		Qe = ue(),
		nt = x.status !== "loading",
		{
			native_default_factor_id: X
		} = x,
		ot = () => {
			if (x.status !== "enabled") throw new Error("MFA is not enabled");
			if (!X) throw new Error("No factor ID found");
			return z.safePost("/accounts/mfa/user/disable_in_house", {
				requestBody: {
					factor_id: X
				}
			})
		...
		xt = () => {
			ot().then(() => {
				Qe.invalidateQueries({
					queryKey: ["mfaInfo"]
				}), o(ta(sa.DISABLE_MFA_SUCCESS, `/#settings/${q.Security}`))
			}).catch(() => {
				o(ta(sa.DISABLE_MFA_TIMEOUT, `/#settings/${q.Security}`))
			})
		},
		it = Z(t, "3325813340");
	return b ? nt ? e.jsx(Ju, {
		onClose: () => o("/", {
			replace: !0
		}),
		onConfirm: xt
	}) : null : Fe ? null : p ? e.jsx(yu, {
		onClose: () => {
			d ? o(n, {
				replace: !0
			}) : (C(!1), g())
		...
		type: "success",
		title: s.formatMessage(k.settings),
		showCloseButton: !0,
		...
		children: e.jsxs($i, {
			...
			children: [e.jsxs(Zi, {
				className: "bg-token-bg-elevated-secondary border-token-border-light flex shrink-0 flex-row flex-wrap select-none max-md:overflow-x-auto max-md:border-b max-md:p-1.5 md:max-w-[200px] md:flex-col md:border-e dark:bg-black/10",
				children: [e.jsx("div", {
				...
				}), it && !Ye && e.jsx(Au, {}), qe && e.jsx(Ue, {
					value: q.Personalization,
					icon: ku,
					label: e.jsx(c, {
						...k.personalizationTab
					}),
				...
				value: q.Connectors,
				children: we ? e.jsx(ru, {
					onAddOauthLinkClick: () => {
						m({}), C(!0)
					},
					onCreateCustomConnectorClick: () => M(!0)
				}) : e.jsx(Bd, {})
			}), e.jsx(Ge, {
				value: q.DataControls,
				children: e.jsx(Yg, {})
...
function qg() {
	...
	return f.useEffect(() => {
		...
		title: t.formatMessage(k.settings),
		children: [a && e.jsx(cg, {}), a && e.jsx(pg, {}), a && e.jsx(ug, {}), e.jsx(D, {
			children: e.jsx(eg, {})
		}), a && e.jsx(gg, {}), e.jsx(D, {
			children: e.jsx(em, {})
		}), e.jsx(Cc, {}), l && e.jsx(D, {
			children: e.jsx(ke, {
				label: t.formatMessage(k.modelStickyForNewChats),
				enabled: d,
				onChange: h => {
					u(h), s.mutate({
			...
			children: e.jsx(ke, {
				label: t.formatMessage(k.showFollowupsLabel),
				enabled: !o,
				onChange: h => {
					n.setDisabledGlobally(!h), O.logEventWithStatsig("chatgpt_message_followup_setting", "chatgpt_message_followup_setting", {
...
function Yg() {
	const t = H(),
		...
		o = Ce(),
		i = Il(Ta.WorkspaceShareLinks),
		l = ht(),
		{
			data: r
		} = mt(),
		d = Nt(r),
		u = He(Je.isBusinessWorkspace),
		h = d?.isTeam(),
		m = r?.accountItems.some(y => y.isPersonalAccount()),
		g = Tn(),
		p = Pn(),
		C = En(),
		j = An(t),
		M = ue(),
		b = () => {
			z.safePatch("/conversations", {
				requestBody: {
					is_archived: !0
				}
			}).then(() => {
				a.info(s.formatMessage(k.archiveHistorySuccess)), Ms(M)
			}), n !== "/" && o("/", {
				replace: !0
			})
		},
	...
	return e.jsxs(ne, {
		title: s.formatMessage(k.dataControlsTab),
		children: [e.jsx(zg, {}), C && j && e.jsx(D, {
			children: e.jsx(ke, {
				label: s.formatMessage({
					id: "APWP2z",
			...
			children: e.jsx(je, {
				label: s.formatMessage(k.sharedConversations),
				buttonLabel: s.formatMessage(k.manageButton),
				onClick: () => {
					_e(t, Ug)
				},
			...
			children: e.jsx(je, {
				label: s.formatMessage(k.archivedConversations),
				buttonLabel: s.formatMessage(k.manageButton),
				onClick: () => {
					_e(t, wg)
				},
			...
			children: e.jsx(je, {
				label: s.formatMessage(k.archiveChatsLabel),
				buttonLabel: s.formatMessage(k.archiveChatsButton),
				onClick: () => {
					_e(t, am, {
						onArchiveHistory: b
					})
			...
			children: e.jsx(je, {
				color: "danger-outline",
				label: s.formatMessage(k.deleteChatLabel),
				buttonLabel: s.formatMessage(k.deleteChatButton),
				onClick: () => {
					_e(t, sm, {
						onDeleteHistory: x
					})
			...
			children: e.jsx(je, {
				label: s.formatMessage(k.mergePersonalData),
				buttonLabel: s.formatMessage(k.mergeButton),
				onClick: () => {
					_e(t, Rl, {
						fromSettings: !0
					})
			...
			children: e.jsx(je, {
				label: s.formatMessage(k.exportData),
				buttonLabel: s.formatMessage(k.exportButton),
				onClick: () => {
					_e(t, nm)
				},
...
function Qg() {
	const t = v();
	return e.jsx(ne, {
		title: t.formatMessage(k.schedulesTab),
		children: e.jsxs("div", {
...
function $g() {
	const t = v(),
		...
		C = Nt(g)?.features,
		j = u === "enabled" || m?.email != null && C?.includes(sr) === !0 && (u === "loading" || u === "disabled"),
		M = f.useCallback(() => {
			i(!0), z.safePost("/accounts/logout_all").then(() => {
				s.success(t.formatMessage(k.logoutAllSuccess), {
					testId: "logout-all-success-toaster"
				}), bt()
			}).catch(b => {
				ve.addError(new Error("Failed logging out all accounts: ", {
					cause: b
				})), s.danger(k.logoutAllFailed, {
					hasCloseButton: !0,
	...
	return e.jsxs(e.Fragment, {
		children: [e.jsxs(ne, {
			title: t.formatMessage(k.securityTab),
			children: [j && e.jsx(D, {
				children: e.jsx(ke, {
					label: t.formatMessage({
				...
				children: e.jsx(je, {
					label: t.formatMessage(k.logOutLabel),
					buttonLabel: t.formatMessage(k.logOutButton),
					onClick: () => bt(),
...
function Zg() {
	const t = H(),
		...
		r = () => {
			n && _e(t, ({
				...
				isOpen: !0,
				onClose: () => {
					O.logEventWithStatsig("Cancel Subscription Modal Dismissed", "chatgpt_cancel_subscription_modal_dismissed"), m()
				},
				onClaimOfferButtonClicked: () => {
					O.logEventWithStatsig("Cancel Subscription Modal Claim Offer Button Clicked", "chatgpt_cancel_subscription_modal_claim_offer_offer_button_clicked"), m(), d()
				},
				currentAccount: n
			}))
		},
	...
	return e.jsxs(e.Fragment, {
		children: [e.jsxs(ne, {
			title: s.formatMessage(k.accountTab),
			children: [h, e.jsx(Zu, {}), !i && e.jsx(D, {
				children: e.jsx(je, {
					label: s.formatMessage(k.deleteAccount),
					buttonLabel: s.formatMessage(k.deleteAccountButton),
					color: "danger-outline",
					onClick: () => {
						_e(t, om)
					},
		...
		children: [e.jsx("div", {
			...
			onValueChange: r => {
				O.logEvent("Locale Updated by User", {
					...
					suggested_locale: o ?? ""
				}), Jt.logEvent("chatgpt_locale_updated_by_user", r, {
					from_locale: t,
					to_locale: r,
					raw_browser_locale: n ?? "",
					suggested_locale: o ?? ""
			...
			children: [e.jsxs(Ee.Trigger, {
				children: [e.jsx(Ee.Value, {}), e.jsx(Ee.Icon, {})]
			}), e.jsx(Ee.Portal, {
				children: e.jsxs(Ee.Content, {
					side: void 0,
					sideOffset: void 0,
					position: "item-aligned",
					children: [e.jsx(Ee.Item, {
						value: "auto",
						children: e.jsx(c, {
							...k.localeAuto
						})
					}), i.map(r => e.jsx(Ee.Item, {
						value: r,
						children: na[r] ?? r
					}, r)), e.jsx(Ee.Separator, {}), l.map(r => e.jsx(Ee.Item, {
						value: r,
						children: na[r] ?? r
					}, r))]
				})
...
function tm() {
	...
	return f.useEffect(() => {
		Jt.logEvent("chatgpt_unauthenticated_settings_modal_shown"), O.logEvent("Unauthenticated Settings Modal Shown")
	}, []), e.jsx(K, {
		...
		children: e.jsx(D, {
			children: e.jsx(ke, {
				...
				enabled: s,
				onChange: n => {
					Vi.setIsNoAuthChatTrainingEnabled(n), O.logEvent("No Auth Chat Training Toggled", {
						isEnabled: n
					})
				},
				description: e.jsx(c, {
...
function sm({
	...
	return e.jsx(K, {
		...
		onClose: t,
		type: "success",
		title: a.formatMessage(k.deleteHistoryModalTitle),
		description: n && e.jsx(c, {
		...
		primaryButton: e.jsx(ae.Button, {
			title: a.formatMessage(k.deleteHistoryModalConfirm),
			color: "danger",
			onClick: () => {
				s(), t()
			},
		...
		secondaryButton: e.jsx(ae.Button, {
			title: a.formatMessage(k.deleteHistoryModalCancel),
			color: "secondary",
			onClick: t
		})
	})
...
function am({
	...
	return e.jsx(K, {
		...
		onClose: t,
		type: "success",
		title: a.formatMessage(k.archiveHistoryModalTitle),
		primaryButton: e.jsx(ae.Button, {
			title: a.formatMessage(k.archiveHistoryModalConfirm),
			color: "primary",
			onClick: () => {
				s(), t()
			}
		...
		secondaryButton: e.jsx(ae.Button, {
			title: a.formatMessage(k.archiveHistoryModalCancel),
			color: "secondary",
			onClick: t
		})
	})
...
function nm({
	...
	const s = v(),
		...
		n = f.useCallback(() => {
			try {
				z.safePost("/accounts/data_export").then(() => {
					a.success(s.formatMessage(k.dataExportRequested), {
						testId: "data-export-success-toaster"
					}), t()
				})
			} catch {
				a.warning(s.formatMessage(k.dataExportFailed), {
					hasCloseButton: !0
				})
			}
		}, [s, a, t]);
	return e.jsx(K, {
		...
		onClose: t,
		type: "success",
		title: s.formatMessage(k.dataExportModalTitle),
		primaryButton: e.jsx(ae.Button, {
			title: s.formatMessage(k.dataExportModalConfirm),
			color: "primary",
			onClick: n,
			"data-testid": "confirm-data-export-button"
		}),
		secondaryButton: e.jsx(ae.Button, {
			title: s.formatMessage(k.dataExportModalCancel),
			color: "secondary",
			onClick: t
		}),
		children: e.jsxs("div", {
			...
			children: [e.jsxs("ul", {
				...
				children: [e.jsx("li", {
					children: e.jsx(c, {
						...k.dataExportModalDescription1
					})
				}), e.jsx("li", {
					children: e.jsx(c, {
						...k.dataExportModalDescription2
					})
				}), e.jsx("li", {
					children: e.jsx(c, {
						...k.dataExportModalDescription3
					})
				}), e.jsx("li", {
					children: e.jsx(c, {
						...k.dataExportModalDescription4
					})
				})]
			}), e.jsx("div", {
				children: e.jsx(c, {
					...k.dataExportModalDescription5
				})
			})]
		})
	})
...
function om({
	...
	const s = v(),
		...
		l = o?.phone_number,
		r = i || l || void 0,
		d = i ? k.typeEmailLabel : k.typePhoneNumberLabel,
		[u, h] = f.useState(""),
		[m, g] = f.useState(""),
		p = f.useCallback(() => {
			const w = n?.user?.iat;
		...
		C = f.useCallback(() => {
			try {
				p() ? z.safePost("/accounts/deactivate").then(() => {
					bt()
				}) : a.warning(s.formatMessage(k.deleteAccountSessionTooOld), {
					hasCloseButton: !0
				})
			} catch {
				a.warning(s.formatMessage(k.deleteAccountFailed), {
					hasCloseButton: !0
				})
			}
		}, [s, a, p]),
		...
		M = m === "DELETE" && (r === void 0 || u.toLowerCase() === r.toLowerCase()),
		[b] = f.useState(() => p()),
		x = Bl();
	return e.jsx(K, {
		...
		onClose: t,
		type: "success",
		title: s.formatMessage(k.deleteAccountTitle),
		showCloseButton: !0,
		children: e.jsxs("div", {
			className: "text-sm",
			children: [e.jsxs("ul", {
				...
				children: [e.jsx("li", {
					children: e.jsx(c, {
						...k.deleteAccountWarning
					})
				}), e.jsx("li", {
					children: e.jsx(c, {
						...k.apiAccessDeletionWarning
					})
				}), e.jsx("li", {
					children: e.jsx(c, {
						...k.reuseEmailPhoneWarning
					})
				}), e.jsx("li", {
					children: e.jsx(c, {
						...k.dataRemovalWarning
					})
				}), x?.purchase_origin_platform === Yt.MOBILE_IOS && e.jsx("li", {
					children: e.jsx(c, {
						...k.iapSubscriptionWarning
					})
				}), x?.purchase_origin_platform === Yt.MOBILE_ANDROID && e.jsx("li", {
					children: e.jsx(c, {
						...k.playStoreSubscriptionWarning
					})
				}), e.jsx("li", {
					children: e.jsx(c, {
						...k.deleteHelpCenter,
				...
				children: [r !== "undefined" ? e.jsxs("div", {
					...
					color: M ? "danger" : void 0,
					onClick: C,
					disabled: !M,
					fullWidth: !0,
					icon: M ? tn : Aa,
					children: M ? e.jsx(c, {
						...k.deleteAccountButtonLabel
					}) : e.jsx(c, {
						...k.lockedButtonLabel
					})
				})]
...
const Na = de.label`block text-sm font-semibold mb-1`,
	k = B({
		settings: {
...
function im() {
	...
	return t ? s ? e.jsx(tm, {}) : e.jsx(Kg, {}) : null
}
...
const lm = Ls(() => Os(() => import("./ksc7cmkbpcodyd9o.js"), __vite__mapDeps([0, 1, 2, 3, 4, 5, 6, 7])).then(t => t.FannyPackModalContainer)),
	cm = Ls(() => Os(() => import("./c9ft6i9h8fs69flr.js"), __vite__mapDeps([8, 1, 6, 2, 3, 7])));

function dm() {
	const t = vt(s => s.sharingModalThreadId);
	return t ? e.jsx(cm, {
		serverThreadId: t
	}) : null
}
const um = Ls(() => Os(() => import("./bhb6cy3wcttd33y4.js"), __vite__mapDeps([9, 1, 2, 3, 6, 7, 10, 11])).then(t => t.UserContextModal));

function tf() {
	const t = vt(x => x.purchaseWorkspaceData),
		s = vt(x => x.leaveWorkspaceData),
		a = t != null,
		n = bs(Te.UserContext),
		o = bs(Te.GlobalMemoryOnboarding),
		i = ce(),
		{
			shouldShowTeamSignupLanding: l,
			shouldShowTeamSignupDirectPurchase: r
		} = ed();
	ac(a);
	const d = Ce(),
		{
		...
		{
			isFannyPackEnabled: m
		} = Gl();
	Yl();
	const g = Ul(x => x.researchShareIntent),
		{
			isEnabled: p
		} = gc(),
		[C] = cn(),
		j = C.get(gn),
		M = Wl(j ?? ""),
		b = j && (M.promoMetadata ?? M.promoError ?? M.isPromoLoading);
	return e.jsxs(e.Fragment, {
		children: [e.jsx(im, {}), e.jsx(sd, {}), e.jsx(kd, {}), e.jsx(Oc, {}), l && e.jsx(td, {}), r && e.jsx(nc, {}), u && i && !b && e.jsx(sc, {
			currentAccount: i,
			defaultTab: h,
			onClose: () => rr(d)
		}), b && i && e.jsx(nd, {
			currentAccount: i,
			promotionData: M
		}), e.jsx(Hl, {}), e.jsx(ql, {}), a && e.jsx(oc, {
			isOpen: a,
			onClose: () => {
				he.setPurchaseWorkspaceData(null), d({
			...
			onClose: () => he.closeModal(Te.GlobalMemoryOnboarding)
		}), m && e.jsx(lm, {}), e.jsx(dm, {}), g && e.jsx(Lc, {
			taskId: g.taskId,
			messages: g.messages,
			threadId: g.threadId
		}), e.jsx(Bc, {}), null, p ? e.jsx(rm, {}) : null]
	})
}
export {
	tf as GlobalModalsComponent
};
//# sourceMappingURL=nlefucx2ofvjj5iu.js.map