...
function Io() {
	return Cr || (Cr = 1, function(D, W) {
		(function(z, C) {
			...
			function Ue(e, n) {
				typeof n == "function" && (n = n($(e))), (typeof Reflect > "u" ? L : Reflect.ownKeys)(n).forEach(function(t) {
					xe(e, t, n[t])
				})
			}
			...
			function ae(e, n, t) {
				if (e && n !== void 0 && !("isFrozen" in Object && Object.isFrozen(e)))
					if (typeof n != "string" && "length" in n) {
						...
						var i, a, u = n.indexOf(".");
						u !== -1 ? (i = n.substr(0, u), (a = n.substr(u + 1)) === "" ? t === void 0 ? K(e) && !isNaN(parseInt(i)) ? e.splice(i, 1) : delete e[i] : e[i] = t : ae(u = !(u = e[i]) || !Y(e, i) ? e[i] = {} : u, a, t)) : t === void 0 ? K(e) && !isNaN(parseInt(n)) ? e.splice(n, 1) : delete e[n] : e[n] = t
					}
			}
...
`)
 ...
 ` + i : ""), this.inner = i || null) : typeof o == "object" && (this.message = "".concat(o.name, " ").concat(o.message), this.inner = o) : (this.message = Mr[n] || t, this.inner = null)
			...
			function zr(e, n) {
				return e === V ? n : function(t) {
					...
					var o = this.onsuccess,
						i = this.onerror;
					return this.onsuccess = null, this.onerror = null, t = n.apply(this, arguments), o && (this.onsuccess = this.onsuccess ? De(o, this.onsuccess) : o), i && (this.onerror = this.onerror ? De(i, this.onerror) : i), r === void 0 ? t === void 0 ? void 0 : t : N(r, t)
				}
			}
			...
			Ue(A.prototype, {
				then: it,
				_then: function(e, n) {
					ut(this, new Ht(null, null, e, n, I))
				},
				catch: function(e) {
				...
				all: function() {
					var e = ve.apply(null, arguments).map(In);
			...
			function Pe(e, n, t, r) {
				var o = I,
					i = Object.create(o);
				return i.parent = o, i.ref = 0, i.global = !1, i.id = ++Gr, ke.env, i.env = tt ? {
					Promise: A,
					PromiseProp: {
						value: A,
						configurable: !0,
					...
					resolve: A.resolve,
					reject: A.reject
				} : {}, n && N(i, n), ++o.ref, i.finalize = function() {
					--this.parent.ref || this.parent.finalize()
				}, r = Re(i, e, t, r), i.ref === 0 && i.finalize(), r
			}

			function Qe() {
				return J.id || (J.id = ++Qr), ++J.awaits, J.echoes += Gt, J.id
			}
			...
			function Ee(e, n) {
				var t, r = I;
				(n ? !J.echoes || An++ && e === I : !An || --An && e === I) || queueMicrotask(n ? function(o) {
					++Cn, J.echoes && --J.echoes != 0 || (J.echoes = J.awaits = J.id = 0), En.push(I), Ee(o, !0)
				}.bind(null, e) : Hr), e !== I && (I = e, r === ke && (ke.env = Jt()), tt && (t = ke.env.Promise, n = e.env, (r.global || e.global) && (Object.defineProperty(F, "Promise", n.PromiseProp), t.all = n.all, t.race = n.race, t.resolve = n.resolve, t.reject = n.reject, n.allSettled && (t.allSettled = n.allSettled), n.any && (t.any = n.any))))
			}
			...
			}("" + ce).indexOf("[native code]") === -1 && (Qe = Oe = V);
			var H = A.reject,
				qe = "￿",
			...
			function Kn(e) {
				return typeof e != "string" || /\./.test(e) ? function(n) {
					...
					return n[e] === void 0 && e in n && delete(n = Se(n))[e], n
				}
			}
			...
			var ir = (Q.prototype._trans = function(e, n, t) {
				...
				var u = We();
				try {
					var f = r && r.db._novip === this.db._novip ? r === I.trans ? r._promise(e, a, t) : Pe(function() {
						return r._promise(e, a, t)
					}, {
						trans: r,
						transless: I.transless || I
					}) : function c(p, s, y, l) {
						if (p.idbdb && (p._state.openComplete || I.letThrough || p._vip)) {
				...
				function o() {
					...
					z(f, c), f.prototype = c === null ? Object.create(c) : (p.prototype = c.prototype, new p)
			...
			var Xr = (U.prototype._read = function(e, n) {
				...
				return this._write(function(r) {
					var o, i, a;
					a = typeof e == "function" ? e : (o = L(e), i = o.length, function(h) {
						...
						function m(b) {
							...
							return f.getMany({
								...
								return Promise.resolve(0 < O.length && f.mutate({
									...
									for (var R in B.failures) E.splice(parseInt(R), 1);
									u(O.length, B)
								})).then(function() {
					...
					for (var b = null, w = l; w < s; ++w) {
						var x = function(O, k, P, E, _, T) {
							for (var j = Math.min(O.length, E.length), B = -1, R = 0; R < j; ++R) {
								var le = k[R];
								if (le !== E[R]) return _(O[R], P[R]) < 0 ? O.substr(0, R) + P[R] + P.substr(R + 1) : _(O[R], E[R]) < 0 ? O.substr(0, R) + E[R] + P.substr(R + 1) : 0 <= B ? O.substr(0, B) + k[B] + P.substr(B + 1) : null;
								_(O[R], le) < 0 && (B = R)
							}
			...
			var lr = (Object.defineProperty(Z.prototype, "Collection", {
				...
				if (!m.every(function(g) {
					...
					})) return ue(this, "First argument to inAnyRange() must be an Array of two-value Arrays [lower,upper] where upper must not be lower than lower", S.InvalidArgument);
			...
			var hn = "storagemutated",
				...
				eo = (de.prototype._lock = function() {
					return Ze(!I.global), ++this._reculock, this._reculock !== 1 || I.global || (I.lockOwnerFor = this), this
				}, de.prototype._unlock = function() {
					if (Ze(!I.global), --this._reculock == 0)
						for (I.global || (I.lockOwnerFor = null); 0 < this._blockedFuncs.length && !this._locked();) {
					...
					return Ze(this._completion._state === null), (e = this.idbtrans = e || (this.db.core || t).transaction(this.storeNames, this.mode, {
						...
						n.active = !1, n._resolve(), "mutatedParts" in e && Ce.storagemutated.fire(e.mutatedParts)
					}), this
					...
					return {
							...
							return new Promise(function(x, O) {
								...
								if (m === "deleteRange") {
									...
									var P = E ? P ? [b, g] : [b, null] : [g, null],
										...
										ne = P[1];
									if (E)
										for (var te = 0; te < T; ++te) B.push(_ = ne && ne[te] !== void 0 ? k[m](q[te], ne[te]) : k[m](q[te])), _.onerror = j;
									else
										for (te = 0; te < T; ++te) B.push(_ = k[m](q[te])), _.onerror = j
								}

								function Yn(oe) {
									oe = oe.target.result, B.forEach(function(Ne, qt) {
						...
						getMany: function(v) {
							...
							return new Promise(function(g, b) {
								...
								for (var w, x = h.objectStore(d), O = m.length, k = new Array(O), P = 0, E = 0, _ = function(B) {
										B = B.target, k[B._pos] = B.result, ++E === P && g(k)
						...
						openCursor: function(v) {
							...
							return new Promise(function(x, O) {
								...
								_.onerror = he(O), _.onsuccess = G(function(T) {
									var j, B, R, le, q = _.result;
									q ? (q.___id = ++no, q.done = !1, j = q.continue.bind(q), B = (B = q.continuePrimaryKey) && B.bind(q), R = q.advance.bind(q), le = function() {
										throw new Error("Cursor not stopped")
									}, q.trans = h, q.stop = q.continue = q.continuePrimaryKey = q.advance = function() {
										throw new Error("Cursor not started")
									}, q.fail = G(O), q.next = function() {
										var ne = this,
											te = 1;
										...
										var Yn = new Promise(function(oe, Ne) {
											oe = G(oe), _.onerror = he(Ne), q.fail = Ne, q.stop = function(qt) {
												q.stop = q.continue = q.continuePrimaryKey = q.advance = le, oe(qt)
											}
										});
										return _.onsuccess = G(function(oe) {
											_.onsuccess = te, te()
										}), q.continue = j, q.continuePrimaryKey = B, q.advance = R, te(), Yn
									}, x(q)) : x(null)
								}, O)
							})
						},
			...
			function io(e, n, t, r) {
				...
				var a = i._reject.bind(i),
					u = I.transless || I;
				Pe(function() {
					return I.trans = i, I.transless = u, n !== 0 ? (Rn(e, t), c = n, ((f = i).storeNames.includes("$meta") ? f.table("$meta").get("version").then(function(p) {
						return p ?? c
							...
							v.push(function() {
								...
								if (x && m._cfg.version > y) {
									...
									w.del.forEach(function(E) {
										O[E] = g[E]
									}), bt(s, [s.Transaction.prototype]), qn(s, [s.Transaction.prototype], L(O), O), l.schema = O;
									var k, P = Zn(x);
									return P && Qe(), w = A.follow(function() {
										var E;
			...
			var uo = (Nn.prototype._parseStoresSpec = function(e, n) {
				...
				return t.forEach(function(i) {
					N(r, i._cfg.storesSource), o = i._cfg.dbschema = {}, i._parseStoresSpec(r, o)
				}), n._dbSchema = o, bt(n, [n._allTables, n, n.Transaction.prototype]), qn(n, [n._allTables, n, n.Transaction.prototype, this._cfg.tables], L(o), o), n._storeNames = L(o), this
			}, Nn.prototype.upgrade = function(e) {
				return this._cfg.contentUpgrade = nt(this._cfg.contentUpgrade || V, e), this
			}, Nn);
			...
			function vr(e) {
				var n, t, r = (((n = e.r) === null || n === void 0 ? void 0 : n.d) || 0) - (((t = e.l) === null || t === void 0 ? void 0 : t.d) || 0),
					o = 1 < r ? "r" : r < -1 ? "l" : "";
				o && (n = o == "r" ? "l" : "r", t = C({}, e), r = e[o], e.from = r.from, e.to = r.to, e[o] = r[o], t[o] = r[n], (e[n] = t).d = mr(t)), e.d = mr(e)
			}
			...
			function Vn(e) {
				Ln(At, e), Ct || (Ct = !0, setTimeout(function() {
					Ct = !1, It(At, !(At = {}))
				}, 0))
			}
			...
			function so(e) {
				...
				function u() {
					return new A(function(y, l) {
						...
						v.onerror = he(l), v.onblocked = G(e._fireOnBlocked), v.onupgradeneeded = G(function(h) {
							var m;
							...
							if (0 < O.length) try {
								...
								if (n.autoSchema) m = x, g = k, (h = e).verno = m.version / 10, g = h._dbSchema = Fn(0, m, g), h._storeNames = bn(m.objectStoreNames, 0), qn(h, [h._allTables], L(g), g);
							...
							Ge.push(e), x.onversionchange = G(function(P) {
								n.vcFired = !0, e.on("versionchange").fire(P)
							}), x.onclose = G(function(P) {
								e.on("close").fire(P)
			...
			function Kt(e, n, t, r) {
				return t = t || {}, r = r || "", L(e).forEach(function(o) {
					var i, a, u;
								...
								mutate: function(o) {
									...
									function p(s) {
										...
										return (s = s.type === "add" || s.type === "put" ? C(C({}, s), {
											keys: h
										}) : C({}, s)).type !== "delete" && (s.values = ee([], s.values)), s.keys && (s.keys = ee([], s.keys)), y = t, d = h, ((l = s).type === "add" ? Promise.resolve([]) : y.getMany({
											trans: l.trans,
											keys: d,
											cache: "immutable"
										})).then(function(m) {
											var g = h.map(function(b, w) {
												...
												return s.type === "delete" ? u.fire.call(E, b, P, v) : s.type === "add" || P === void 0 ? (x = f.fire.call(E, b, s.values[w], v), b == null && x != null && (s.keys[w] = b = x, r.outbound || ae(s.values[w], r.keyPath, b))) : (x = Kt(P, s.values[w]), (O = c.fire.call(E, x, b, P, v)) && (k = s.values[w], Object.keys(O).forEach(function(_) {
			...
			function br(e, n, t) {
				try {
					...
					for (var r = [], o = 0, i = 0; o < n.keys.length && i < e.length; ++o) M(n.keys[o], e[i]) === 0 && (r.push(t ? Se(n.values[o]) : n.values[o]), ++i);
				...
				create: function(e) {
					...
					return C(C({}, e), {
						transaction: function(r, o, i) {
							if (I.subscr && o !== "readonly") throw new S.ReadOnly("Readwrite transaction in liveQuery context. Querier source: ".concat(I.querier));
						...
						table: function(r) {
							var o = e.table(r),
								...
								p = C(C({}, o), {
									mutate: function(l) {
										function d(_) {
											return _ = "idb://".concat(n, "/").concat(r, "/").concat(_), b[_] || (b[_] = new re)
										}
										var v, h, m, g = l.trans,
											...
											P = E[1],
											E = l.trans._cache;
										return K(k) ? (w.addKeys(k), (E = O === "delete" || k.length === P.length ? br(k, E) : null) || x.addKeys(k), (E || P) && (v = d, h = E, m = P, i.indexes.forEach(function(_) {
											var T = v(_.name || "");
											...
											function B(R) {
												...
												var q = h && j(h[ne]),
													ne = m && j(m[ne]);
												M(q, ne) !== 0 && (q != null && B(q), ne != null && B(ne))
											})
										}))) : k ? (P = {
											from: k.lower,
											to: k.upper
							...
							return L(y).forEach(function(l) {
								p[l] = function(d) {
									var v = I.subscr,
										h = !!v,
										m = wr(I, o) && _r(l, d) ? d.obsSet = {} : v;
									if (h) {
										var g = function(P) {
												return P = "idb://".concat(n, "/").concat(r, "/").concat(P), m[P] || (m[P] = new re)
											},
											b = g(""),
											w = g(":dels"),
											v = y[l](d),
			...
			function xr(e, n, t) {
				...
				return t.numFailures === r ? null : (n = C({}, n), K(n.keys) && (n.keys = n.keys.filter(function(o, i) {
					...
					return C(C({}, e), {
											...
											if (l) {
												...
												if (u._explicit && f && u.mutatedParts)
													for (var h = 0, m = Object.values(l.queries.query); h < m.length; h++)
														for (var g = 0, b = (O = m[h]).slice(); g < b.length; g++) Et((k = b[g]).obsSet, u.mutatedParts) && (Ke(O, k), k.subscribers.forEach(function(T) {
															return c.add(T)
														}));
												else if (0 < v.length) {
													...
													for (var w = 0, x = Object.values(l.queries.query); w < x.length; w++)
														for (var O, k, P, E = 0, _ = (O = x[w]).slice(); E < _.length; E++)(k = _[E]).res != null && u.mutatedParts && (f && !k.dirty ? (P = Object.isFrozen(k.res), P = kr(k.res, k.req, v, d, k, P), k.dirty ? (Ke(O, k), k.subscribers.forEach(function(T) {
															return c.add(T)
														})) : P !== k.res && (k.res = P, k.promise = A.resolve({
															result: P
														}))) : (k.dirty && Ke(O, k), k.subscribers.forEach(function(T) {
															return c.add(T)
														})))
												}
											}
						...
						table: function(t) {
							...
							return C(C({}, r), {
									...
									return u ? (a = r.mutate(i), i.type !== "add" && i.type !== "put" || !(50 <= i.values.length || Dt(o, i).some(function(f) {
										...
										var c = xr(0, C(C({}, i), {
											values: i.values.map(function(l, s) {
												var y, l = (y = o.keyPath) !== null && y !== void 0 && y.includes(".") ? Se(l) : C({}, l);
								...
								query: function(i) {
									if (!wr(I, r) || !_r("query", i)) return r.query(i);
									var a = ((c = I.trans) === null || c === void 0 ? void 0 : c.db._options.cache) === "immutable",
										s = I,
										u = s.requery,
										f = s.signal,
										c = function(d, v, h, m) {
			...
			var be = (X.prototype.version = function(e) {
				...
				var n = this;
				return this.idbdb && (this._state.openComplete || I.letThrough || this._vip) ? e() : new A(function(t, r) {
				...
				return new A(function(o, i) {
					function a() {
						...
						u.onsuccess = G(function() {
							var f, c, p;
							f = n._deps, c = n.name, p = f.indexedDB, f = f.IDBKeyRange, kt(p) || c === Sn || xt(p, f).delete(c).catch(V), o()
				...
				return o ? o._promise(i, f, "lock") : I.trans ? Re(I.transless, function() {
					return r._whenReady(f)
				}) : this._whenReady(f)
			}, X.prototype.table = function(e) {
				if (!Y(this._allTables, e)) throw new S.InvalidTable("Table ".concat(e, " does not exist"));
						...
						var i = Zn(e),
							...
							p = {
								...
								unsubscribe: function() {
									u || (u = !0, a && a.abort(), s && Ce.storagemutated.unsubscribe(l))
								}
							};
						o.start && o.start(p);
						var s = !1,
			...
			function Rt(e) {
				var n = Ie;
				try {
					Ie = !0, Ce.storagemutated.fire(e), It(e, !0)
				} finally {
					Ie = n
				}
			}
			Ue(Me, C(C({}, _n), {
				...
				ignoreTransaction: function(e) {
					return I.trans ? Re(I.transless, e) : e()
				},
				vip: Pt,
				async: function(e) {
					return function() {
				...
				waitFor: function(e, n) {
					return n = A.resolve(typeof e == "function" ? Me.ignoreTransaction(e) : e).timeout(n || 6e4), I.trans ? I.trans.waitFor(n) : n
				},
				Promise: A,
				debug: {
					get: function() {
			...
			})), Me.maxKey = dn(Me.dependencies.IDBKeyRange), typeof dispatchEvent < "u" && typeof addEventListener < "u" && (Ce(hn, function(e) {
				Ie || (e = new CustomEvent(yt, {
					detail: e
				}), Ie = !0, dispatchEvent(e), Ie = !1)
			...
			return typeof BroadcastChannel < "u" && ((Er = function() {
			...
			})(), typeof Je.unref == "function" && Je.unref(), Ce(hn, function(e) {
				Ie || Je.postMessage(e)
				...
				!be.disableBfCache && e.persisted && (fe && console.debug("Dexie: handling persisted pageshow"), Er(), Rt({
					all: new re(-1 / 0, [
						[]
					])
				}))
...
const Ft = Ao(So),
	Ir = Symbol.for("Dexie"),
	Hn = globalThis[Ir] || (globalThis[Ir] = Ft);
if (Ft.semVer !== Hn.semVer) throw new Error(`Two different versions of Dexie loaded in the same app: ${Ft.semVer} and ${Hn.semVer}`);
const {
	liveQuery: Ko,
	mergeRanges: Fo,
	rangesOverlap: Mo,
...
function Do(D, W, z) {
	var C, ee;
	typeof D == "function" ? (C = W || [], ee = z) : (C = [], ee = W);
	var F = mn.useRef({
			hasResult: !1,
			result: ee,
			error: null
	...
	var K = L[1],
		N = mn.useMemo(function() {
			...
			if (!F.current.hasResult && typeof window < "u" && (typeof $.hasValue != "function" || $.hasValue()))
				if (typeof $.getValue == "function") F.current.result = $.getValue(), F.current.hasResult = !0;
				else {
					var se = $.subscribe(function(Y) {
						F.current.result = Y, F.current.hasResult = !0
					});
					typeof se == "function" ? se() : se.unsubscribe()
				} return $
		}, C);
	if (mn.useDebugValue(F.current.result), mn.useEffect(function() {
			var $ = N.subscribe(function(se) {
				var Y = F.current;
				(Y.error !== null || Y.result !== se) && (Y.error = null, Y.result = se, Y.hasResult = !0, K())
			}, function(se) {
				var Y = F.current;
				Y.error !== se && (Y.error = se, K())
			});
			return typeof $ == "function" ? $ : $.unsubscribe.bind($)
		}, C), F.current.error) throw F.current.error;
...
const Dr = {
	...
	gn = {
		init: (D = pe()) => {
			D.initialized || (we({
				initialized: !0
			}), Qn.on("createConversation", W => {
				Sr(W.clientThreadId)
			}), Qn.on("deleteConversation", W => {
				jo(W.serverThreadId)
			}), Qn.on("refreshHistory", W => {
				gn.setCurrentConversationIds(W.conversations.map(z => z.id))
			}), Qn.on("updateThreadTitle", W => {
				Sr(W.conversationId)
			}))
		},
		reset: () => we(Dr),
		...
		getCurrentAccountData: () => {
			...
			return D || ie.addError("FannyPack: Unavailable current account data"), D
		},
		setCurrentAccountV2: async D => {
			if (!D.accountUserId || !D.authUserId) {
				try {
					await pe().db.conversations.clear(), ie.addError("FannyPack: Invalid user. Cleared conversations")
				} catch {
			...
			if (W && W.authUserId !== z.authUserId) try {
				await pe().db.conversations.where("accountUserId").notEqual(_e(z?.accountUserId)).delete(), we({
...
function Ro(D, W, z = 0) {
	...
	return L.reduce((K, N) => (K.set(N.conversationId, N), K), new Map)
}
...
function Qo(D, W = 0) {
	const z = Oo(),
		...
		}).toArray().catch(L => (ie.addError(`FannyPack: Failed to fetch conversations: ${L}`), [])) : [], [D, z?.accountUserId]) ?? C.current;
	return Ar.useMemo(() => Ro(D, ee, W), [D, ee, W])
}
export {
	gn as F, Qo as u
};
//# sourceMappingURL=1qalzv2pc5hfujvd.js.map