...
function T(i, t, e, s) {
	let n, o, r;
	if (B(i))
		for (o = i.length, n = 0; n < o; n++) t.call(e, i[n], n);
	else if (O(i))
...
function pe(i) {
	if (B(i)) return i.map(pe);
	if (O(i)) {
		const t = Object.create(null),
			e = Object.keys(i),
			s = e.length;
		let n = 0;
		for (; n < s; ++n) t[e[n]] = pe(i[e[n]]);
		return t
	}
	return i
}
...
function Ls(i, t, e) {
	...
	if (i._sorted) {
		...
		d && (n = U(Math.min(xt(a, l, c).lo, e ? s : xt(t, l, r.getPixelForValue(c)).lo), 0, s - 1)), u ? o = U(Math.max(xt(a, r.axis, h, !0).hi + 1, e ? 0 : xt(t, l, r.getPixelForValue(h), !0).hi + 1), n, s) - n : o = s - n
	}
	return {
		start: n,
		count: o
...
const jn = {
	...
	numeric(i, t, e) {
		...
		if (e.length > 1) {
			...
			(c < 1e-4 || c > 1e15) && (n = "scientific"), o = $n(i, e)
		}
	...
	if (!(isNaN(p) || p <= 0)) {
		switch (i.beginPath(), f) {
			default:
				...
				break;
			case "triangle":
				h = n ? n / 2 : p, i.moveTo(e + Math.sin(m) * h, s - Math.cos(m) * p), m += ai, i.lineTo(e + Math.sin(m) * h, s - Math.cos(m) * p), m += ai, i.lineTo(e + Math.sin(m) * h, s - Math.cos(m) * p), i.closePath();
				break;
			case "rectRounded":
				c = p * .516, l = p - c, r = Math.cos(m + gt) * l, d = Math.cos(m + gt) * (n ? n / 2 - c : l), a = Math.sin(m + gt) * l, u = Math.sin(m + gt) * (n ? n / 2 - c : l), i.arc(e - d, s - a, c, m - H, m - V), i.arc(e + u, s - r, c, m - V, m), i.arc(e + d, s + a, c, m, m + V), i.arc(e - u, s + r, c, m + V, m + H), i.closePath();
				break;
			case "rect":
				if (!g) {
			...
			case "cross":
				...
				break;
			case "star":
				d = Math.cos(m) * (n ? n / 2 : p), r = Math.cos(m) * p, a = Math.sin(m) * p, u = Math.sin(m) * (n ? n / 2 : p), i.moveTo(e - d, s - a), i.lineTo(e + d, s + a), i.moveTo(e + u, s - r), i.lineTo(e - u, s + r), m += gt, d = Math.cos(m) * (n ? n / 2 : p), r = Math.cos(m) * p, a = Math.sin(m) * p, u = Math.sin(m) * (n ? n / 2 : p), i.moveTo(e - d, s - a), i.lineTo(e + d, s + a), i.moveTo(e + u, s - r), i.lineTo(e - u, s + r);
				break;
			case "line":
...
function Qt(i, t, e, s, n, o = {}) {
	...
	let l, c;
	for (i.save(), i.font = n.string, Gn(i, o), l = 0; l < r.length; ++l) c = r[l], o.backdrop && Qn(i, o.backdrop), a && (o.strokeColor && (i.strokeStyle = o.strokeColor), R(o.strokeWidth) || (i.lineWidth = o.strokeWidth), i.strokeText(c, e, s, o.maxWidth)), i.fillText(c, e, s, o.maxWidth), Jn(i, e, s, c, o), s += Number(n.lineHeight);
	i.restore()
}
...
function be(i, t) {
	...
	i.arc(e + r.topLeft, s + r.topLeft, r.topLeft, -V, H, !0), i.lineTo(e, s + o - r.bottomLeft), i.arc(e + r.bottomLeft, s + o - r.bottomLeft, r.bottomLeft, H, V, !0), i.lineTo(e + n - r.bottomRight, s + o), i.arc(e + n - r.bottomRight, s + o - r.bottomRight, r.bottomRight, V, 0, !0), i.lineTo(e + n, s + r.topRight), i.arc(e + n - r.topRight, s + r.topRight, r.topRight, 0, -V, !0), i.lineTo(e + r.topLeft, s)
}
...
function Y(i, t) {
	...
	s && !("" + s).match(to) && (console.warn('Invalid font style specified: "' + s + '"'), s = void 0);
	const n = {
	...
	return n.string = Xn(n), n
}

function se(i, t, e, s) {
	let n, o, r;
	for (n = 0, o = i.length; n < o; ++n)
		if (r = i[n], r !== void 0 && (t !== void 0 && typeof r == "function" && (r = r(t)), e !== void 0 && B(r) && (r = r[e % r.length]), r !== void 0)) return r
}
...
function so(i, t, e) {
	const {
		min: s,
		max: n
	} = i, o = Ss(t, (n - s) / 2), r = (a, l) => e && a === 0 ? 0 : a + l;
	return {
		min: r(s, -Math.abs(o)),
		max: r(n, o)
	}
...
function oo(i, t, e) {
	...
	let a = s[t];
	return ft(a) && r.isScriptable(t) && (a = ro(t, a, i, e)), B(a) && a.length && (a = ao(t, a, i, r.isIndexable)), Qe(t, a) && (a = At(a, n, o && o[t], r)), a
}
...
function ro(i, t, e, s) {
	...
	a.add(i);
	let l = t(o, r || s);
	return a.delete(i), Qe(i, l) && (l = Ze(n._scopes, n, i, l)), l
}
...
function Ze(i, t, e, s) {
	...
	return l === null || typeof o < "u" && o !== e && (l = bi(a, r, o, l, s), l === null) ? !1 : Je(Array.from(a), [""], n, o, () => ho(t, e, s))
}

function bi(i, t, e, s, n) {
	for (; e;) e = co(i, t, e, s, n);
	return e
}
...
function uo(i, t, e, s) {
	let n;
	for (const o of t)
		if (n = Hs(no(o, i), e), typeof n < "u") return Qe(i, n) ? Ze(e, s, i, n) : n
}
...
function _i(i) {
	let t = i._keys;
	return t || (t = i._keys = fo(i._scopes)), t
}
...
function bo(i, t, e = "x") {
	...
	let o, r, a, l = Tt(i, 0);
	for (let c = 0; c < n; ++c) {
		if (r = a, a = l, l = Tt(i, c + 1), !a) continue;
		const h = a[e],
			d = a[s];
...
function xo(i, t) {
	...
	for (e = 0, s = i.length; e < s; ++e) r = o, o = a, a = e < s - 1 && Jt(i[e + 1], t), o && (n = i[e], r && (n.cp1x = ne(n.cp1x, t.left, t.right), n.cp1y = ne(n.cp1y, t.top, t.bottom)), a && (n.cp2x = ne(n.cp2x, t.left, t.right), n.cp2y = ne(n.cp2y, t.top, t.bottom)))
}

function yo(i, t, e, s, n) {
	let o, r, a, l;
	if (t.spanGaps && (i = i.filter(c => !c.skip)), t.cubicInterpolationMode === "monotone") _o(i, n);
	else {
		let c = s ? i[i.length - 1] : i[0];
		for (o = 0, r = i.length; o < r; ++o) a = i[o], l = po(c, a, i[Math.min(o + 1, r - (s ? 0 : 1)) % r], t.tension), a.cp1x = l.previous.x, a.cp1y = l.previous.y, a.cp2x = l.next.x, a.cp2y = l.next.y, c = a
	}
...
function bt(i, t) {
	...
	} = t, n = ke(e), o = n.boxSizing === "border-box", r = yt(n, "padding"), a = yt(n, "border", "width"), {
		x: l,
		y: c,
		box: h
	} = So(i, e), d = r.left + (h && a.left), u = r.top + (h && a.top);
	let {
		width: f,
		height: g
	} = t;
	...
	if (t === void 0 || e === void 0) {
		...
		if (!o) t = i.clientWidth, e = i.clientHeight;
			...
			const r = o.getBoundingClientRect(),
				...
				l = yt(a, "border", "width"),
				c = yt(a, "padding");
			t = r.width - c.width - l.width, e = r.height - c.height - l.height, s = _e(a.maxWidth, o, "clientWidth"), n = _e(a.maxHeight, o, "clientHeight")
		}
	}
	return {
		width: t,
...
function Ys(i, t, e) {
	...
	const y = () => l(n, v, b) && a(n, v) !== 0,
		...
		M = () => p || y(),
		k = () => !p || x();
	for (let S = h, w = h; S <= d; ++S) _ = t[S % r], !_.skip && (b = c(_[s]), b !== v && (p = l(b, n, o), m === null && M() && (m = a(b, n) === 0 ? S : w), m !== null && k() && (g.push(vi({
		start: m,
		end: S,
		loop: u,
		count: r,
	...
	for (const g of t) {
		...
		for (u = d + 1; u <= g.end; u++) {
			...
			m = ki(s.setContext(kt(n, {
				...
				p1DataIndex: u % l,
				datasetIndex: r
			}))), Fo(m, h) && f(d, u - 1, g.loop, h), p = b, h = m
		}
...
function Fo(i, t) {
	...
	const e = [],
		s = function(n, o) {
			return Ke(o) ? (e.includes(o) || e.push(o), e.indexOf(o)) : o
		};
...
class Ho {
	constructor(t, e, s, n) {
		...
		this._active = !0, this._fn = t.fn || Wo[t.type || typeof r], this._easing = Yt[t.easing] || Yt.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = s, this._from = r, this._to = n, this._promises = void 0
	}
	active() {
		return this._active
	}
	update(t, e, s) {
		if (this._active) {
			...
			const n = this._target[this._prop],
				o = s - this._start,
				r = this._duration - o;
			this._start = s, this._duration = Math.floor(Math.max(r, t.duration)), this._total += o, this._loop = !!t.loop, this._to = se([t.to, e, n, t.from]), this._from = se([t.from, n, e])
		}
	}
	cancel() {
...
function Pi(i, t, e, s = {}) {
	...
	if (t !== null) {
		for (r = 0, a = n.length; r < a; ++r) {
			...
			c = i.values[l], X(c) && (o || t === 0 || ot(t) === ot(c)) && (t += c)
		}
		return t
	}
}
...
function Oi(i, t) {
	const {
		...
		vScale: r,
		index: a
	} = s, l = o.axis, c = r.axis, h = Yo(o, r, s), d = t.length;
	let u;
	for (let f = 0; f < d; ++f) {
		const g = t[f],
			{
		...
		u = b[c] = Ko(n, h, p), u[a] = m, u._top = Di(u, r, !0, s.type), u._bottom = Di(u, r, !1, s.type);
...
class te {
	...
	updateIndex(t) {
		this.index !== t && Ft(this._cachedMeta), this.index = t
	}
	linkScales() {
		const t = this.chart,
			e = this._cachedMeta,
	...
	_destroy() {
		const t = this._cachedMeta;
		this._data && hi(this._data, this), t._stacked && Ft(t)
	}
	_dataCheck() {
		const t = this.getDataset(),
			e = t.data || (t.data = []),
			s = this._data;
		if (O(e)) this._data = Uo(e);
		else if (s !== e) {
			if (s) {
				hi(s, this);
			...
			e && Object.isExtensible(e) && In(e, this), this._syncList = [], this._data = e
		}
	}
	addElements() {
		const t = this._cachedMeta;
	...
	buildOrUpdateElements(t) {
		...
		this._dataCheck();
		const o = e._stacked;
		e._stacked = Ci(e.vScale, e), e.stack !== s.stack && (n = !0, Ft(e), e.stack = s.stack), this._resyncElements(t), (n || o !== e._stacked) && Oi(this, e._parsed)
	}
	configure() {
	...
	updateRangeFromParsed(t, e, s, n) {
		...
		n && a && (n.values = a, r = Pi(n, o, this._cachedMeta.index)), t.min = Math.min(t.min, r), t.max = Math.max(t.max, r)
	}
	getMinMax(t, e) {
	...
	getAllParsedValues(t) {
		const e = this._cachedMeta._parsed,
			s = [];
		let n, o, r;
		for (n = 0, o = e.length; n < o; ++n) r = e[n][t.axis], X(r) && s.push(r);
		return s
	}
	getMaxOverflow() {
		return !1
	...
	_update(t) {
		const e = this._cachedMeta;
		this.update(t || "default"), e._clip = $o(D(this.options.clip, jo(e.xScale, e.yScale, this.getMaxOverflow())))
	}
	update(t) {}
	draw() {
		const t = this._ctx,
	...
	getContext(t, e, s) {
		...
		if (t >= 0 && t < this._cachedMeta.data.length) {
			...
			o = r.$context || (r.$context = Go(this.getContext(), t, r)), o.parsed = this.getParsed(t), o.raw = n.data[t], o.index = o.dataIndex = t
		} else o = this.$context || (this.$context = qo(this.chart.getContext(), this.index)), o.dataset = n, o.index = o.datasetIndex = this.index;
	...
	_resolveElementOptions(t, e = "default", s) {
		...
		return p.$shared && (p.$shared = l, o[r] = Object.freeze(Ai(p, l))), p
	}
...
function Zo(i) {
	...
	let s = t._length,
		n, o, r, a;
	const l = () => {
		r === 32767 || r === -32768 || (qt(a) && (s = Math.min(s, Math.abs(r - a) || s)), a = r)
	};
...
function Gs(i, t, e, s) {
	return B(i) ? ir(i, t, e, s) : t[e.axis] = e.parse(i, s), t
}
...
function Ti(i, t, e, s) {
	const n = i.iScale,
		...
		l = [];
	let c, h, d, u;
	for (c = e, h = e + s; c < h; ++c) u = t[c], d = {}, d[n.axis] = a || n.parse(r[c], c), l.push(Gs(u, d, o, c));
	return l
}
...
function or(i, t, e, s) {
	...
	n === "middle" && e && (i.enableBorderRadius = !0, (e._top || 0) === s ? n = c : (e._bottom || 0) === s ? n = h : (o[Li(h, r, a, l)] = !0, n = c)), o[Li(n, r, a, l)] = !0, i.borderSkipped = o
}

function Li(i, t, e, s) {
	return s ? (i = rr(i, t, e), i = Ri(i, e, t)) : i = Ri(i, t, e), i
}
...
class lr extends te {
	...
	parseObjectData(t, e, s, n) {
		...
		let u, f, g, p;
		for (u = s, f = s + n; u < f; ++u) p = e[u], g = {}, g[o.axis] = o.parse(vt(p, c), u), d.push(Gs(vt(p, h), g, r, u));
		return d
	}
	updateRangeFromParsed(t, e, s, n) {
	...
	updateElements(t, e, s, n) {
		...
		for (let f = e; f < e + s; f++) {
			...
			or(_, v, b, r), ar(_, v, h.ratio), this.updateElement(t[f], f, _, n)
		}
	}
	_getStacks(t, e) {
		const {
	...
	_calculateBarValuePixels(t) {
		...
		} = this, a = o || 0, l = this.getParsed(t), c = l._custom, h = Te(c);
		let d = l[e.axis],
			u = 0,
			f = s ? this.applyStack(e, l, s) : d,
			g, p;
		f !== d && (u = f - d, f = d), h && (d = c.barStart, f = c.barEnd - c.barStart, d !== 0 && ot(d) !== ot(c.barEnd) && (u = 0), u += d);
		const m = !R(o) && !h ? o : u;
		let b = e.getPixelForValue(m);
		if (this.chart.getDataVisibility(t) ? g = e.getPixelForValue(u + f) : g = b, p = g - b, Math.abs(p) < r) {
			p = sr(p, e, a) * r, d === a && (b -= p / 2);
...
class dr extends te {
	...
	update(t) {
		...
		this._drawStart = a, this._drawCount = l, Rs(e) && (a = 0, l = n.length), s._chart = this.chart, s._datasetIndex = this.index, s._decimated = !!o._decimated, s.points = n.slice(Math.max(this._drawStart - 1, 0), this._drawStart + this._drawCount);
	...
	updateElements(t, e, s, n) {
		...
		for (let x = 0; x < v; ++x) {
			...
			k.skip = isNaN(P) || isNaN(C) || w, k.stop = x > 0 && Math.abs(S[u] - y[u]) > m, p && (k.parsed = S, k.raw = c.data[x]), d && (k.options = h || this.resolveDataElementOptions(x, M.active ? "active" : n)), b || this.updateElement(M, x, k, n), y = S
		}
	}
	getMaxOverflow() {
		const t = this._cachedMeta,
...
class fr extends te {
	...
	updateElements(t, e, s, n) {
		...
		for (let y = e; y < e + s; ++y) {
			...
			k.skip = isNaN(w) || isNaN(P) || S, k.stop = y > 0 && Math.abs(M[f] - v[f]) > b, m && (k.parsed = M, k.raw = c.data[y]), u && (k.options = d || this.resolveDataElementOptions(y, x.active ? "active" : n)), _ || this.updateElement(x, y, k, n), v = M
		}
...
function Nt(i, t, e, s) {
	...
	for (o = 0, r = i.length, c = 0; o < r; ++o) {
		a = i[o], l = a.box, l.update(a.width || t.w, a.height || t.h, Pr(a.horizontal, t));
		const {
			same: d,
			other: u
		} = Sr(t, e, a, s);
...
function Fi(i, t, e, s) {
	...
	for (const a of i) {
		...
		if (a.horizontal) {
			const d = t.w * h,
				u = c.size || l.height;
			qt(c.start) && (r = c.start), l.fullSize ? re(l, n.left, r, e.outerWidth - n.right - n.left, u) : re(l, t.left + c.placed, r, d, u), c.start = r, c.placed += d, r = l.bottom
		} else {
			const d = t.h * h,
				u = c.size || l.width;
			qt(c.start) && (o = c.start), l.fullSize ? re(l, o, n.top, u, e.outerHeight - n.bottom - n.top) : re(l, o, t.top + c.placed, u, d), c.start = o, c.placed += d, o = l.right
		}
	}
	t.x = o, t.y = r
}
var J = {
	...
	update(i, t, e, s) {
		...
		const f = Object.assign({
			...
			g = Mr(l.concat(c), d);
		Nt(a.fullSize, f, d, g), Nt(l, f, d, g), Nt(c, f, d, g) && Nt(l, f, d, g), wr(f), Fi(a.leftAndTop, f, d, g), f.x += f.w, f.y += f.h, Fi(a.rightAndBottom, f, d, g), i.chartArea = {
			left: f.left,
			top: f.top,
			right: f.left + f.w,
			bottom: f.top + f.h,
...
function Or(i, t) {
	...
	if (i[ue] = {
		...
		}, e.display = e.display || "block", e.boxSizing = e.boxSizing || "border-box", Bi(n)) {
		const o = yi(i, "width");
		o !== void 0 && (i.width = o)
	}
	if (Bi(s))
...
function en() {
	...
	i !== Wi && (Wi = i, Zt.forEach((t, e) => {
		e.currentDevicePixelRatio !== i && t()
	}))
}

function Ir(i, t) {
	Zt.size || window.addEventListener("resize", en), Zt.set(i, t)
}

function zr(i) {
	Zt.delete(i), Zt.size || window.removeEventListener("resize", en)
}
...
class Wr extends Zs {
	acquireContext(t, e) {
		...
		return s && s.canvas === t ? (Or(t, e), s) : null
	}
	releaseContext(t) {
		const e = t.canvas;
		if (!e[ue]) return !1;
...
function Vr(i, t) {
	const e = i.options.ticks,
		...
		l = o[r - 1],
		c = [];
	if (r > n) return Ur(t, c, o, r / n), c;
	const h = jr(o, t, n);
	if (r > 0) {
		let d, u;
		const f = r > 1 ? Math.round((l - a) / (r - 1)) : null;
		for (ae(t, c, h, R(f) ? 0 : a - f, a), d = 0, u = r - 1; d < u; d++) ae(t, c, h, o[d], o[d + 1]);
		return ae(t, c, h, l, R(f) ? t.length : l + f), c
	}
	return ae(t, c, h), c
}
...
function Zr(i, t, e, s) {
	...
	if (i.isHorizontal()) {
		...
		} else e === "center" ? g = (c.bottom + c.top) / 2 + p - t : g = Hi(i, e, t);
		u = a - o
	} else {
		if (O(e)) {
			const b = Object.keys(e)[0],
		...
		} else e === "center" ? f = (c.left + c.right) / 2 - m + t : f = Hi(i, e, t);
		g = $(s, r, n), d = e === "left" ? -V : V
	}
	return {
		titleX: f,
		titleY: g,
...
class Lt extends dt {
	...
	update(t, e, s) {
		...
		this._convertTicksToLabels(l ? Ni(this.ticks, a) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), r.display && (r.autoSkip || r.source === "auto") && (this.ticks = Vr(this, this.ticks), this._labelSizes = null, this.afterAutoSkip()), l && this._convertTicksToLabels(this.ticks), this.beforeFit(), this.fit(), this.afterFit(), this.afterUpdate()
	}
	configure() {
	...
	calculateLabelRotation() {
		...
		a = t.offset ? this.maxWidth / s : f / (s - 1), d + 6 > a && (a = f / (s - (t.offset ? .5 : 1)), l = this.maxHeight - Ht(t.grid) - e.padding - ji(t.title, this.chart.options.font), c = Math.sqrt(d * d + u * u), r = An(Math.min(Math.asin(U((h.highest.height + 6) / a, -1, 1)), Math.asin(U(l / c, -1, 1)) - Math.asin(U(u / c, -1, 1)))), r = Math.max(n, Math.min(o, r))), this.labelRotation = r
	}
		...
		if (r) {
			...
			if (a ? (t.width = this.maxWidth, t.height = Ht(o) + l) : (t.height = this.maxHeight, t.width = Ht(o) + l), s.display && this.ticks.length) {
				const {
					...
					widest: d,
					highest: u
				} = this._getLabelSizes(), f = s.padding * 2, g = ct(this.labelRotation), p = Math.cos(g), m = Math.sin(g);
				if (a) {
	...
	_getLabelSizes() {
		...
		if (!t) {
			...
			let s = this.ticks;
			e < s.length && (s = Ni(s, e)), this._labelSizes = t = this._computeLabelSizes(s, s.length, this.options.ticks.maxTicksLimit)
		}
		return t
	}
	_computeLabelSizes(t, e, s) {
		const {
			ctx: n,
			_longestTextCache: o
		} = this, r = [], a = [], l = Math.floor(e / Vi(e, s));
		let c = 0,
			h = 0,
			d, u, f, g, p, m, b, _, v, y, x;
		for (d = 0; d < e; d += l) {
			if (g = t[d].label, p = this._resolveTickFontOptions(d), n.font = m = p.string, b = o[m] = o[m] || {
					data: {},
					gc: []
				}, _ = p.lineHeight, v = y = 0, !R(g) && !B(g)) v = pi(n, b.data, b.gc, v, g), y = _;
			else if (B(g))
				for (u = 0, f = g.length; u < f; ++u) x = g[u], !R(x) && !B(x) && (v = pi(n, b.data, b.gc, v, x), y += _);
	...
	_computeGridLineItems(t) {
		...
		if (r === "top") _ = b(this.bottom), k = this.bottom - u, w = _ - m, C = b(t.top) + m, N = t.bottom;
		else if (r === "bottom") _ = b(this.top), C = t.top, N = b(t.bottom) - m, k = _ + m, w = this.top + u;
		else if (r === "left") _ = b(this.right), M = this.right - u, S = _ - m, P = b(t.left) + m, A = t.right;
		else if (r === "right") _ = b(this.left), P = t.left, A = b(t.right) - m, M = _ + m, S = this.left + u;
		else if (e === "x") {
			...
			C = t.top, N = t.bottom, k = _ + m, w = k + u
		} else if (e === "y") {
			...
			M = _ - m, S = M - u, P = t.left, A = t.right
		}
		...
		for (v = 0; v < d; v += L) {
			...
			y = Kr(this, v, l), y !== void 0 && (x = pt(s, y, j), c ? M = S = P = A = x : k = w = C = N = x, f.push({
				tx1: M,
				ty1: k,
				tx2: S,
				ty2: w,
	...
	_computeLabelItems(t) {
		...
		for (b = 0, _ = a.length; b < _; ++b) {
			...
			S = this.getPixelForTick(b) + o.labelOffset, w = this._resolveTickFontOptions(b), P = w.lineHeight, C = B(y) ? y.length : 1;
			const I = C / 2,
				F = L.color,
				Z = L.textStrokeColor,
				j = L.textStrokeWidth;
			let St = k;
			r ? (x = S, k === "inner" && (b === _ - 1 ? St = this.options.reverse ? "left" : "right" : b === 0 ? St = this.options.reverse ? "right" : "left" : St = "center"), n === "top" ? c === "near" || p !== 0 ? A = -C * P + P / 2 : c === "center" ? A = -G.highest.height / 2 - I * P + P : A = -G.highest.height + P / 2 : c === "near" || p !== 0 ? A = P / 2 : c === "center" ? A = G.highest.height / 2 - I * P : A = G.highest.height - C * P, d && (A *= -1), p !== 0 && !L.showLabelBackdrop && (x += P / 2 * Math.sin(p))) : (M = S, A = (1 - C) * P / 2);
			let ee;
...
class le {
	...
	register(t) {
		...
		return o in n || (n[o] = t, ta(t, r, s), this.override && W.override(t.id, t.overrides)), r
	}
	get(t) {
		return this.items[t]
	}
	unregister(t) {
		const e = this.items,
			s = t.id,
			n = this.scope;
		s in e && delete e[s], n && s in W[n] && (delete W[n][s], this.override && delete Mt[s])
	}
}

function ta(i, t, e) {
	const s = Kt(Object.create(null), [e ? W.get(e) : {}, W.get(t), i.defaults]);
	W.set(t, s), i.defaultRoutes && ea(t, i.defaultRoutes), i.descriptors && W.describe(t, i.descriptors)
}
...
class sa {
	constructor() {
		this.controllers = new le(te, "datasets", !0), this.elements = new le(dt, "elements"), this.plugins = new le(Object, "plugins"), this.scales = new le(Lt, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
	}
	add(...t) {
...
function oa(i) {
	...
	for (let o = 0; o < s.length; o++) e.push(st.getPlugin(s[o]));
	const n = i.plugins || [];
...
function ua(i, t) {
	if (t.data && t.data.datasets) {
		...
		if (e.length) return Ui(i, "x", e[0]) || Ui(i, "y", e[0])
	}
	return {}
}
...
function fa(i, t) {
	...
	return Object.keys(s).forEach(r => {
		...
		Object.keys(h).forEach(d => {
			const u = ca(d, l),
				f = r[u + "AxisID"] || u;
			o[f] = o[f] || Object.create(null), $t(o[f], [{
				axis: u
			}, s[f], h[d]])
		})
...
function sn(i) {
	...
	t.plugins = D(t.plugins, {}), t.scales = fa(i, t)
}
...
function ga(i) {
	return i = i || {}, i.data = nn(i.data), sn(i), i
}
const Yi = new Map,
	on = new Set;
...
function ce(i, t) {
	let e = Yi.get(i);
	return e || (e = t(), Yi.set(i, e), on.add(e)), e
}
const Vt = (i, t, e) => {
	const s = vt(t, e);
	s !== void 0 && i.add(s)
...
class pa {
	constructor(t) {
		this._config = ga(t), this._scopeCache = new Map, this._resolverCache = new Map
	}
	get platform() {
	...
	getOptionScopes(t, e, s) {
		...
		const l = new Set;
		e.forEach(h => {
			t && (l.add(t), h.forEach(d => Vt(l, t, d))), h.forEach(d => Vt(l, n, d)), h.forEach(d => Vt(l, Mt[o] || {}, d)), h.forEach(d => Vt(l, W, d)), h.forEach(d => Vt(l, We, d))
		});
		const c = Array.from(l);
		return c.length === 0 && c.push(Object.create(null)), on.has(e) && r.set(e, c), c
	}
	chartOptionScopes() {
		const {
			options: t,
...
let ii = class {
	...
	constructor(t, e) {
		...
		this.platform = new(s.platform || Hr(n)), this.platform.updateConfig(s);
		const a = this.platform.acquireContext(n, r.aspectRatio),
			l = a && a.canvas,
			c = l && l.height,
			h = l && l.width;
		if (this.id = _n(), this.ctx = a, this.canvas = l, this.width = h, this.height = c, this._options = r, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new na, this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = zn(d => this.update(d), r.resizeDelay || 0), this._dataChanges = [], fe[this.id] = this, !a || !l) {
			console.error("Failed to create chart: can't acquire context from the given item");
			return
		}
		at.listen(this, "complete", Gi), at.listen(this, "progress", ya), this._initialize(), this.attached && this.update()
	}
	get aspectRatio() {
		const {
			options: {
	...
	_resize(t, e) {
		...
		this.width = r.width, this.height = r.height, this._aspectRatio = this.aspectRatio, xi(this, a, !0) && (this.notifyPlugins("resize", {
			size: r
	...
	buildOrUpdateScales() {
		...
		e && (o = o.concat(Object.keys(e).map(r => {
			...
			const a = r.options,
				...
				c = Ne(l, a),
				h = D(a.type, r.dtype);
			(a.position === void 0 || Ki(a.position, c) !== Ki(r.dposition)) && (a.position = r.dposition), n[l] = !0;
			let d = null;
	...
	buildOrUpdateControllers() {
		...
		for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
			...
			if (r.type && r.type !== a && (this._destroyDatasetMeta(s), r = this.getDatasetMeta(s)), r.type = a, r.indexAxis = o.indexAxis || Ve(a, this.options), r.order = o.order || 0, r.index = s, r.label = "" + o.label, r.visible = this.isDatasetVisible(s), r.controller) r.controller.updateIndex(s), r.controller.linkScales();
			else {
	...
	_checkEventBindings() {
		const t = this.options,
			...
			s = new Set(t.events);
		(!ri(e, s) || !!this._responsiveListeners !== t.responsive) && (this.unbindEvents(), this.bindEvents())
	}
	...
	render() {
		this.notifyPlugins("beforeRender", {
			cancelable: !0
		}) !== !1 && (at.has(this) ? this.attached && !at.running(this) && at.start(this) : (this.draw(), Gi({
			chart: this
		})))
	}
	draw() {
	...
	_drawDataset(t) {
		...
		}), t.controller.draw(), n && Me(e), r.cancelable = !1, this.notifyPlugins("afterDatasetDraw", r))
	}
	isPointInArea(t) {
	...
	_updateVisibility(t, e, s) {
		...
		qt(e) ? (o.data[e].hidden = !s, this.update()) : (this.setDatasetVisibility(t, s), r.update(o, {
			visible: s
	...
	destroy() {
		...
		this._stop(), this.config.clearCache(), t && (this.unbindEvents(), mi(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), delete fe[this.id], this.notifyPlugins("afterDestroy")
	}
	toBase64Image(...t) {
	...
	_handleEvent(t, e, s) {
		const {
			_active: n = [],
			options: o
		} = this, r = e, a = this._getActiveElements(t, n, s, r), l = Sn(t), c = Ma(t, this._lastEvent, s, l);
...
function ye(i, t, e, s, n, o) {
	...
	if (i.beginPath(), o) {
		const L = (w + P) / 2;
		if (i.arc(r, a, d, w, L), i.arc(r, a, d, L, P), y > 0) {
			const j = Pt(S, P, r, a);
		...
		if (i.arc(r, a, u, _ - M / u, F, !0), i.arc(r, a, u, F, b + x / u, !0), x > 0) {
			const j = Pt(C, N, r, a);
			i.arc(j.x, j.y, x, N + Math.PI, b - V)
		}
		const Z = Pt(k, b, r, a);
		if (i.lineTo(Z.x, Z.y), v > 0) {
			const j = Pt(k, w, r, a);
...
function Ca(i, t, e, s, n) {
	...
	return ye(i, t, e, s, l, n), i.fill(), l
}
...
function Da(i, t, e, s, n) {
	...
	f && Sa(i, t, g), o || (ye(i, t, e, s, g, n), i.stroke())
}
class zl extends dt {
	static id = "arc";
	static defaults = {
	...
	draw(t) {
		...
		const l = 1 - Math.sin(Math.min(H, s || 0)),
			c = n * l;
		t.fillStyle = e.backgroundColor, t.strokeStyle = e.borderColor, Ca(t, this, c, o, r), Da(t, this, c, o, r), t.restore()
	}
}
...
function Ea(i, t, e, s) {
	let n = t._path;
	n || (n = t._path = new Path2D, t.path(n, e, s) && n.closePath()), an(i, t.options), i.stroke(n)
}
...
function Ia(i, t, e, s) {
	...
	for (const a of n) an(i, o, a.style), i.beginPath(), r(i, t, a, {
		start: e,
		end: e + s - 1
...
class si extends dt {
	...
	updateControlPoints(t, e) {
		...
		if ((s.tension || s.cubicInterpolationMode === "monotone") && !s.stepped && !this._pointsUpdated) {
			...
			yo(this._points, s, t, n, e), this._pointsUpdated = !0
		}
	}
	set points(t) {
	...
	draw(t, e, s, n) {
		...
		(this.points || []).length && o.borderWidth && (t.save(), Fa(t, this, s, n), t.restore()), this.animated && (this._pointsUpdated = !1, this._path = void 0)
	}
}
...
class Fl extends dt {
	...
	draw(t, e) {
		const s = this.options;
		this.skip || s.radius < .1 || !Jt(this, e, this.size(s) / 2) || (t.strokeStyle = s.borderColor, t.lineWidth = s.borderWidth, t.fillStyle = s.backgroundColor, He(t, s, this.x, this.y))
	}
	getRange() {
		const t = this.options || {};
...
function Wa(i, t, e) {
	...
	} = i.getProps(["enableBorderRadius"]), n = i.options.borderRadius, o = Ct(n), r = Math.min(t, e), a = i.borderSkipped, l = s || O(n);
	return {
...
function hn(i, t) {
	let e = [],
		s = !1;
	return B(i) ? (s = !0, e = i) : e = $a(i, t), e.length ? new si({
		points: e,
		options: {
			tension: 0
		},
...
function Ja(i) {
	const {
		...
		index: e,
		line: s
	} = i, n = [], o = s.segments, r = s.points, a = Qa(t, e);
	a.push(hn({
		x: null,
		y: t.bottom
	}, s));
	for (let l = 0; l < o.length; l++) {
		const c = o[l];
		for (let h = c.start; h <= c.end; h++) Za(n, r[h], a)
	}
	return new si({
		points: n,
		options: {}
...
function el(i) {
	...
	if (X(e)) return il(t, e);
	if (e === "stack") return Ja(i);
	if (e === "shape") return !0;
	const n = sl(i);
...
function ol(i) {
	const {
		scale: t,
		fill: e
	} = i, s = t.options, n = t.getLabels().length, o = s.reverse ? t.max : t.min, r = qa(e, t, o), a = [];
	if (s.grid.circular) {
...
function rl(i, t) {
	...
	i.save(), l === "x" && o !== n && (is(i, s, r.top), ss(i, {
		line: e,
		target: s,
		color: n,
		scale: a,
		property: l
	}), i.restore(), i.save(), is(i, s, r.bottom)), ss(i, {
		line: e,
		target: s,
		color: o,
		scale: a,
...
function ss(i, t) {
	...
	for (const {
		...
		i.save(), i.fillStyle = u, al(i, r, f && $e(n, h, d)), i.beginPath();
...
var Wl = {
	...
	afterDatasetsUpdate(i, t, e) {
		const s = (i.data.datasets || []).length,
			n = [];
		let o, r, a, l;
		for (r = 0; r < s; ++r) o = i.getDatasetMeta(r), a = o.dataset, l = null, a && a.options && a instanceof si && (l = {
		...
		for (r = 0; r < s; ++r) l = n[r], !(!l || l.fill === !1) && (l.fill = Ua(n, r, e.propagate))
	},
	beforeDraw(i, t, e) {
		...
		for (let r = n.length - 1; r >= 0; --r) {
			const a = n[r].$filler;
			a && (a.line.updateControlPoints(o, a.axis), s && a.fill && Fe(i.ctx, a, o))
		}
	},
...
class rs extends dt {
	...
	adjustHitBoxes() {
		...
		if (this.isHorizontal()) {
			...
			for (const c of e) a !== c.row && (a = c.row, l = $(s, this.left + n, this.right - this.lineWidths[a])), c.top += this.top + t + n, c.left = r.leftForLtr(r.x(l), c.width), l += c.width + n
		} else {
			let a = 0,
				l = $(s, this.top + t + n, this.bottom - this.columnSizes[a].height);
			for (const c of e) c.col !== a && (a = c.col, l = $(s, this.top + t + n, this.bottom - this.columnSizes[a].height)), c.top = l, c.left += this.left + n, c.left = r.leftForLtr(r.x(c.left), c.width), l += c.height + n
		}
	}
	isHorizontal() {
	...
	_draw() {
		const {
			...
			align: o,
			labels: r
		} = t, a = W.color, l = Dt(t.rtl, this.left, this.width), c = Y(r.font), {
			padding: h
		} = r, d = c.size, u = d / 2;
		let f;
		...
		const {
			...
			boxHeight: p,
			itemHeight: m
		} = os(r, d), b = function(M, k, S) {
			if (isNaN(g) || g <= 0 || isNaN(p) || p < 0) return;
			n.save();
			const w = D(S.lineWidth, 1);
			if (n.fillStyle = D(S.fillStyle, a), n.lineCap = D(S.lineCap, "butt"), n.lineDashOffset = D(S.lineDashOffset, 0), n.lineJoin = D(S.lineJoin, "miter"), n.lineWidth = w, n.strokeStyle = D(S.strokeStyle, a), n.setLineDash(D(S.lineDash, [])), r.usePointStyle) {
				const P = {
				...
				const P = k + Math.max((d - p) / 2, 0),
					C = l.leftForLtr(M, g),
					A = Ct(S.borderRadius);
				n.beginPath(), Object.values(A).some(N => N !== 0) ? be(n, {
					x: C,
					y: P,
					w: g,
					h: p,
					radius: A
				}) : n.rect(C, P, g, p), n.fill(), w !== 0 && n.stroke()
			}
			n.restore()
		}, _ = function(M, k, S) {
		...
		this.legendItems.forEach((M, k) => {
			...
			let C = f.x,
				A = f.y;
			l.setWidth(this.width), v ? k > 0 && C + P + h > this.right && (A = f.y += x, f.line++, C = f.x = $(o, this.left + h, this.right - s[f.line])) : k > 0 && A + x > this.bottom && (C = f.x = C + e[f.line].width + h, f.line++, A = f.y = $(o, this.top + y + h, this.bottom - e[f.line].height));
			const N = l.x(C);
			if (b(N, A, M), C = Fn(w, C + g + u, v ? C + P : this.right, t.rtl), _(l.x(C), A, M), v) f.x += P + h;
	...
	drawTitle() {
		...
		let h, d = this.left,
			u = this.width;
		if (this.isHorizontal()) u = Math.max(...this.lineWidths), h = this.top + c, d = $(t.align, d, this.right - u);
		else {
		...
		const f = $(a, d, d + u);
		r.textAlign = o.textAlign(Xe(a)), r.textBaseline = "middle", r.strokeStyle = e.color, r.fillStyle = e.color, r.font = s.string, Qt(r, e.text, f, h, s)
	}
	_computeTitleHeight() {
	...
	_getLegendItemAt(t, e) {
		...
		if (ht(t, this.left, this.right) && ht(e, this.top, this.bottom)) {
			for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
				if (n = o[s], ht(t, n.left, n.left + n.width) && ht(e, n.top, n.top + n.height)) return this.legendItems[s]
		}
		return null
	}
	handleEvent(t) {
...
function dl(i, t, e) {
	let s = i;
	return typeof t.text != "string" && (s = un(t, e)), s
}
...
class fn extends dt {
	...
	_drawArgs(t) {
		...
		let l = 0,
			c, h, d;
		return this.isHorizontal() ? (h = $(a, s, o), d = e + t, c = o - s) : (r.position === "left" ? (h = s + t, d = $(a, n, e), l = H * -.5) : (h = o - t, d = $(a, e, n), l = H * .5), c = n - e), {
			titleX: h,
			titleY: d,
			maxWidth: c,
			rotation: l
...
function as(i, t) {
	...
	return e.save(), e.font = c.string, T(i.title, v), e.font = l.string, T(i.beforeBody.concat(i.afterBody), v), _ = t.displayColors ? r + 2 + t.boxPadding : 0, T(s, y => {
		T(y.before, v), T(y.lines, v), T(y.after, v)
	}), _ = 0, e.font = h.string, T(i.footer, v), e.restore(), m += g.width, {
		width: m,
		height: p
	}
}
...
function bl(i, t, e, s) {
	...
	let c = "center";
	return s === "center" ? c = n <= (a + l) / 2 ? "left" : "right" : n <= o / 2 ? c = "left" : n >= r - o / 2 && (c = "right"), ml(c, i, t, e) && (c = "center"), c
}
...
class us extends dt {
	...
	getTitle(t, e) {
		const {
			callbacks: s
		} = e, n = K(s, "beforeTitle", this, t), o = K(s, "title", this, t), r = K(s, "afterTitle", this, t);
		let a = [];
		return a = et(a, lt(n)), a = et(a, lt(o)), a = et(a, lt(r)), a
	}
	getBeforeBody(t, e) {
	...
	getBody(t, e) {
		...
		return T(t, o => {
			const r = {
				...
				a = ds(s, o);
			et(r.before, lt(K(a, "beforeLabel", this, o))), et(r.lines, K(a, "label", this, o)), et(r.after, lt(K(a, "afterLabel", this, o))), n.push(r)
		}), n
	}
	getAfterBody(t, e) {
	...
	getFooter(t, e) {
		const {
			callbacks: s
		} = e, n = K(s, "beforeFooter", this, t), o = K(s, "footer", this, t), r = K(s, "afterFooter", this, t);
		let a = [];
		return a = et(a, lt(n)), a = et(a, lt(o)), a = et(a, lt(r)), a
	}
	_createItems(t) {
		...
		let a = [],
			l, c;
		for (l = 0, c = e.length; l < c; ++l) a.push(gl(this.chart, e[l]));
	...
	drawTitle(t, e, s) {
		...
		if (o) {
			...
			for (t.x = he(this, s.titleAlign, s), e.textAlign = c.textAlign(s.titleAlign), e.textBaseline = "middle", r = Y(s.titleFont), a = s.titleSpacing, e.fillStyle = s.titleColor, e.font = r.string, l = 0; l < o; ++l) e.fillText(n[l], c.x(t.x), t.y + r.lineHeight / 2), t.y += r.lineHeight + a, l + 1 === o && (t.y += s.titleMarginBottom - a)
		}
	}
	_drawColorBox(t, e, s, n, o) {
		...
		if (o.usePointStyle) {
			const p = {
				...
				b = g + l / 2;
			t.strokeStyle = o.multiKeyBackground, t.fillStyle = o.multiKeyBackground, He(t, p, m, b), t.strokeStyle = r.borderColor, t.fillStyle = r.backgroundColor, He(t, p, m, b)
		} else {
			...
			const p = n.leftForLtr(u, c),
				...
				b = Ct(r.borderRadius);
			Object.values(b).some(_ => _ !== 0) ? (t.beginPath(), t.fillStyle = o.multiKeyBackground, be(t, {
				x: p,
				y: g,
				w: c,
				h: l,
	...
	drawBody(t, e, s) {
		...
		const g = Dt(s.rtl, this.x, this.width),
			...
			m = g.textAlign(r);
		let b, _, v, y, x, M, k;
		for (e.textAlign = r, e.textBaseline = "middle", e.font = d.string, t.x = he(this, m, s), e.fillStyle = s.bodyColor, T(this.beforeBody, p), f = a && m !== "right" ? r === "center" ? c / 2 + h : c + 2 + h : 0, y = 0, M = n.length; y < M; ++y) {
			for (b = n[y], _ = this.labelTextColors[y], e.fillStyle = _, T(b.before, p), v = b.lines, a && v.length && (this._drawColorBox(e, t, y, g, s), u = Math.max(d.lineHeight, l)), x = 0, k = v.length; x < k; ++x) p(v[x]), u = d.lineHeight;
			T(b.after, p)
		}
	...
	drawFooter(t, e, s) {
		...
		if (o) {
			...
			for (t.x = he(this, s.footerAlign, s), t.y += s.footerMarginTop, e.textAlign = l.textAlign(s.footerAlign), e.textBaseline = "middle", r = Y(s.footerFont), e.fillStyle = s.footerColor, e.font = r.string, a = 0; a < o; ++a) e.fillText(n[a], l.x(t.x), t.y + r.lineHeight / 2), t.y += r.lineHeight + s.footerSpacing
		}
	}
	...
	draw(t) {
		...
		e.enabled && a && (t.save(), t.globalAlpha = s, this.drawBackground(o, t, n, e), js(t, e.textDirection), o.y += r.top, this.drawTitle(o, t, e), this.drawBody(o, t, e), this.drawFooter(o, t, e), $s(t, e.textDirection), t.restore())
	}
	getActiveElements() {
		return this._active || []
	}
	...
	_positionChanged(t, e) {
		const {
			...
			caretY: n,
			options: o
		} = this, r = jt[o.position].call(this, t, e);
...
const vl = (i, t, e, s) => (typeof t == "string" ? (e = i.push(t) - 1, s.unshift({
	index: e,
	label: t
})) : isNaN(t) && (e = null), e);
...
class jl extends Lt {
	...
	parse(t, e) {
		if (R(t)) return null;
		const s = this.getLabels();
		return e = isFinite(e) && s[e] === t ? e : Ml(s, t, D(e, t), this._addedLabels), kl(e, s.length - 1)
	}
	determineDataLimits() {
		const {
			minDefined: t,
...
function Sl(i, t) {
	...
	w = Math.ceil(m / x) - Math.floor(p / x), w > g && (x = li(w * x / g / f) * f), R(l) || (M = Math.pow(10, l), x = Math.ceil(x * M) / M), n === "ticks" ? (k = Math.floor(p / x) * x, S = Math.ceil(m / x) * x) : (k = p, S = m), b && _ && o && Dn((a - r) / o, x / 1e3) ? (w = Math.round(Math.min((a - r) / x, h)), x = (a - r) / w, k = r, S = a) : v ? (k = b ? r : k, S = _ ? a : S, w = c - 1, x = (S - k) / w) : (w = (S - k) / x, Ut(w, Math.round(w), x / 1e3) ? w = Math.round(w) : w = Math.ceil(w));
	const P = Math.max(ci(x), ci(k));
	M = Math.pow(10, R(l) ? P : l), k = Math.round(k * M) / M, S = Math.round(S * M) / M;
	let C = 0;
	for (b && (u && k !== r ? (e.push({
			value: r
		}), k < r && C++, Ut(Math.round((k + C * x) * M) / M, r, gs(r, y, i)) && C++) : k < r && C++); C < w; ++C) {
...
class wl extends Lt {
	...
	buildTicks() {
		...
		const n = {
			...
			o = this._range || this,
			r = Sl(n, o);
		return t.bounds === "ticks" && On(r, this, "value"), t.reverse ? (r.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), r
	}
	configure() {
		const t = this.ticks;
		let e = this.min,
...
function ms(i, t) {
	...
	let r = t;
	return typeof s == "function" && (r = s(r)), X(r) || (r = typeof s == "string" ? e.parse(r, s) : e.parse(r)), r === null ? null : (n && (r = n === "week" && (Ot(o) || o === !0) ? e.startOf(r, "isoWeek", o) : e.startOf(r, n)), +r)
}
...
function Pl(i, t, e, s, n) {
	for (let o = q.length - 1; o >= q.indexOf(e); o--) {
		const r = q[o];
		if (we[r].common && i._adapter.diff(n, s, r) >= t - 1) return r
	}
...
class ys extends Lt {
	...
	determineDataLimits() {
		...
		}(!r || !a) && (l(this._getLabelBounds()), (t.bounds !== "ticks" || t.ticks.source !== "labels") && l(this.getMinMax(!1))), n = X(n) && !isNaN(n) ? n : +e.startOf(Date.now(), s), o = X(o) && !isNaN(o) ? o : +e.endOf(Date.now(), s) + 1, this.min = Math.min(n, o - 1), this.max = Math.max(n + 1, o)
	}
	_getLabelBounds() {
	...
	buildTicks() {
		...
		const o = this.min,
			r = this.max,
			a = En(n, o, r);
		return this._unit = e.unit || (s.autoSkip ? bs(e.minUnit, this.min, this.max, this._getLabelCapacity(o)) : Pl(this, a.length, e.minUnit, this.min, this.max)), this._majorUnit = !s.major.enabled || this._unit === "year" ? void 0 : Cl(this._unit), this.initOffsets(n), t.reverse && a.reverse(), xs(this, a, this._majorUnit)
	}
	afterAutoSkip() {
	...
	_generate() {
		...
		for (u = d, f = 0; u < s; u = +t.add(u, a, r), f++) _s(h, u, g);
		return (u === s || n.bounds === "ticks" || f === 1) && _s(h, u, g), Object.keys(h).sort(ps).map(p => +p)
	}
	getLabelForValue(t) {
	...
	getLabelTimestamps() {
		...
		for (e = 0, s = n.length; e < s; ++e) t.push(ms(this, n[e]));
...
class Ul extends ys {
	...
	initOffsets() {
		...
		this._minPos = de(e, this.min), this._tableRange = de(e, this.max) - this._minPos, super.initOffsets(t)
	}
	buildLookupTable(t) {
		const {
			min: e,
...
function Tl(i, t) {
	const {
		...
		updateMode: d,
		...u
	} = i, f = it.useRef(null), g = it.useRef(), p = () => {
...
function Pe(i, t) {
	return ii.register(t), it.forwardRef((e, s) => Ms.createElement(Ll, Object.assign({}, e, {
		ref: s,
		type: i
	})))
}
const Yl = Pe("line", dr),
	...
	ql = Pe("scatter", fr);
export {
	zl as A, Bl as B, ii as C, $l as L, Fl as P, ql as S, jl as a, Nl as b, dr as c, si as d, Yl as e, Xl as f, R as g, O as h, Wl as i, T as j, E as k, W as l, Kt as m, Q as n, Kl as o, Vl as p, Hl as q, se as r, Y as t, D as v
};
//# sourceMappingURL=dlxldtpg3t60aqlu.js.map