...
function $(n, e, t, r) {
	...
	var c = l * r;
	return g === "border-box" && (c = c + i + s), u = Math.min(c, u), [u, l]
}
var w = function() {},
	_ = function(e, t) {
...
var G = function(e) {
	...
	Z = function(e, t) {
			...
			b = function() {
				...
				if (x) {
					...
					var y = $(x, f.value || f.placeholder || "x", s, i),
						m = y[0],
						W = y[1];
					z.current !== m && (z.current = m, f.style.setProperty("height", m + "px", "important"), l(m, {
						rowHeight: W
					}))
				}
			},
		...
		return d.useLayoutEffect(b), G(b), U(b), d.createElement("textarea", A({}, h, {
			onChange: T,
			ref: p
		}))
	},
...
//# sourceMappingURL=b35luffh9z4llgqb.js.map